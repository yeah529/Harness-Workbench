...
function Todos({ store: store3, projectId }) {
  ...
  return import_react7.default.createElement(
    ...
    todos.length === 0 ? import_react7.default.createElement(Empty, { glyph: glyph(ICONS.grid) }, "\u6682\u65E0\u5F85\u529E\uFF0C\u6DFB\u52A0\u7B2C\u4E00\u9879") : import_react7.default.createElement("div", { className: "cpwb-list" }, todos.map((todo) => import_react7.default.createElement(
      "article",
      ...
      import_react7.default.createElement("button", { type: "button", className: "cpwb-item-main cpwb-todo-details", onClick: () => setDialog({ todo }) }, import_react7.default.createElement("span", { className: "cpwb-item-title" }, todo.title), import_react7.default.createElement("span", { className: "cpwb-item-meta" }, todo.overdue && !todo.done ? "\u5DF2\u903E\u671F \xB7 " : "\u9884\u8BA1\u5B8C\u6210 \xB7 ", localDateTime(todo.dueAt, timeZone), " \xB7 \u521B\u5EFA\u4E8E ", localDateTime(todo.createdAt, timeZone), todo.source === "auto" ? " \xB7 \u81EA\u52A8\u751F\u6210" : "")),
      import_react7.default.createElement("button", { type: "button", className: "cpwb-icon-button", onClick: () => setDialog({ todo }), "aria-label": "\u7F16\u8F91\u5F85\u529E" }, import_react7.default.createElement(a39, { size: 14 }))
    ))),
