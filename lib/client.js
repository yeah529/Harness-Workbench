...
function localDateKey(date = /* @__PURE__ */ new Date()) {
  ...
  const m4 = String(date.getMonth() + 1).padStart(2, "0");
...
function createCpwbApi({ fetchImpl, basePath = API_PREFIX } = {}) {
  ...
  return {
    ...
    todos: {
      list({ projectId, signal } = {}) {
        return request({ path: "/todos", query: { projectId }, signal });
      },
      create({ projectId, title, dueAt, source }, { signal } = {}) {
        return request({ method: "POST", path: "/todos", body: { projectId, title, dueAt, source }, signal });
      },
      update({ id, title, dueAt, done }, { signal } = {}) {
        return request({ method: "PATCH", path: "/todos", body: { id, title, dueAt, done }, signal });
      }
    },
    settings: {
      timezone({ signal } = {}) {
        return request({ path: "/settings/timezone", signal });
      },
      updateTimezone(timezone, { signal } = {}) {
        return request({ method: "PATCH", path: "/settings/timezone", body: { timezone }, signal });
      },
      embedding({ signal } = {}) {
        return request({ path: "/settings/embedding", signal });
      },
      updateEmbedding(body, { signal } = {}) {
        return request({ method: "PATCH", path: "/settings/embedding", body, signal });
      },
      testEmbedding(body, { signal } = {}) {
        return request({ method: "POST", path: "/settings/embedding/test", body, signal });
      },
      indexStatus({ signal } = {}) {
        return request({ path: "/settings/index", signal });
      },
      reindex({ signal } = {}) {
        return request({ method: "POST", path: "/settings/index/reindex", signal });
      },
      putEmbeddingCredential(body, { signal } = {}) {
        return request({ method: "PUT", path: "/settings/embedding/credential", body, signal });
      },
      deleteEmbeddingCredential(body, { signal } = {}) {
        return request({ method: "DELETE", path: "/settings/embedding/credential", body, signal });
      },
      network({ signal } = {}) {
        return request({ path: "/settings/network", signal });
      },
      updateNetwork(body, { signal } = {}) {
        return request({ method: "PATCH", path: "/settings/network", body, signal });
      },
      testNetwork(body, { signal } = {}) {
        return request({ method: "POST", path: "/settings/network/test", body, signal });
      },
      authStatus({ signal } = {}) {
        return request({ path: "/settings/auth/status", signal });
      },
      authTest({ signal } = {}) {
        return request({ method: "POST", path: "/settings/auth/test", body: {}, signal });
      },
      connectCodex({ signal } = {}) {
        return request({ method: "POST", path: "/settings/auth/codex/connect", body: {}, signal });
      }
    },
    knowledgeBaseIndex: {
      reindex(knowledgeBaseId, { signal } = {}) {
        return request({ method: "POST", path: "/knowledge-bases/" + knowledgeBaseId + "/reindex", signal });
      }
    },
    schedules: {
      list({ projectId, signal } = {}) {
...
var e2 = /* @__PURE__ */ new Map([
  ...
  [
    ...
    ), /* @__PURE__ */ a2.createElement("path", { d: "M231.65,194.55,198.46,36.75a16,16,0,0,0-19-12.39L132.65,34.42a16.08,16.08,0,0,0-12.3,19l33.19,157.8A16,16,0,0,0,169.16,224a16.25,16.25,0,0,0,3.38-.36l46.81-10.06A16.09,16.09,0,0,0,231.65,194.55ZM136,50.15c0-.06,0-.09,0-.09l46.8-10,3.33,15.87L139.33,66Zm6.62,31.47,46.82-10.05,3.34,15.9L146,97.53Zm6.64,31.57,46.82-10.06,13.3,63.24-46.82,10.06ZM216,197.94l-46.8,10-3.33-15.87L212.67,182,216,197.85C216,197.91,216,197.94,216,197.94ZM104,32H56A16,16,0,0,0,40,48V208a16,16,0,0,0,16,16h48a16,16,0,0,0,16-16V48A16,16,0,0,0,104,32ZM56,48h48V64H56Zm0,32h48v96H56Zm48,128H56V192h48v16Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a2.createElement(a2.Fragment, null, /* @__PURE__ */ a2.createElement("path", { d: "M231.65,194.55,198.46,36.75a16,16,0,0,0-19-12.39L132.65,34.42a16.08,16.08,0,0,0-12.3,19l33.19,157.8A16,16,0,0,0,169.16,224a16.25,16.25,0,0,0,3.38-.36l46.81-10.06A16.09,16.09,0,0,0,231.65,194.55ZM136,50.15c0-.06,0-.09,0-.09l46.8-10,3.33,15.87L139.33,66Zm10,47.38-3.35-15.9,46.82-10.06,3.34,15.9Zm70,100.41-46.8,10-3.33-15.87L212.67,182,216,197.85C216,197.91,216,197.94,216,197.94ZM104,32H56A16,16,0,0,0,40,48V208a16,16,0,0,0,16,16h48a16,16,0,0,0,16-16V48A16,16,0,0,0,104,32ZM56,48h48V64H56Zm48,160H56V192h48v16Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a2.createElement(a2.Fragment, null, /* @__PURE__ */ a2.createElement("path", { d: "M104,34H56A14,14,0,0,0,42,48V208a14,14,0,0,0,14,14h48a14,14,0,0,0,14-14V48A14,14,0,0,0,104,34ZM54,78h52V178H54Zm2-32h48a2,2,0,0,1,2,2V66H54V48A2,2,0,0,1,56,46Zm48,164H56a2,2,0,0,1-2-2V190h52v18A2,2,0,0,1,104,210Zm125.7-15L196.51,37.16a14,14,0,0,0-16.63-10.85L133.07,36.37A14.09,14.09,0,0,0,122.3,53l33.19,157.81a14,14,0,0,0,6.1,8.9,13.85,13.85,0,0,0,7.57,2.26,13.55,13.55,0,0,0,3-.32l46.81-10.05A14.09,14.09,0,0,0,229.7,195Zm-82.81-83.32,50.73-10.9,14.12,67.16L161,178.81Zm-6.63-31.56L191,69.19,195.15,89l-50.73,10.9Zm-4.66-32,46.8-10.05a2.18,2.18,0,0,1,.42,0,1.89,1.89,0,0,1,1.05.32,2,2,0,0,1,.89,1.31l3.75,17.82L137.79,68.34l-3.74-17.78A2.07,2.07,0,0,1,135.6,48.1Zm80.81,151.8L169.6,210a1.92,1.92,0,0,1-1.47-.27,2,2,0,0,1-.89-1.31l-3.75-17.82,50.72-10.9L218,197.43A2.07,2.07,0,0,1,216.41,199.9Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a2.createElement(a2.Fragment, null, /* @__PURE__ */ a2.createElement("path", { d: "M231.65,194.55,198.46,36.75a16,16,0,0,0-19-12.39L132.65,34.42a16.08,16.08,0,0,0-12.3,19l33.19,157.8A16,16,0,0,0,169.16,224a16.25,16.25,0,0,0,3.38-.36l46.81-10.06A16.09,16.09,0,0,0,231.65,194.55ZM136,50.15c0-.06,0-.09,0-.09l46.8-10,3.33,15.87L139.33,66Zm6.62,31.47,46.82-10.05,3.34,15.9L146,97.53Zm6.64,31.57,46.82-10.06,13.3,63.24-46.82,10.06ZM216,197.94l-46.8,10-3.33-15.87L212.67,182,216,197.85C216,197.91,216,197.94,216,197.94ZM104,32H56A16,16,0,0,0,40,48V208a16,16,0,0,0,16,16h48a16,16,0,0,0,16-16V48A16,16,0,0,0,104,32ZM56,48h48V64H56Zm0,32h48v96H56Zm48,128H56V192h48v16Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a2.createElement(a2.Fragment, null, /* @__PURE__ */ a2.createElement("path", { d: "M104,36H56A12,12,0,0,0,44,48V208a12,12,0,0,0,12,12h48a12,12,0,0,0,12-12V48A12,12,0,0,0,104,36ZM52,76h56V180H52Zm4-32h48a4,4,0,0,1,4,4V68H52V48A4,4,0,0,1,56,44Zm48,168H56a4,4,0,0,1-4-4V188h56v20A4,4,0,0,1,104,212Zm123.74-16.62L194.55,37.57a12,12,0,0,0-14.25-9.3L133.49,38.32a12.1,12.1,0,0,0-9.23,14.3l33.19,157.81a12,12,0,0,0,14.25,9.3l46.81-10.06h0A12.08,12.08,0,0,0,227.74,195.38Zm-83.21-85.27,54.63-11.73,15,71.07-54.63,11.74Zm-6.64-31.56,54.64-11.74,5,23.74-54.64,11.73Zm-2.71-32.4L182,36.09a4,4,0,0,1,.84-.09,3.94,3.94,0,0,1,2.14.64,4,4,0,0,1,1.76,2.58L190.88,59,136.24,70.72,132.09,51A4.07,4.07,0,0,1,135.18,46.15Zm81.65,155.7L170,211.91a4,4,0,0,1-3-.55,4,4,0,0,1-1.76-2.58L161.12,189l54.64-11.73L219.91,197A4.07,4.07,0,0,1,216.83,201.85Z" }))
  ]
]);
...
var V = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a4.createElement(a4.Fragment, null, /* @__PURE__ */ a4.createElement("path", { d: "M208,28H188V24a12,12,0,0,0-24,0v4H92V24a12,12,0,0,0-24,0v4H48A20,20,0,0,0,28,48V208a20,20,0,0,0,20,20H208a20,20,0,0,0,20-20V48A20,20,0,0,0,208,28ZM68,52a12,12,0,0,0,24,0h72a12,12,0,0,0,24,0h16V76H52V52ZM52,204V100H204V204Zm120.49-84.49a12,12,0,0,1,0,17l-48,48a12,12,0,0,1-17,0l-24-24a12,12,0,0,1,17-17L116,159l39.51-39.52A12,12,0,0,1,172.49,119.51Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ a4.createElement("path", { d: "M208,32H184V24a8,8,0,0,0-16,0v8H88V24a8,8,0,0,0-16,0v8H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM72,48v8a8,8,0,0,0,16,0V48h80v8a8,8,0,0,0,16,0V48h24V80H48V48ZM208,208H48V96H208V208Zm-38.34-85.66a8,8,0,0,1,0,11.32l-48,48a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L116,164.69l42.34-42.35A8,8,0,0,1,169.66,122.34Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a4.createElement(a4.Fragment, null, /* @__PURE__ */ a4.createElement("path", { d: "M208,32H184V24a8,8,0,0,0-16,0v8H88V24a8,8,0,0,0-16,0v8H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM169.66,133.66l-48,48a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L116,164.69l42.34-42.35a8,8,0,0,1,11.32,11.32ZM48,80V48H72v8a8,8,0,0,0,16,0V48h80v8a8,8,0,0,0,16,0V48h24V80Z" }))
  ],
  [
    "light",
  ...
  [
    "regular",
    /* @__PURE__ */ a4.createElement(a4.Fragment, null, /* @__PURE__ */ a4.createElement("path", { d: "M208,32H184V24a8,8,0,0,0-16,0v8H88V24a8,8,0,0,0-16,0v8H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM72,48v8a8,8,0,0,0,16,0V48h80v8a8,8,0,0,0,16,0V48h24V80H48V48ZM208,208H48V96H208V208Zm-38.34-85.66a8,8,0,0,1,0,11.32l-48,48a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L116,164.69l42.34-42.35A8,8,0,0,1,169.66,122.34Z" }))
  ],
  [
    "thin",
...
var e4 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a5.createElement(a5.Fragment, null, /* @__PURE__ */ a5.createElement("path", { d: "M172,108a12,12,0,0,1-12,12H96a12,12,0,0,1,0-24h64A12,12,0,0,1,172,108Zm-12,28H96a12,12,0,0,0,0,24h64a12,12,0,0,0,0-24Zm76-8A108,108,0,0,1,78.77,224.15L46.34,235A20,20,0,0,1,21,209.66l10.81-32.43A108,108,0,1,1,236,128Zm-24,0A84,84,0,1,0,55.27,170.06a12,12,0,0,1,1,9.81l-9.93,29.79,29.79-9.93a12.1,12.1,0,0,1,3.8-.62,12,12,0,0,1,6,1.62A84,84,0,0,0,212,128Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ a5.createElement("path", { d: "M128,24A104,104,0,0,0,36.18,176.88L24.83,210.93a16,16,0,0,0,20.24,20.24l34.05-11.35A104,104,0,1,0,128,24Zm0,192a87.87,87.87,0,0,1-44.06-11.81,8,8,0,0,0-4-1.08,7.85,7.85,0,0,0-2.53.42L40,216,52.47,178.6a8,8,0,0,0-.66-6.54A88,88,0,1,1,128,216Zm40-104a8,8,0,0,1-8,8H96a8,8,0,0,1,0-16h64A8,8,0,0,1,168,112Zm0,32a8,8,0,0,1-8,8H96a8,8,0,0,1,0-16h64A8,8,0,0,1,168,144Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a5.createElement(a5.Fragment, null, /* @__PURE__ */ a5.createElement("path", { d: "M128,24A104,104,0,0,0,36.18,176.88L24.83,210.93a16,16,0,0,0,20.24,20.24l34.05-11.35A104,104,0,1,0,128,24Zm32,128H96a8,8,0,0,1,0-16h64a8,8,0,0,1,0,16Zm0-32H96a8,8,0,0,1,0-16h64a8,8,0,0,1,0,16Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a5.createElement(a5.Fragment, null, /* @__PURE__ */ a5.createElement("path", { d: "M166,112a6,6,0,0,1-6,6H96a6,6,0,0,1,0-12h64A6,6,0,0,1,166,112Zm-6,26H96a6,6,0,0,0,0,12h64a6,6,0,0,0,0-12Zm70-10A102,102,0,0,1,79.31,217.65L44.44,229.27a14,14,0,0,1-17.71-17.71l11.62-34.87A102,102,0,1,1,230,128Zm-12,0A90,90,0,1,0,50.08,173.06a6,6,0,0,1,.5,4.91L38.12,215.35a2,2,0,0,0,2.53,2.53L78,205.42a6.2,6.2,0,0,1,1.9-.31,6.09,6.09,0,0,1,3,.81A90,90,0,0,0,218,128Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a5.createElement(a5.Fragment, null, /* @__PURE__ */ a5.createElement("path", { d: "M168,112a8,8,0,0,1-8,8H96a8,8,0,0,1,0-16h64A8,8,0,0,1,168,112Zm-8,24H96a8,8,0,0,0,0,16h64a8,8,0,0,0,0-16Zm72-8A104,104,0,0,1,79.12,219.82L45.07,231.17a16,16,0,0,1-20.24-20.24l11.35-34.05A104,104,0,1,1,232,128Zm-16,0A88,88,0,1,0,51.81,172.06a8,8,0,0,1,.66,6.54L40,216,77.4,203.53a7.85,7.85,0,0,1,2.53-.42,8,8,0,0,1,4,1.08A88,88,0,0,0,216,128Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a5.createElement(a5.Fragment, null, /* @__PURE__ */ a5.createElement("path", { d: "M164,112a4,4,0,0,1-4,4H96a4,4,0,0,1,0-8h64A4,4,0,0,1,164,112Zm-4,28H96a4,4,0,0,0,0,8h64a4,4,0,0,0,0-8Zm68-12A100,100,0,0,1,79.5,215.47l-35.69,11.9a12,12,0,0,1-15.18-15.18l11.9-35.69A100,100,0,1,1,228,128Zm-8,0A92,92,0,1,0,48.35,174.07a4,4,0,0,1,.33,3.27L36.22,214.72a4,4,0,0,0,5.06,5.06l37.38-12.46a3.93,3.93,0,0,1,1.27-.21,4.05,4.05,0,0,1,2,.54A92,92,0,0,0,220,128Z" }))
  ]
]);
...
var e5 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a6.createElement(a6.Fragment, null, /* @__PURE__ */ a6.createElement("path", { d: "M236.34,187.09A84,84,0,0,0,172.29,68.9,84,84,0,0,0,19.66,139.09l-6.84,23.26a20,20,0,0,0,24.83,24.83l23.26-6.84a83.94,83.94,0,0,0,22.76,6.74,84.06,84.06,0,0,0,111.42,41.26l23.26,6.84a20,20,0,0,0,24.83-24.83ZM62,155.5a11.88,11.88,0,0,0-3.39.49l-20.72,6.09L44,141.35a12,12,0,0,0-.93-9A60,60,0,1,1,67.7,156.92,12,12,0,0,0,62,155.5Zm150.89,24.8a12,12,0,0,0-.93,9l6.09,20.73L197.36,204a12,12,0,0,0-9.06.93A60,60,0,0,1,111,186.63a83.93,83.93,0,0,0,68.55-91.37,60,60,0,0,1,33.38,85Z" }))
  ],
  [
    "duotone",
...
var a7 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e6.createElement(e6.Fragment, null, /* @__PURE__ */ e6.createElement("path", { d: "M232.49,80.49l-128,128a12,12,0,0,1-17,0l-56-56a12,12,0,1,1,17-17L96,183,215.51,63.51a12,12,0,0,1,17,17Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ e6.createElement("path", { d: "M205.66,85.66l-96,96a8,8,0,0,1-11.32,0l-40-40a8,8,0,0,1,11.32-11.32L104,164.69l90.34-90.35a8,8,0,0,1,11.32,11.32Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e6.createElement(e6.Fragment, null, /* @__PURE__ */ e6.createElement("path", { d: "M216,40H40A16,16,0,0,0,24,56V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40ZM205.66,85.66l-96,96a8,8,0,0,1-11.32,0l-40-40a8,8,0,0,1,11.32-11.32L104,164.69l90.34-90.35a8,8,0,0,1,11.32,11.32Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e6.createElement(e6.Fragment, null, /* @__PURE__ */ e6.createElement("path", { d: "M228.24,76.24l-128,128a6,6,0,0,1-8.48,0l-56-56a6,6,0,0,1,8.48-8.48L96,191.51,219.76,67.76a6,6,0,0,1,8.48,8.48Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e6.createElement(e6.Fragment, null, /* @__PURE__ */ e6.createElement("path", { d: "M229.66,77.66l-128,128a8,8,0,0,1-11.32,0l-56-56a8,8,0,0,1,11.32-11.32L96,188.69,218.34,66.34a8,8,0,0,1,11.32,11.32Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e6.createElement(e6.Fragment, null, /* @__PURE__ */ e6.createElement("path", { d: "M226.83,74.83l-128,128a4,4,0,0,1-5.66,0l-56-56a4,4,0,0,1,5.66-5.66L96,194.34,221.17,69.17a4,4,0,1,1,5.66,5.66Z" }))
  ]
]);
...
var a8 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e7.createElement(e7.Fragment, null, /* @__PURE__ */ e7.createElement("path", { d: "M176.49,95.51a12,12,0,0,1,0,17l-56,56a12,12,0,0,1-17,0l-24-24a12,12,0,1,1,17-17L112,143l47.51-47.52A12,12,0,0,1,176.49,95.51ZM236,128A108,108,0,1,1,128,20,108.12,108.12,0,0,1,236,128Zm-24,0a84,84,0,1,0-84,84A84.09,84.09,0,0,0,212,128Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ e7.createElement(e7.Fragment, null, /* @__PURE__ */ e7.createElement("path", { d: "M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z", opacity: "0.2" }), /* @__PURE__ */ e7.createElement("path", { d: "M173.66,98.34a8,8,0,0,1,0,11.32l-56,56a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35A8,8,0,0,1,173.66,98.34ZM232,128A104,104,0,1,1,128,24,104.11,104.11,0,0,1,232,128Zm-16,0a88,88,0,1,0-88,88A88.1,88.1,0,0,0,216,128Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e7.createElement(e7.Fragment, null, /* @__PURE__ */ e7.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm45.66,85.66-56,56a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35a8,8,0,0,1,11.32,11.32Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e7.createElement(e7.Fragment, null, /* @__PURE__ */ e7.createElement("path", { d: "M172.24,99.76a6,6,0,0,1,0,8.48l-56,56a6,6,0,0,1-8.48,0l-24-24a6,6,0,0,1,8.48-8.48L112,151.51l51.76-51.75A6,6,0,0,1,172.24,99.76ZM230,128A102,102,0,1,1,128,26,102.12,102.12,0,0,1,230,128Zm-12,0a90,90,0,1,0-90,90A90.1,90.1,0,0,0,218,128Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e7.createElement(e7.Fragment, null, /* @__PURE__ */ e7.createElement("path", { d: "M173.66,98.34a8,8,0,0,1,0,11.32l-56,56a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35A8,8,0,0,1,173.66,98.34ZM232,128A104,104,0,1,1,128,24,104.11,104.11,0,0,1,232,128Zm-16,0a88,88,0,1,0-88,88A88.1,88.1,0,0,0,216,128Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e7.createElement(e7.Fragment, null, /* @__PURE__ */ e7.createElement("path", { d: "M170.83,101.17a4,4,0,0,1,0,5.66l-56,56a4,4,0,0,1-5.66,0l-24-24a4,4,0,0,1,5.66-5.66L112,154.34l53.17-53.17A4,4,0,0,1,170.83,101.17ZM228,128A100,100,0,1,1,128,28,100.11,100.11,0,0,1,228,128Zm-8,0a92,92,0,1,0-92,92A92.1,92.1,0,0,0,220,128Z" }))
  ]
]);
...
var e8 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a9.createElement(a9.Fragment, null, /* @__PURE__ */ a9.createElement("path", { d: "M236,137A108.13,108.13,0,1,1,119,20,12,12,0,0,1,121,44,84.12,84.12,0,1,0,212,135,12,12,0,1,1,236,137ZM116,76v52a12,12,0,0,0,12,12h52a12,12,0,0,0,0-24H140V76a12,12,0,0,0-24,0Zm92,20a16,16,0,1,0-16-16A16,16,0,0,0,208,96ZM176,64a16,16,0,1,0-16-16A16,16,0,0,0,176,64Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ a9.createElement(a9.Fragment, null, /* @__PURE__ */ a9.createElement("path", { d: "M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z", opacity: "0.2" }), /* @__PURE__ */ a9.createElement("path", { d: "M232,136.66A104.12,104.12,0,1,1,119.34,24,8,8,0,0,1,120.66,40,88.12,88.12,0,1,0,216,135.34,8,8,0,0,1,232,136.66ZM120,72v56a8,8,0,0,0,8,8h56a8,8,0,0,0,0-16H136V72a8,8,0,0,0-16,0Zm40-24a12,12,0,1,0-12-12A12,12,0,0,0,160,48Zm36,24a12,12,0,1,0-12-12A12,12,0,0,0,196,72Zm24,36a12,12,0,1,0-12-12A12,12,0,0,0,220,108Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a9.createElement(a9.Fragment, null, /* @__PURE__ */ a9.createElement("path", { d: "M208,96a12,12,0,1,1,12,12A12,12,0,0,1,208,96ZM196,72a12,12,0,1,0-12-12A12,12,0,0,0,196,72Zm28.66,56a8,8,0,0,0-8.63,7.31A88.12,88.12,0,1,1,120.66,40,8,8,0,0,0,119.34,24,104.12,104.12,0,1,0,232,136.66,8,8,0,0,0,224.66,128ZM128,56a72,72,0,1,1-72,72A72.08,72.08,0,0,1,128,56Zm-8,72a8,8,0,0,0,8,8h48a8,8,0,0,0,0-16H136V80a8,8,0,0,0-16,0Zm40-80a12,12,0,1,0-12-12A12,12,0,0,0,160,48Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a9.createElement(a9.Fragment, null, /* @__PURE__ */ a9.createElement("path", { d: "M230,136.49A102.12,102.12,0,1,1,119.51,26a6,6,0,0,1,1,12A90.13,90.13,0,1,0,218,135.51a6,6,0,1,1,12,1ZM122,72v56a6,6,0,0,0,6,6h56a6,6,0,0,0,0-12H134V72a6,6,0,0,0-12,0Zm38-26a10,10,0,1,0-10-10A10,10,0,0,0,160,46Zm36,24a10,10,0,1,0-10-10A10,10,0,0,0,196,70Zm24,36a10,10,0,1,0-10-10A10,10,0,0,0,220,106Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a9.createElement(a9.Fragment, null, /* @__PURE__ */ a9.createElement("path", { d: "M232,136.66A104.12,104.12,0,1,1,119.34,24,8,8,0,0,1,120.66,40,88.12,88.12,0,1,0,216,135.34,8,8,0,0,1,232,136.66ZM120,72v56a8,8,0,0,0,8,8h56a8,8,0,0,0,0-16H136V72a8,8,0,0,0-16,0Zm40-24a12,12,0,1,0-12-12A12,12,0,0,0,160,48Zm36,24a12,12,0,1,0-12-12A12,12,0,0,0,196,72Zm24,36a12,12,0,1,0-12-12A12,12,0,0,0,220,108Z" }))
  ...
  [
    "thin",
    /* @__PURE__ */ a9.createElement(a9.Fragment, null, /* @__PURE__ */ a9.createElement("path", { d: "M228,136.33A100.13,100.13,0,1,1,119.67,28a4,4,0,1,1,.66,8A92.13,92.13,0,1,0,220,135.67a4,4,0,1,1,8,.66ZM128,132h56a4,4,0,0,0,0-8H132V72a4,4,0,0,0-8,0v56A4,4,0,0,0,128,132Zm32-88a8,8,0,1,0-8-8A8,8,0,0,0,160,44Zm36,24a8,8,0,1,0-8-8A8,8,0,0,0,196,68Zm24,36a8,8,0,1,0-8-8A8,8,0,0,0,220,104Z" }))
  ]
]);
...
var t = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e9.createElement(e9.Fragment, null, /* @__PURE__ */ e9.createElement("path", { d: "M196,35.52C177.62,25.51,153.48,20,128,20S78.38,25.51,60,35.52C39.37,46.79,28,62.58,28,80v96c0,17.42,11.37,33.21,32,44.48,18.35,10,42.49,15.52,68,15.52s49.62-5.51,68-15.52c20.66-11.27,32-27.06,32-44.48V80C228,62.58,216.63,46.79,196,35.52ZM204,128c0,17-31.21,36-76,36s-76-19-76-36v-8.46a88.9,88.9,0,0,0,8,4.94c18.35,10,42.49,15.52,68,15.52s49.62-5.51,68-15.52a88.9,88.9,0,0,0,8-4.94ZM128,44c44.79,0,76,19,76,36s-31.21,36-76,36S52,97,52,80,83.21,44,128,44Zm0,168c-44.79,0-76-19-76-36v-8.46a88.9,88.9,0,0,0,8,4.94c18.35,10,42.49,15.52,68,15.52s49.62-5.51,68-15.52a88.9,88.9,0,0,0,8-4.94V176C204,193,172.79,212,128,212Z" }))
  ],
  [
    "duotone",
...
var l = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a10.createElement(a10.Fragment, null, /* @__PURE__ */ a10.createElement("path", { d: "M128,76a52,52,0,1,0,52,52A52.06,52.06,0,0,0,128,76Zm0,80a28,28,0,1,1,28-28A28,28,0,0,1,128,156Zm113.86-49.57A12,12,0,0,0,236,98.34L208.21,82.49l-.11-31.31a12,12,0,0,0-4.25-9.12,116,116,0,0,0-38-21.41,12,12,0,0,0-9.68.89L128,37.27,99.83,21.53a12,12,0,0,0-9.7-.9,116.06,116.06,0,0,0-38,21.47,12,12,0,0,0-4.24,9.1l-.14,31.34L20,98.35a12,12,0,0,0-5.85,8.11,110.7,110.7,0,0,0,0,43.11A12,12,0,0,0,20,157.66l27.82,15.85.11,31.31a12,12,0,0,0,4.25,9.12,116,116,0,0,0,38,21.41,12,12,0,0,0,9.68-.89L128,218.73l28.14,15.74a12,12,0,0,0,9.7.9,116.06,116.06,0,0,0,38-21.47,12,12,0,0,0,4.24-9.1l.14-31.34,27.81-15.81a12,12,0,0,0,5.85-8.11A110.7,110.7,0,0,0,241.86,106.43Zm-22.63,33.18-26.88,15.28a11.94,11.94,0,0,0-4.55,4.59c-.54,1-1.11,1.93-1.7,2.88a12,12,0,0,0-1.83,6.31L184.13,199a91.83,91.83,0,0,1-21.07,11.87l-27.15-15.19a12,12,0,0,0-5.86-1.53h-.29c-1.14,0-2.3,0-3.44,0a12.08,12.08,0,0,0-6.14,1.51L93,210.82A92.27,92.27,0,0,1,71.88,199l-.11-30.24a12,12,0,0,0-1.83-6.32c-.58-.94-1.16-1.91-1.7-2.88A11.92,11.92,0,0,0,63.7,155L36.8,139.63a86.53,86.53,0,0,1,0-23.24l26.88-15.28a12,12,0,0,0,4.55-4.58c.54-1,1.11-1.94,1.7-2.89a12,12,0,0,0,1.83-6.31L71.87,57A91.83,91.83,0,0,1,92.94,45.17l27.15,15.19a11.92,11.92,0,0,0,6.15,1.52c1.14,0,2.3,0,3.44,0a12.08,12.08,0,0,0,6.14-1.51L163,45.18A92.27,92.27,0,0,1,184.12,57l.11,30.24a12,12,0,0,0,1.83,6.32c.58.94,1.16,1.91,1.7,2.88A11.92,11.92,0,0,0,192.3,101l26.9,15.33A86.53,86.53,0,0,1,219.23,139.61Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ a10.createElement("path", { d: "M128,80a48,48,0,1,0,48,48A48.05,48.05,0,0,0,128,80Zm0,80a32,32,0,1,1,32-32A32,32,0,0,1,128,160Zm109.94-52.79a8,8,0,0,0-3.89-5.4l-29.83-17-.12-33.62a8,8,0,0,0-2.83-6.08,111.91,111.91,0,0,0-36.72-20.67,8,8,0,0,0-6.46.59L128,41.85,97.88,25a8,8,0,0,0-6.47-.6A111.92,111.92,0,0,0,54.73,45.15a8,8,0,0,0-2.83,6.07l-.15,33.65-29.83,17a8,8,0,0,0-3.89,5.4,106.47,106.47,0,0,0,0,41.56,8,8,0,0,0,3.89,5.4l29.83,17,.12,33.63a8,8,0,0,0,2.83,6.08,111.91,111.91,0,0,0,36.72,20.67,8,8,0,0,0,6.46-.59L128,214.15,158.12,231a7.91,7.91,0,0,0,3.9,1,8.09,8.09,0,0,0,2.57-.42,112.1,112.1,0,0,0,36.68-20.73,8,8,0,0,0,2.83-6.07l.15-33.65,29.83-17a8,8,0,0,0,3.89-5.4A106.47,106.47,0,0,0,237.94,107.21Zm-15,34.91-28.57,16.25a8,8,0,0,0-3,3c-.58,1-1.19,2.06-1.81,3.06a7.94,7.94,0,0,0-1.22,4.21l-.15,32.25a95.89,95.89,0,0,1-25.37,14.3L134,199.13a8,8,0,0,0-3.91-1h-.19c-1.21,0-2.43,0-3.64,0a8.1,8.1,0,0,0-4.1,1l-28.84,16.1A96,96,0,0,1,67.88,201l-.11-32.2a8,8,0,0,0-1.22-4.22c-.62-1-1.23-2-1.8-3.06a8.09,8.09,0,0,0-3-3.06l-28.6-16.29a90.49,90.49,0,0,1,0-28.26L61.67,97.63a8,8,0,0,0,3-3c.58-1,1.19-2.06,1.81-3.06a7.94,7.94,0,0,0,1.22-4.21l.15-32.25a95.89,95.89,0,0,1,25.37-14.3L122,56.87a8,8,0,0,0,4.1,1c1.21,0,2.43,0,3.64,0a8,8,0,0,0,4.1-1l28.84-16.1A96,96,0,0,1,188.12,55l.11,32.2a8,8,0,0,0,1.22,4.22c.62,1,1.23,2,1.8,3.06a8.09,8.09,0,0,0,3,3.06l28.6,16.29A90.49,90.49,0,0,1,222.9,142.12Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a10.createElement(a10.Fragment, null, /* @__PURE__ */ a10.createElement("path", { d: "M237.94,107.21a8,8,0,0,0-3.89-5.4l-29.83-17-.12-33.62a8,8,0,0,0-2.83-6.08,111.91,111.91,0,0,0-36.72-20.67,8,8,0,0,0-6.46.59L128,41.85,97.88,25a8,8,0,0,0-6.47-.6A111.92,111.92,0,0,0,54.73,45.15a8,8,0,0,0-2.83,6.07l-.15,33.65-29.83,17a8,8,0,0,0-3.89,5.4,106.47,106.47,0,0,0,0,41.56,8,8,0,0,0,3.89,5.4l29.83,17,.12,33.63a8,8,0,0,0,2.83,6.08,111.91,111.91,0,0,0,36.72,20.67,8,8,0,0,0,6.46-.59L128,214.15,158.12,231a7.91,7.91,0,0,0,3.9,1,8.09,8.09,0,0,0,2.57-.42,112.1,112.1,0,0,0,36.68-20.73,8,8,0,0,0,2.83-6.07l.15-33.65,29.83-17a8,8,0,0,0,3.89-5.4A106.47,106.47,0,0,0,237.94,107.21ZM128,168a40,40,0,1,1,40-40A40,40,0,0,1,128,168Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a10.createElement(a10.Fragment, null, /* @__PURE__ */ a10.createElement("path", { d: "M128,82a46,46,0,1,0,46,46A46.06,46.06,0,0,0,128,82Zm0,80a34,34,0,1,1,34-34A34,34,0,0,1,128,162Zm108-54.4a6,6,0,0,0-2.92-4L202.64,86.22l-.42-.71L202.1,51.2A6,6,0,0,0,200,46.64a110.12,110.12,0,0,0-36.07-20.31,6,6,0,0,0-4.84.45L128.46,43.86h-1L96.91,26.76a6,6,0,0,0-4.86-.44A109.92,109.92,0,0,0,56,46.68a6,6,0,0,0-2.12,4.55l-.16,34.34c-.14.23-.28.47-.41.71L22.91,103.57A6,6,0,0,0,20,107.62a104.81,104.81,0,0,0,0,40.78,6,6,0,0,0,2.92,4l30.42,17.33.42.71.12,34.31A6,6,0,0,0,56,209.36a110.12,110.12,0,0,0,36.07,20.31,6,6,0,0,0,4.84-.45l30.61-17.08h1l30.56,17.1A6.09,6.09,0,0,0,162,230a5.83,5.83,0,0,0,1.93-.32,109.92,109.92,0,0,0,36-20.36,6,6,0,0,0,2.12-4.55l.16-34.34c.14-.23.28-.47.41-.71l30.42-17.29a6,6,0,0,0,2.92-4.05A104.81,104.81,0,0,0,236,107.6Zm-11.25,35.79L195.32,160.1a6.07,6.07,0,0,0-2.28,2.3c-.59,1-1.21,2.11-1.86,3.14a6,6,0,0,0-.91,3.16l-.16,33.21a98.15,98.15,0,0,1-27.52,15.53L133,200.88a6,6,0,0,0-2.93-.77h-.14c-1.24,0-2.5,0-3.74,0a6,6,0,0,0-3.07.76L93.45,217.43a98,98,0,0,1-27.56-15.49l-.12-33.17a6,6,0,0,0-.91-3.16c-.64-1-1.27-2.08-1.86-3.14a6,6,0,0,0-2.27-2.3L31.3,143.4a93,93,0,0,1,0-30.79L60.68,95.9A6.07,6.07,0,0,0,63,93.6c.59-1,1.21-2.11,1.86-3.14a6,6,0,0,0,.91-3.16l.16-33.21A98.15,98.15,0,0,1,93.41,38.56L123,55.12a5.81,5.81,0,0,0,3.07.76c1.24,0,2.5,0,3.74,0a6,6,0,0,0,3.07-.76l29.65-16.56a98,98,0,0,1,27.56,15.49l.12,33.17a6,6,0,0,0,.91,3.16c.64,1,1.27,2.08,1.86,3.14a6,6,0,0,0,2.27,2.3L224.7,112.6A93,93,0,0,1,224.73,143.39Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a10.createElement(a10.Fragment, null, /* @__PURE__ */ a10.createElement("path", { d: "M128,80a48,48,0,1,0,48,48A48.05,48.05,0,0,0,128,80Zm0,80a32,32,0,1,1,32-32A32,32,0,0,1,128,160Zm109.94-52.79a8,8,0,0,0-3.89-5.4l-29.83-17-.12-33.62a8,8,0,0,0-2.83-6.08,111.91,111.91,0,0,0-36.72-20.67,8,8,0,0,0-6.46.59L128,41.85,97.88,25a8,8,0,0,0-6.47-.6A112.1,112.1,0,0,0,54.73,45.15a8,8,0,0,0-2.83,6.07l-.15,33.65-29.83,17a8,8,0,0,0-3.89,5.4,106.47,106.47,0,0,0,0,41.56,8,8,0,0,0,3.89,5.4l29.83,17,.12,33.62a8,8,0,0,0,2.83,6.08,111.91,111.91,0,0,0,36.72,20.67,8,8,0,0,0,6.46-.59L128,214.15,158.12,231a7.91,7.91,0,0,0,3.9,1,8.09,8.09,0,0,0,2.57-.42,112.1,112.1,0,0,0,36.68-20.73,8,8,0,0,0,2.83-6.07l.15-33.65,29.83-17a8,8,0,0,0,3.89-5.4A106.47,106.47,0,0,0,237.94,107.21Zm-15,34.91-28.57,16.25a8,8,0,0,0-3,3c-.58,1-1.19,2.06-1.81,3.06a7.94,7.94,0,0,0-1.22,4.21l-.15,32.25a95.89,95.89,0,0,1-25.37,14.3L134,199.13a8,8,0,0,0-3.91-1h-.19c-1.21,0-2.43,0-3.64,0a8.08,8.08,0,0,0-4.1,1l-28.84,16.1A96,96,0,0,1,67.88,201l-.11-32.2a8,8,0,0,0-1.22-4.22c-.62-1-1.23-2-1.8-3.06a8.09,8.09,0,0,0-3-3.06l-28.6-16.29a90.49,90.49,0,0,1,0-28.26L61.67,97.63a8,8,0,0,0,3-3c.58-1,1.19-2.06,1.81-3.06a7.94,7.94,0,0,0,1.22-4.21l.15-32.25a95.89,95.89,0,0,1,25.37-14.3L122,56.87a8,8,0,0,0,4.1,1c1.21,0,2.43,0,3.64,0a8.08,8.08,0,0,0,4.1-1l28.84-16.1A96,96,0,0,1,188.12,55l.11,32.2a8,8,0,0,0,1.22,4.22c.62,1,1.23,2,1.8,3.06a8.09,8.09,0,0,0,3,3.06l28.6,16.29A90.49,90.49,0,0,1,222.9,142.12Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a10.createElement(a10.Fragment, null, /* @__PURE__ */ a10.createElement("path", { d: "M128,84a44,44,0,1,0,44,44A44.05,44.05,0,0,0,128,84Zm0,80a36,36,0,1,1,36-36A36,36,0,0,1,128,164Zm106-56a4,4,0,0,0-2-2.7l-30.89-17.6q-.47-.82-1-1.62L200.1,51.2a3.94,3.94,0,0,0-1.42-3,107.8,107.8,0,0,0-35.41-19.94,4,4,0,0,0-3.23.29L129,45.87h-2l-31-17.36a4,4,0,0,0-3.23-.3,108.05,108.05,0,0,0-35.39,20,4,4,0,0,0-1.41,3l-.16,34.9-1,1.62L23.9,105.3A4,4,0,0,0,22,108a102.76,102.76,0,0,0,0,40,4,4,0,0,0,1.95,2.7l30.89,17.6q.47.83,1,1.62l.12,34.87a3.94,3.94,0,0,0,1.42,3,107.8,107.8,0,0,0,35.41,19.94,4,4,0,0,0,3.23-.29L127,210.13h2l31,17.36a4,4,0,0,0,3.23.3,108.05,108.05,0,0,0,35.39-20,4,4,0,0,0,1.41-3l.16-34.9,1-1.62L232.1,150.7a4,4,0,0,0,2-2.71A102.76,102.76,0,0,0,234,108Zm-7.48,36.67L196.3,161.84a4,4,0,0,0-1.51,1.53c-.61,1.09-1.25,2.17-1.91,3.24a3.92,3.92,0,0,0-.61,2.1l-.16,34.15a99.8,99.8,0,0,1-29.7,16.77l-30.4-17a4.06,4.06,0,0,0-2-.51H130c-1.28,0-2.57,0-3.84,0a4.1,4.1,0,0,0-2.05.51l-30.45,17A100.23,100.23,0,0,1,63.89,202.9l-.12-34.12a3.93,3.93,0,0,0-.61-2.11c-.66-1-1.3-2.14-1.91-3.23a4,4,0,0,0-1.51-1.53L29.49,144.68a94.78,94.78,0,0,1,0-33.34L59.7,94.16a4,4,0,0,0,1.51-1.53c.61-1.09,1.25-2.17,1.91-3.23a4,4,0,0,0,.61-2.11l.16-34.15a99.8,99.8,0,0,1,29.7-16.77l30.4,17a4.1,4.1,0,0,0,2.05.51c1.28,0,2.57,0,3.84,0a4,4,0,0,0,2.05-.51l30.45-17A100.23,100.23,0,0,1,192.11,53.1l.12,34.12a3.93,3.93,0,0,0,.61,2.11c.66,1,1.3,2.14,1.91,3.23a4,4,0,0,0,1.51,1.53l30.25,17.23A94.78,94.78,0,0,1,226.54,144.66Z" }))
  ]
]);
...
var e10 = /* @__PURE__ */ new Map([
  ...
  [
    ...
    ), /* @__PURE__ */ a11.createElement("path", { d: "M219.31,108.68l-80-80a16,16,0,0,0-22.62,0l-80,80A15.87,15.87,0,0,0,32,120v96a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V160h32v56a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V120A15.87,15.87,0,0,0,219.31,108.68ZM208,208H160V152a8,8,0,0,0-8-8H104a8,8,0,0,0-8,8v56H48V120l80-80,80,80Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a11.createElement(a11.Fragment, null, /* @__PURE__ */ a11.createElement("path", { d: "M224,120v96a8,8,0,0,1-8,8H160a8,8,0,0,1-8-8V164a4,4,0,0,0-4-4H108a4,4,0,0,0-4,4v52a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V120a16,16,0,0,1,4.69-11.31l80-80a16,16,0,0,1,22.62,0l80,80A16,16,0,0,1,224,120Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a11.createElement(a11.Fragment, null, /* @__PURE__ */ a11.createElement("path", { d: "M217.9,110.1l-80-80a14,14,0,0,0-19.8,0l-80,80A13.92,13.92,0,0,0,34,120v96a6,6,0,0,0,6,6h64a6,6,0,0,0,6-6V158h36v58a6,6,0,0,0,6,6h64a6,6,0,0,0,6-6V120A13.92,13.92,0,0,0,217.9,110.1ZM210,210H158V152a6,6,0,0,0-6-6H104a6,6,0,0,0-6,6v58H46V120a2,2,0,0,1,.58-1.42l80-80a2,2,0,0,1,2.84,0l80,80A2,2,0,0,1,210,120Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a11.createElement(a11.Fragment, null, /* @__PURE__ */ a11.createElement("path", { d: "M219.31,108.68l-80-80a16,16,0,0,0-22.62,0l-80,80A15.87,15.87,0,0,0,32,120v96a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V160h32v56a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V120A15.87,15.87,0,0,0,219.31,108.68ZM208,208H160V152a8,8,0,0,0-8-8H104a8,8,0,0,0-8,8v56H48V120l80-80,80,80Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a11.createElement(a11.Fragment, null, /* @__PURE__ */ a11.createElement("path", { d: "M216.49,111.51l-80-80a12,12,0,0,0-17,0l-80,80A12,12,0,0,0,36,120v96a4,4,0,0,0,4,4h64a4,4,0,0,0,4-4V156h40v60a4,4,0,0,0,4,4h64a4,4,0,0,0,4-4V120A12,12,0,0,0,216.49,111.51ZM212,212H156V152a4,4,0,0,0-4-4H104a4,4,0,0,0-4,4v60H44V120a4,4,0,0,1,1.17-2.83l80-80a4,4,0,0,1,5.66,0l80,80A4,4,0,0,1,212,120Z" }))
  ]
]);
...
var e11 = /* @__PURE__ */ new Map([
  ...
  [
    ...
    ), /* @__PURE__ */ a12.createElement("path", { d: "M216.57,39.43A80,80,0,0,0,83.91,120.78L28.69,176A15.86,15.86,0,0,0,24,187.31V216a16,16,0,0,0,16,16H72a8,8,0,0,0,8-8V208H96a8,8,0,0,0,8-8V184h16a8,8,0,0,0,5.66-2.34l9.56-9.57A79.73,79.73,0,0,0,160,176h.1A80,80,0,0,0,216.57,39.43ZM224,98.1c-1.09,34.09-29.75,61.86-63.89,61.9H160a63.7,63.7,0,0,1-23.65-4.51,8,8,0,0,0-8.84,1.68L116.69,168H96a8,8,0,0,0-8,8v16H72a8,8,0,0,0-8,8v16H40V187.31l58.83-58.82a8,8,0,0,0,1.68-8.84A63.72,63.72,0,0,1,96,95.92c0-34.14,27.81-62.8,61.9-63.89A64,64,0,0,1,224,98.1ZM192,76a12,12,0,1,1-12-12A12,12,0,0,1,192,76Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a12.createElement(a12.Fragment, null, /* @__PURE__ */ a12.createElement("path", { d: "M216.57,39.43A80,80,0,0,0,83.91,120.78L28.69,176A15.86,15.86,0,0,0,24,187.31V216a16,16,0,0,0,16,16H72a8,8,0,0,0,8-8V208H96a8,8,0,0,0,8-8V184h16a8,8,0,0,0,5.66-2.34l9.56-9.57A79.73,79.73,0,0,0,160,176h.1A80,80,0,0,0,216.57,39.43ZM180,92a16,16,0,1,1,16-16A16,16,0,0,1,180,92Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a12.createElement(a12.Fragment, null, /* @__PURE__ */ a12.createElement("path", { d: "M215.15,40.85A78,78,0,0,0,86.2,121.31l-56.1,56.1a13.94,13.94,0,0,0-4.1,9.9V216a14,14,0,0,0,14,14H72a6,6,0,0,0,6-6V206H96a6,6,0,0,0,6-6V182h18a6,6,0,0,0,4.24-1.76l10.45-10.44A77.59,77.59,0,0,0,160,174h.1A78,78,0,0,0,215.15,40.85ZM226,98.16c-1.12,35.16-30.67,63.8-65.88,63.84a65.93,65.93,0,0,1-24.51-4.67,6,6,0,0,0-6.64,1.26L117.51,170H96a6,6,0,0,0-6,6v18H72a6,6,0,0,0-6,6v18H40a2,2,0,0,1-2-2V187.31a2,2,0,0,1,.58-1.41l58.83-58.83a6,6,0,0,0,1.26-6.64A65.61,65.61,0,0,1,94,95.92C94,60.71,122.68,31.16,157.83,30A66,66,0,0,1,226,98.16ZM190,76a10,10,0,1,1-10-10A10,10,0,0,1,190,76Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a12.createElement(a12.Fragment, null, /* @__PURE__ */ a12.createElement("path", { d: "M216.57,39.43A80,80,0,0,0,83.91,120.78L28.69,176A15.86,15.86,0,0,0,24,187.31V216a16,16,0,0,0,16,16H72a8,8,0,0,0,8-8V208H96a8,8,0,0,0,8-8V184h16a8,8,0,0,0,5.66-2.34l9.56-9.57A79.73,79.73,0,0,0,160,176h.1A80,80,0,0,0,216.57,39.43ZM224,98.1c-1.09,34.09-29.75,61.86-63.89,61.9H160a63.7,63.7,0,0,1-23.65-4.51,8,8,0,0,0-8.84,1.68L116.69,168H96a8,8,0,0,0-8,8v16H72a8,8,0,0,0-8,8v16H40V187.31l58.83-58.82a8,8,0,0,0,1.68-8.84A63.72,63.72,0,0,1,96,95.92c0-34.14,27.81-62.8,61.9-63.89A64,64,0,0,1,224,98.1ZM192,76a12,12,0,1,1-12-12A12,12,0,0,1,192,76Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a12.createElement(a12.Fragment, null, /* @__PURE__ */ a12.createElement("path", { d: "M213.74,42.26A76,76,0,0,0,88.51,121.84l-57,57A11.93,11.93,0,0,0,28,187.31V216a12,12,0,0,0,12,12H72a4,4,0,0,0,4-4V204H96a4,4,0,0,0,4-4V180h20a4,4,0,0,0,2.83-1.17l11.33-11.34A75.72,75.72,0,0,0,160,172h.1A76,76,0,0,0,213.74,42.26Zm14.22,56c-1.15,36.22-31.6,65.72-67.87,65.77H160a67.52,67.52,0,0,1-25.21-4.83,4,4,0,0,0-4.45.83l-12,12H96a4,4,0,0,0-4,4v20H72a4,4,0,0,0-4,4v20H40a4,4,0,0,1-4-4V187.31a4.06,4.06,0,0,1,1.17-2.83L96,125.66a4,4,0,0,0,.83-4.45A67.51,67.51,0,0,1,92,95.91C92,59.64,121.55,29.19,157.77,28A68,68,0,0,1,228,98.23ZM188,76a8,8,0,1,1-8-8A8,8,0,0,1,188,76Z" }))
  ]
]);
...
var e12 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M228,128a12,12,0,0,1-12,12H40a12,12,0,0,1,0-24H216A12,12,0,0,1,228,128ZM40,76H216a12,12,0,0,0,0-24H40a12,12,0,0,0,0,24ZM216,180H40a12,12,0,0,0,0,24H216a12,12,0,0,0,0-24Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M216,64V192H40V64Z", opacity: "0.2" }), /* @__PURE__ */ a13.createElement("path", { d: "M224,128a8,8,0,0,1-8,8H40a8,8,0,0,1,0-16H216A8,8,0,0,1,224,128ZM40,72H216a8,8,0,0,0,0-16H40a8,8,0,0,0,0,16ZM216,184H40a8,8,0,0,0,0,16H216a8,8,0,0,0,0-16Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM192,184H64a8,8,0,0,1,0-16H192a8,8,0,0,1,0,16Zm0-48H64a8,8,0,0,1,0-16H192a8,8,0,0,1,0,16Zm0-48H64a8,8,0,0,1,0-16H192a8,8,0,0,1,0,16Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M222,128a6,6,0,0,1-6,6H40a6,6,0,0,1,0-12H216A6,6,0,0,1,222,128ZM40,70H216a6,6,0,0,0,0-12H40a6,6,0,0,0,0,12ZM216,186H40a6,6,0,0,0,0,12H216a6,6,0,0,0,0-12Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M224,128a8,8,0,0,1-8,8H40a8,8,0,0,1,0-16H216A8,8,0,0,1,224,128ZM40,72H216a8,8,0,0,0,0-16H40a8,8,0,0,0,0,16ZM216,184H40a8,8,0,0,0,0,16H216a8,8,0,0,0,0-16Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M220,128a4,4,0,0,1-4,4H40a4,4,0,0,1,0-8H216A4,4,0,0,1,220,128ZM40,68H216a4,4,0,0,0,0-8H40a4,4,0,0,0,0,8ZM216,188H40a4,4,0,0,0,0,8H216a4,4,0,0,0,0-8Z" }))
  ]
]);
...
var a14 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e13.createElement(e13.Fragment, null, /* @__PURE__ */ e13.createElement("path", { d: "M232.49,215.51,185,168a92.12,92.12,0,1,0-17,17l47.53,47.54a12,12,0,0,0,17-17ZM44,112a68,68,0,1,1,68,68A68.07,68.07,0,0,1,44,112Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ e13.createElement(e13.Fragment, null, /* @__PURE__ */ e13.createElement("path", { d: "M192,112a80,80,0,1,1-80-80A80,80,0,0,1,192,112Z", opacity: "0.2" }), /* @__PURE__ */ e13.createElement("path", { d: "M229.66,218.34,179.6,168.28a88.21,88.21,0,1,0-11.32,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e13.createElement(e13.Fragment, null, /* @__PURE__ */ e13.createElement("path", { d: "M168,112a56,56,0,1,1-56-56A56,56,0,0,1,168,112Zm61.66,117.66a8,8,0,0,1-11.32,0l-50.06-50.07a88,88,0,1,1,11.32-11.31l50.06,50.06A8,8,0,0,1,229.66,229.66ZM112,184a72,72,0,1,0-72-72A72.08,72.08,0,0,0,112,184Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e13.createElement(e13.Fragment, null, /* @__PURE__ */ e13.createElement("path", { d: "M228.24,219.76l-51.38-51.38a86.15,86.15,0,1,0-8.48,8.48l51.38,51.38a6,6,0,0,0,8.48-8.48ZM38,112a74,74,0,1,1,74,74A74.09,74.09,0,0,1,38,112Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e13.createElement(e13.Fragment, null, /* @__PURE__ */ e13.createElement("path", { d: "M229.66,218.34l-50.07-50.06a88.11,88.11,0,1,0-11.31,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e13.createElement(e13.Fragment, null, /* @__PURE__ */ e13.createElement("path", { d: "M226.83,221.17l-52.7-52.7a84.1,84.1,0,1,0-5.66,5.66l52.7,52.7a4,4,0,0,0,5.66-5.66ZM36,112a76,76,0,1,1,76,76A76.08,76.08,0,0,1,36,112Z" }))
  ]
]);
...
var e14 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a15.createElement(a15.Fragment, null, /* @__PURE__ */ a15.createElement("path", { d: "M84,108A12,12,0,0,1,96,96h64a12,12,0,0,1,0,24H96A12,12,0,0,1,84,108Zm32,28H96a12,12,0,0,0,0,24h20a12,12,0,0,0,0-24ZM228,48V156.69a19.86,19.86,0,0,1-5.86,14.14l-51.31,51.31A19.86,19.86,0,0,1,156.69,228H48a20,20,0,0,1-20-20V48A20,20,0,0,1,48,28H208A20,20,0,0,1,228,48ZM52,204h92V156a12,12,0,0,1,12-12h48V52H52Zm139-36H168v23Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ a15.createElement(a15.Fragment, null, /* @__PURE__ */ a15.createElement("path", { d: "M216,160l-56,56V160Z", opacity: "0.2" }), /* @__PURE__ */ a15.createElement("path", { d: "M88,96a8,8,0,0,1,8-8h64a8,8,0,0,1,0,16H96A8,8,0,0,1,88,96Zm8,40h64a8,8,0,0,0,0-16H96a8,8,0,0,0,0,16Zm32,16H96a8,8,0,0,0,0,16h32a8,8,0,0,0,0-16ZM224,48V156.69A15.86,15.86,0,0,1,219.31,168L168,219.31A15.86,15.86,0,0,1,156.69,224H48a16,16,0,0,1-16-16V48A16,16,0,0,1,48,32H208A16,16,0,0,1,224,48ZM48,208H152V160a8,8,0,0,1,8-8h48V48H48Zm120-40v28.7L196.69,168Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a15.createElement(a15.Fragment, null, /* @__PURE__ */ a15.createElement("path", { d: "M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H156.69A15.92,15.92,0,0,0,168,219.31L219.31,168A15.92,15.92,0,0,0,224,156.69V48A16,16,0,0,0,208,32ZM96,88h64a8,8,0,0,1,0,16H96a8,8,0,0,1,0-16Zm32,80H96a8,8,0,0,1,0-16h32a8,8,0,0,1,0,16ZM96,136a8,8,0,0,1,0-16h64a8,8,0,0,1,0,16Zm64,68.69V160h44.7Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a15.createElement(a15.Fragment, null, /* @__PURE__ */ a15.createElement("path", { d: "M90,96a6,6,0,0,1,6-6h64a6,6,0,0,1,0,12H96A6,6,0,0,1,90,96Zm6,38h64a6,6,0,0,0,0-12H96a6,6,0,0,0,0,12Zm32,20H96a6,6,0,0,0,0,12h32a6,6,0,0,0,0-12ZM222,48V156.69a13.94,13.94,0,0,1-4.1,9.9L166.59,217.9a13.94,13.94,0,0,1-9.9,4.1H48a14,14,0,0,1-14-14V48A14,14,0,0,1,48,34H208A14,14,0,0,1,222,48ZM48,210H154V160a6,6,0,0,1,6-6h50V48a2,2,0,0,0-2-2H48a2,2,0,0,0-2,2V208A2,2,0,0,0,48,210Zm153.52-44H166v35.52Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a15.createElement(a15.Fragment, null, /* @__PURE__ */ a15.createElement("path", { d: "M88,96a8,8,0,0,1,8-8h64a8,8,0,0,1,0,16H96A8,8,0,0,1,88,96Zm8,40h64a8,8,0,0,0,0-16H96a8,8,0,0,0,0,16Zm32,16H96a8,8,0,0,0,0,16h32a8,8,0,0,0,0-16ZM224,48V156.69A15.86,15.86,0,0,1,219.31,168L168,219.31A15.86,15.86,0,0,1,156.69,224H48a16,16,0,0,1-16-16V48A16,16,0,0,1,48,32H208A16,16,0,0,1,224,48ZM48,208H152V160a8,8,0,0,1,8-8h48V48H48Zm120-40v28.7L196.69,168Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a15.createElement(a15.Fragment, null, /* @__PURE__ */ a15.createElement("path", { d: "M92,96a4,4,0,0,1,4-4h64a4,4,0,0,1,0,8H96A4,4,0,0,1,92,96Zm4,36h64a4,4,0,0,0,0-8H96a4,4,0,0,0,0,8Zm32,24H96a4,4,0,0,0,0,8h32a4,4,0,0,0,0-8ZM220,48V156.69a11.9,11.9,0,0,1-3.52,8.48l-51.31,51.32a11.93,11.93,0,0,1-8.48,3.51H48a12,12,0,0,1-12-12V48A12,12,0,0,1,48,36H208A12,12,0,0,1,220,48ZM48,212H156V160a4,4,0,0,1,4-4h52V48a4,4,0,0,0-4-4H48a4,4,0,0,0-4,4V208A4,4,0,0,0,48,212Zm158.35-48H164v42.35Z" }))
  ]
]);
...
var e15 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a16.createElement(a16.Fragment, null, /* @__PURE__ */ a16.createElement("path", { d: "M230.14,70.54,185.46,25.85a20,20,0,0,0-28.29,0L33.86,149.17A19.85,19.85,0,0,0,28,163.31V208a20,20,0,0,0,20,20H92.69a19.86,19.86,0,0,0,14.14-5.86L230.14,98.82a20,20,0,0,0,0-28.28ZM91,204H52V165l84-84,39,39ZM192,103,153,64l18.34-18.34,39,39Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ a16.createElement("path", { d: "M227.31,73.37,182.63,28.68a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L227.31,96a16,16,0,0,0,0-22.63ZM92.69,208H48V163.31l88-88L180.69,120ZM192,108.68,147.31,64l24-24L216,84.68Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a16.createElement(a16.Fragment, null, /* @__PURE__ */ a16.createElement("path", { d: "M227.31,73.37,182.63,28.68a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L227.31,96a16,16,0,0,0,0-22.63ZM192,108.68,147.31,64l24-24L216,84.68Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a16.createElement(a16.Fragment, null, /* @__PURE__ */ a16.createElement("path", { d: "M225.9,74.78,181.21,30.09a14,14,0,0,0-19.8,0L38.1,153.41a13.94,13.94,0,0,0-4.1,9.9V208a14,14,0,0,0,14,14H92.69a13.94,13.94,0,0,0,9.9-4.1L225.9,94.58a14,14,0,0,0,0-19.8ZM94.1,209.41a2,2,0,0,1-1.41.59H48a2,2,0,0,1-2-2V163.31a2,2,0,0,1,.59-1.41L136,72.48,183.51,120ZM217.41,86.1,192,111.51,144.49,64,169.9,38.58a2,2,0,0,1,2.83,0l44.68,44.69a2,2,0,0,1,0,2.83Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a16.createElement(a16.Fragment, null, /* @__PURE__ */ a16.createElement("path", { d: "M227.31,73.37,182.63,28.68a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L227.31,96a16,16,0,0,0,0-22.63ZM92.69,208H48V163.31l88-88L180.69,120ZM192,108.68,147.31,64l24-24L216,84.68Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a16.createElement(a16.Fragment, null, /* @__PURE__ */ a16.createElement("path", { d: "M224.49,76.2,179.8,31.51a12,12,0,0,0-17,0L133.17,61.17h0L39.52,154.83A11.9,11.9,0,0,0,36,163.31V208a12,12,0,0,0,12,12H92.69a12,12,0,0,0,8.48-3.51L224.48,93.17a12,12,0,0,0,0-17Zm-129,134.63A4,4,0,0,1,92.69,212H48a4,4,0,0,1-4-4V163.31a4,4,0,0,1,1.17-2.83L136,69.65,186.34,120ZM218.83,87.51,192,114.34,141.66,64l26.82-26.83a4,4,0,0,1,5.66,0l44.69,44.68a4,4,0,0,1,0,5.66Z" }))
  ]
]);
...
var a17 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e16.createElement(e16.Fragment, null, /* @__PURE__ */ e16.createElement("path", { d: "M234.49,111.07,90.41,22.94A20,20,0,0,0,60,39.87V216.13a20,20,0,0,0,30.41,16.93l144.08-88.13a19.82,19.82,0,0,0,0-33.86ZM84,208.85V47.15L216.16,128Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ e16.createElement("path", { d: "M232.4,114.49,88.32,26.35a16,16,0,0,0-16.2-.3A15.86,15.86,0,0,0,64,39.87V216.13A15.94,15.94,0,0,0,80,232a16.07,16.07,0,0,0,8.36-2.35L232.4,141.51a15.81,15.81,0,0,0,0-27ZM80,215.94V40l143.83,88Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e16.createElement(e16.Fragment, null, /* @__PURE__ */ e16.createElement("path", { d: "M240,128a15.74,15.74,0,0,1-7.6,13.51L88.32,229.65a16,16,0,0,1-16.2.3A15.86,15.86,0,0,1,64,216.13V39.87a15.86,15.86,0,0,1,8.12-13.82,16,16,0,0,1,16.2.3L232.4,114.49A15.74,15.74,0,0,1,240,128Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e16.createElement(e16.Fragment, null, /* @__PURE__ */ e16.createElement("path", { d: "M231.36,116.19,87.28,28.06a14,14,0,0,0-14.18-.27A13.69,13.69,0,0,0,66,39.87V216.13a13.69,13.69,0,0,0,7.1,12.08,14,14,0,0,0,14.18-.27l144.08-88.13a13.82,13.82,0,0,0,0-23.62Zm-6.26,13.38L81,217.7a2,2,0,0,1-2.06,0,1.78,1.78,0,0,1-1-1.61V39.87a1.78,1.78,0,0,1,1-1.61A2.06,2.06,0,0,1,80,38a2,2,0,0,1,1,.31L225.1,126.43a1.82,1.82,0,0,1,0,3.14Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e16.createElement(e16.Fragment, null, /* @__PURE__ */ e16.createElement("path", { d: "M232.4,114.49,88.32,26.35a16,16,0,0,0-16.2-.3A15.86,15.86,0,0,0,64,39.87V216.13A15.94,15.94,0,0,0,80,232a16.07,16.07,0,0,0,8.36-2.35L232.4,141.51a15.81,15.81,0,0,0,0-27ZM80,215.94V40l143.83,88Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e16.createElement(e16.Fragment, null, /* @__PURE__ */ e16.createElement("path", { d: "M230.32,117.9,86.24,29.79a11.91,11.91,0,0,0-12.17-.23A11.71,11.71,0,0,0,68,39.89V216.11a11.71,11.71,0,0,0,6.07,10.33,11.91,11.91,0,0,0,12.17-.23L230.32,138.1a11.82,11.82,0,0,0,0-20.2Zm-4.18,13.37L82.06,219.39a4,4,0,0,1-4.07.07,3.77,3.77,0,0,1-2-3.35V39.89a3.77,3.77,0,0,1,2-3.35,4,4,0,0,1,4.07.07l144.08,88.12a3.8,3.8,0,0,1,0,6.54Z" }))
  ]
]);
...
var a19 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e17.createElement(e17.Fragment, null, /* @__PURE__ */ e17.createElement("path", { d: "M228,128a12,12,0,0,1-12,12H140v76a12,12,0,0,1-24,0V140H40a12,12,0,0,1,0-24h76V40a12,12,0,0,1,24,0v76h76A12,12,0,0,1,228,128Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ e17.createElement(e17.Fragment, null, /* @__PURE__ */ e17.createElement(
      "path",
      {
        d: "M216,56V200a16,16,0,0,1-16,16H56a16,16,0,0,1-16-16V56A16,16,0,0,1,56,40H200A16,16,0,0,1,216,56Z",
        opacity: "0.2"
      }
    ), /* @__PURE__ */ e17.createElement("path", { d: "M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e17.createElement(e17.Fragment, null, /* @__PURE__ */ e17.createElement("path", { d: "M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM184,136H136v48a8,8,0,0,1-16,0V136H72a8,8,0,0,1,0-16h48V72a8,8,0,0,1,16,0v48h48a8,8,0,0,1,0,16Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e17.createElement(e17.Fragment, null, /* @__PURE__ */ e17.createElement("path", { d: "M222,128a6,6,0,0,1-6,6H134v82a6,6,0,0,1-12,0V134H40a6,6,0,0,1,0-12h82V40a6,6,0,0,1,12,0v82h82A6,6,0,0,1,222,128Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e17.createElement(e17.Fragment, null, /* @__PURE__ */ e17.createElement("path", { d: "M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e17.createElement(e17.Fragment, null, /* @__PURE__ */ e17.createElement("path", { d: "M220,128a4,4,0,0,1-4,4H132v84a4,4,0,0,1-8,0V132H40a4,4,0,0,1,0-8h84V40a4,4,0,0,1,8,0v84h84A4,4,0,0,1,220,128Z" }))
  ]
]);
...
var e18 = /* @__PURE__ */ new Map([
  ...
  [
    ...
    ), /* @__PURE__ */ a20.createElement("path", { d: "M208,40H48A16,16,0,0,0,32,56v56c0,52.72,25.52,84.67,46.93,102.19,23.06,18.86,46,25.26,47,25.53a8,8,0,0,0,4.2,0c1-.27,23.91-6.67,47-25.53C198.48,196.67,224,164.72,224,112V56A16,16,0,0,0,208,40Zm0,72c0,37.07-13.66,67.16-40.6,89.42A129.3,129.3,0,0,1,128,223.62a128.25,128.25,0,0,1-38.92-21.81C61.82,179.51,48,149.3,48,112l0-56,160,0ZM82.34,141.66a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35a8,8,0,0,1,11.32,11.32l-56,56a8,8,0,0,1-11.32,0Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a20.createElement(a20.Fragment, null, /* @__PURE__ */ a20.createElement("path", { d: "M208,40H48A16,16,0,0,0,32,56v56c0,52.72,25.52,84.67,46.93,102.19,23.06,18.86,46,25.26,47,25.53a8,8,0,0,0,4.2,0c1-.27,23.91-6.67,47-25.53C198.48,196.67,224,164.72,224,112V56A16,16,0,0,0,208,40Zm-34.32,69.66-56,56a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35a8,8,0,0,1,11.32,11.32Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a20.createElement(a20.Fragment, null, /* @__PURE__ */ a20.createElement("path", { d: "M208,42H48A14,14,0,0,0,34,56v56c0,51.94,25.12,83.4,46.2,100.64,22.73,18.6,45.27,24.89,46.22,25.15a6,6,0,0,0,3.16,0c.95-.26,23.49-6.55,46.22-25.15C196.88,195.4,222,163.94,222,112V56A14,14,0,0,0,208,42Zm2,70c0,37.76-13.94,68.39-41.44,91.06A131.17,131.17,0,0,1,128,225.72a130.94,130.94,0,0,1-40.56-22.66C59.94,180.39,46,149.76,46,112V56a2,2,0,0,1,2-2H208a2,2,0,0,1,2,2ZM172.24,99.76a6,6,0,0,1,0,8.48l-56,56a6,6,0,0,1-8.48,0l-24-24a6,6,0,0,1,8.48-8.48L112,151.51l51.76-51.75A6,6,0,0,1,172.24,99.76Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a20.createElement(a20.Fragment, null, /* @__PURE__ */ a20.createElement("path", { d: "M208,40H48A16,16,0,0,0,32,56v56c0,52.72,25.52,84.67,46.93,102.19,23.06,18.86,46,25.26,47,25.53a8,8,0,0,0,4.2,0c1-.27,23.91-6.67,47-25.53C198.48,196.67,224,164.72,224,112V56A16,16,0,0,0,208,40Zm0,72c0,37.07-13.66,67.16-40.6,89.42A129.3,129.3,0,0,1,128,223.62a128.25,128.25,0,0,1-38.92-21.81C61.82,179.51,48,149.3,48,112l0-56,160,0ZM82.34,141.66a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35a8,8,0,0,1,11.32,11.32l-56,56a8,8,0,0,1-11.32,0Z" }))
  ...
  [
    "thin",
    /* @__PURE__ */ a20.createElement(a20.Fragment, null, /* @__PURE__ */ a20.createElement("path", { d: "M208,44H48A12,12,0,0,0,36,56v56c0,51.16,24.73,82.12,45.47,99.1,22.4,18.32,44.55,24.5,45.48,24.76a4,4,0,0,0,2.1,0c.93-.26,23.08-6.44,45.48-24.76,20.74-17,45.47-47.94,45.47-99.1V56A12,12,0,0,0,208,44Zm4,68c0,38.44-14.23,69.63-42.29,92.71A132.45,132.45,0,0,1,128,227.82a132.23,132.23,0,0,1-41.71-23.11C58.23,181.63,44,150.44,44,112V56a4,4,0,0,1,4-4H208a4,4,0,0,1,4,4Zm-41.17-10.83a4,4,0,0,1,0,5.66l-56,56a4,4,0,0,1-5.66,0l-24-24a4,4,0,0,1,5.66-5.66L112,154.34l53.17-53.17A4,4,0,0,1,170.83,101.17Z" }))
  ]
]);
...
var e19 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a21.createElement(a21.Fragment, null, /* @__PURE__ */ a21.createElement("path", { d: "M140,32V64a12,12,0,0,1-24,0V32a12,12,0,0,1,24,0Zm84,84H192a12,12,0,0,0,0,24h32a12,12,0,0,0,0-24Zm-42.26,48.77a12,12,0,1,0-17,17l22.63,22.63a12,12,0,0,0,17-17ZM128,180a12,12,0,0,0-12,12v32a12,12,0,0,0,24,0V192A12,12,0,0,0,128,180ZM74.26,164.77,51.63,187.4a12,12,0,0,0,17,17l22.63-22.63a12,12,0,1,0-17-17ZM76,128a12,12,0,0,0-12-12H32a12,12,0,0,0,0,24H64A12,12,0,0,0,76,128ZM68.6,51.63a12,12,0,1,0-17,17L74.26,91.23a12,12,0,0,0,17-17Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ a21.createElement(a21.Fragment, null, /* @__PURE__ */ a21.createElement("path", { d: "M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z", opacity: "0.2" }), /* @__PURE__ */ a21.createElement("path", { d: "M136,32V64a8,8,0,0,1-16,0V32a8,8,0,0,1,16,0Zm88,88H192a8,8,0,0,0,0,16h32a8,8,0,0,0,0-16Zm-45.09,47.6a8,8,0,0,0-11.31,11.31l22.62,22.63a8,8,0,0,0,11.32-11.32ZM128,184a8,8,0,0,0-8,8v32a8,8,0,0,0,16,0V192A8,8,0,0,0,128,184ZM77.09,167.6,54.46,190.22a8,8,0,0,0,11.32,11.32L88.4,178.91A8,8,0,0,0,77.09,167.6ZM72,128a8,8,0,0,0-8-8H32a8,8,0,0,0,0,16H64A8,8,0,0,0,72,128ZM65.78,54.46A8,8,0,0,0,54.46,65.78L77.09,88.4A8,8,0,0,0,88.4,77.09Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a21.createElement(a21.Fragment, null, /* @__PURE__ */ a21.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24ZM48,136a8,8,0,0,1,0-16H72a8,8,0,0,1,0,16Zm46.06,37.25-17,17a8,8,0,0,1-11.32-11.32l17-17a8,8,0,0,1,11.31,11.31Zm0-79.19a8,8,0,0,1-11.31,0l-17-17A8,8,0,0,1,77.09,65.77l17,17A8,8,0,0,1,94.06,94.06ZM136,208a8,8,0,0,1-16,0V184a8,8,0,0,1,16,0Zm0-136a8,8,0,0,1-16,0V48a8,8,0,0,1,16,0Zm54.23,118.23a8,8,0,0,1-11.32,0l-17-17a8,8,0,0,1,11.31-11.31l17,17A8,8,0,0,1,190.23,190.23ZM208,136H184a8,8,0,0,1,0-16h24a8,8,0,0,1,0,16Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a21.createElement(a21.Fragment, null, /* @__PURE__ */ a21.createElement("path", { d: "M134,32V64a6,6,0,0,1-12,0V32a6,6,0,0,1,12,0Zm90,90H192a6,6,0,0,0,0,12h32a6,6,0,0,0,0-12Zm-46.5,47A6,6,0,0,0,169,177.5l22.63,22.62a6,6,0,0,0,8.48-8.48ZM128,186a6,6,0,0,0-6,6v32a6,6,0,0,0,12,0V192A6,6,0,0,0,128,186ZM78.5,169,55.88,191.64a6,6,0,1,0,8.48,8.48L87,177.5A6,6,0,1,0,78.5,169ZM70,128a6,6,0,0,0-6-6H32a6,6,0,0,0,0,12H64A6,6,0,0,0,70,128ZM64.36,55.88a6,6,0,0,0-8.48,8.48L78.5,87A6,6,0,1,0,87,78.5Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a21.createElement(a21.Fragment, null, /* @__PURE__ */ a21.createElement("path", { d: "M136,32V64a8,8,0,0,1-16,0V32a8,8,0,0,1,16,0Zm88,88H192a8,8,0,0,0,0,16h32a8,8,0,0,0,0-16Zm-45.09,47.6a8,8,0,0,0-11.31,11.31l22.62,22.63a8,8,0,0,0,11.32-11.32ZM128,184a8,8,0,0,0-8,8v32a8,8,0,0,0,16,0V192A8,8,0,0,0,128,184ZM77.09,167.6,54.46,190.22a8,8,0,0,0,11.32,11.32L88.4,178.91A8,8,0,0,0,77.09,167.6ZM72,128a8,8,0,0,0-8-8H32a8,8,0,0,0,0,16H64A8,8,0,0,0,72,128ZM65.78,54.46A8,8,0,0,0,54.46,65.78L77.09,88.4A8,8,0,0,0,88.4,77.09Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a21.createElement(a21.Fragment, null, /* @__PURE__ */ a21.createElement("path", { d: "M132,32V64a4,4,0,0,1-8,0V32a4,4,0,0,1,8,0Zm92,92H192a4,4,0,0,0,0,8h32a4,4,0,0,0,0-8Zm-47.92,46.43a4,4,0,1,0-5.65,5.65l22.62,22.63a4,4,0,0,0,5.66-5.66ZM128,188a4,4,0,0,0-4,4v32a4,4,0,0,0,8,0V192A4,4,0,0,0,128,188ZM79.92,170.43,57.29,193.05A4,4,0,0,0,63,198.71l22.62-22.63a4,4,0,1,0-5.65-5.65ZM68,128a4,4,0,0,0-4-4H32a4,4,0,0,0,0,8H64A4,4,0,0,0,68,128ZM63,57.29A4,4,0,0,0,57.29,63L79.92,85.57a4,4,0,1,0,5.65-5.65Z" }))
  ]
]);
...
var e20 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a22.createElement(a22.Fragment, null, /* @__PURE__ */ a22.createElement("path", { d: "M216,48H180V36A28,28,0,0,0,152,8H104A28,28,0,0,0,76,36V48H40a12,12,0,0,0,0,24h4V208a20,20,0,0,0,20,20H192a20,20,0,0,0,20-20V72h4a12,12,0,0,0,0-24ZM100,36a4,4,0,0,1,4-4h48a4,4,0,0,1,4,4V48H100Zm88,168H68V72H188ZM116,104v64a12,12,0,0,1-24,0V104a12,12,0,0,1,24,0Zm48,0v64a12,12,0,0,1-24,0V104a12,12,0,0,1,24,0Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ a22.createElement(a22.Fragment, null, /* @__PURE__ */ a22.createElement("path", { d: "M200,56V208a8,8,0,0,1-8,8H64a8,8,0,0,1-8-8V56Z", opacity: "0.2" }), /* @__PURE__ */ a22.createElement("path", { d: "M216,48H176V40a24,24,0,0,0-24-24H104A24,24,0,0,0,80,40v8H40a8,8,0,0,0,0,16h8V208a16,16,0,0,0,16,16H192a16,16,0,0,0,16-16V64h8a8,8,0,0,0,0-16ZM96,40a8,8,0,0,1,8-8h48a8,8,0,0,1,8,8v8H96Zm96,168H64V64H192ZM112,104v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm48,0v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a22.createElement(a22.Fragment, null, /* @__PURE__ */ a22.createElement("path", { d: "M216,48H176V40a24,24,0,0,0-24-24H104A24,24,0,0,0,80,40v8H40a8,8,0,0,0,0,16h8V208a16,16,0,0,0,16,16H192a16,16,0,0,0,16-16V64h8a8,8,0,0,0,0-16ZM112,168a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm48,0a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm0-120H96V40a8,8,0,0,1,8-8h48a8,8,0,0,1,8,8Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a22.createElement(a22.Fragment, null, /* @__PURE__ */ a22.createElement("path", { d: "M216,50H174V40a22,22,0,0,0-22-22H104A22,22,0,0,0,82,40V50H40a6,6,0,0,0,0,12H50V208a14,14,0,0,0,14,14H192a14,14,0,0,0,14-14V62h10a6,6,0,0,0,0-12ZM94,40a10,10,0,0,1,10-10h48a10,10,0,0,1,10,10V50H94ZM194,208a2,2,0,0,1-2,2H64a2,2,0,0,1-2-2V62H194ZM110,104v64a6,6,0,0,1-12,0V104a6,6,0,0,1,12,0Zm48,0v64a6,6,0,0,1-12,0V104a6,6,0,0,1,12,0Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a22.createElement(a22.Fragment, null, /* @__PURE__ */ a22.createElement("path", { d: "M216,48H176V40a24,24,0,0,0-24-24H104A24,24,0,0,0,80,40v8H40a8,8,0,0,0,0,16h8V208a16,16,0,0,0,16,16H192a16,16,0,0,0,16-16V64h8a8,8,0,0,0,0-16ZM96,40a8,8,0,0,1,8-8h48a8,8,0,0,1,8,8v8H96Zm96,168H64V64H192ZM112,104v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm48,0v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Z" }))
...
var e21 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a23.createElement(a23.Fragment, null, /* @__PURE__ */ a23.createElement("path", { d: "M240.26,186.1,152.81,34.23h0a28.74,28.74,0,0,0-49.62,0L15.74,186.1a27.45,27.45,0,0,0,0,27.71A28.31,28.31,0,0,0,40.55,228h174.9a28.31,28.31,0,0,0,24.79-14.19A27.45,27.45,0,0,0,240.26,186.1Zm-20.8,15.7a4.46,4.46,0,0,1-4,2.2H40.55a4.46,4.46,0,0,1-4-2.2,3.56,3.56,0,0,1,0-3.73L124,46.2a4.77,4.77,0,0,1,8,0l87.44,151.87A3.56,3.56,0,0,1,219.46,201.8ZM116,136V104a12,12,0,0,1,24,0v32a12,12,0,0,1-24,0Zm28,40a16,16,0,1,1-16-16A16,16,0,0,1,144,176Z" }))
  ],
  [
    "duotone",
...
var a24 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e22.createElement(e22.Fragment, null, /* @__PURE__ */ e22.createElement("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm0,192a84,84,0,1,1,84-84A84.09,84.09,0,0,1,128,212Zm-12-80V80a12,12,0,0,1,24,0v52a12,12,0,0,1-24,0Zm28,40a16,16,0,1,1-16-16A16,16,0,0,1,144,172Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ e22.createElement(e22.Fragment, null, /* @__PURE__ */ e22.createElement("path", { d: "M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z", opacity: "0.2" }), /* @__PURE__ */ e22.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm-8-80V80a8,8,0,0,1,16,0v56a8,8,0,0,1-16,0Zm20,36a12,12,0,1,1-12-12A12,12,0,0,1,140,172Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e22.createElement(e22.Fragment, null, /* @__PURE__ */ e22.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm-8,56a8,8,0,0,1,16,0v56a8,8,0,0,1-16,0Zm8,104a12,12,0,1,1,12-12A12,12,0,0,1,128,184Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e22.createElement(e22.Fragment, null, /* @__PURE__ */ e22.createElement("path", { d: "M128,26A102,102,0,1,0,230,128,102.12,102.12,0,0,0,128,26Zm0,192a90,90,0,1,1,90-90A90.1,90.1,0,0,1,128,218Zm-6-82V80a6,6,0,0,1,12,0v56a6,6,0,0,1-12,0Zm16,36a10,10,0,1,1-10-10A10,10,0,0,1,138,172Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e22.createElement(e22.Fragment, null, /* @__PURE__ */ e22.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm-8-80V80a8,8,0,0,1,16,0v56a8,8,0,0,1-16,0Zm20,36a12,12,0,1,1-12-12A12,12,0,0,1,140,172Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e22.createElement(e22.Fragment, null, /* @__PURE__ */ e22.createElement("path", { d: "M128,28A100,100,0,1,0,228,128,100.11,100.11,0,0,0,128,28Zm0,192a92,92,0,1,1,92-92A92.1,92.1,0,0,1,128,220Zm-4-84V80a4,4,0,0,1,8,0v56a4,4,0,0,1-8,0Zm12,36a8,8,0,1,1-8-8A8,8,0,0,1,136,172Z" }))
  ]
]);
  ...
  (s6, a31) => {
    ...
    return /* @__PURE__ */ e23.createElement(
      "svg",
      {
        ...
        width: t5 != null ? t5 : l3,
        height: t5 != null ? t5 : l3,
        fill: r6 != null ? r6 : d,
        viewBox: "0 0 256 256",
        transform: c6 || g ? "scale(-1, 1)" : void 0,
        ...w,
        ...x
      },
      !!n11 && /* @__PURE__ */ e23.createElement("title", null, n11),
      i,
      m4.get(o21 != null ? o21 : f2)
    );
  }
);
...
var r2 = o2.forwardRef((t5, e42) => /* @__PURE__ */ o2.createElement(p, { ref: e42, ...t5, weights: a }));
r2.displayName = "ArrowUpRightIcon";
var c = r2;

// node_modules/@phosphor-icons/react/dist/csr/Books.es.js
var o3 = __toESM(require("react"), 1);
var e24 = o3.forwardRef((r6, s6) => /* @__PURE__ */ o3.createElement(p, { ref: s6, ...r6, weights: e2 }));
e24.displayName = "BooksIcon";
var n = e24;

// node_modules/@phosphor-icons/react/dist/csr/CalendarBlank.es.js
var a25 = __toESM(require("react"), 1);
var e25 = a25.forwardRef((o21, r6) => /* @__PURE__ */ a25.createElement(p, { ref: r6, ...o21, weights: e3 }));
e25.displayName = "CalendarBlankIcon";
var c2 = e25;

// node_modules/@phosphor-icons/react/dist/csr/CalendarCheck.es.js
var e26 = __toESM(require("react"), 1);
var a26 = e26.forwardRef((o21, r6) => /* @__PURE__ */ e26.createElement(p, { ref: r6, ...o21, weights: V }));
a26.displayName = "CalendarCheckIcon";
var s = a26;

// node_modules/@phosphor-icons/react/dist/csr/ChatCircleText.es.js
var e27 = __toESM(require("react"), 1);
var t2 = e27.forwardRef((o21, r6) => /* @__PURE__ */ e27.createElement(p, { ref: r6, ...o21, weights: e4 }));
t2.displayName = "ChatCircleTextIcon";
var s2 = t2;

// node_modules/@phosphor-icons/react/dist/csr/ChatsCircle.es.js
var e28 = __toESM(require("react"), 1);
var o4 = e28.forwardRef((r6, t5) => /* @__PURE__ */ e28.createElement(p, { ref: t5, ...r6, weights: e5 }));
o4.displayName = "ChatsCircleIcon";
var m = o4;

// node_modules/@phosphor-icons/react/dist/csr/Check.es.js
var e29 = __toESM(require("react"), 1);
var o5 = e29.forwardRef((c6, r6) => /* @__PURE__ */ e29.createElement(p, { ref: r6, ...c6, weights: a7 }));
o5.displayName = "CheckIcon";
var n2 = o5;

// node_modules/@phosphor-icons/react/dist/csr/CheckCircle.es.js
var e30 = __toESM(require("react"), 1);
var c3 = e30.forwardRef((o21, r6) => /* @__PURE__ */ e30.createElement(p, { ref: r6, ...o21, weights: a8 }));
...
var t3 = o6.forwardRef((n11, c6) => /* @__PURE__ */ o6.createElement(p, { ref: c6, ...n11, weights: e8 }));
t3.displayName = "ClockCountdownIcon";
var s4 = t3;

// node_modules/@phosphor-icons/react/dist/csr/Database.es.js
var a27 = __toESM(require("react"), 1);
var e31 = a27.forwardRef((o21, t5) => /* @__PURE__ */ a27.createElement(p, { ref: t5, ...o21, weights: t }));
e31.displayName = "DatabaseIcon";
var n3 = e31;

// node_modules/@phosphor-icons/react/dist/csr/GearSix.es.js
var e32 = __toESM(require("react"), 1);
var o7 = e32.forwardRef((r6, a31) => /* @__PURE__ */ e32.createElement(p, { ref: a31, ...r6, weights: l }));
o7.displayName = "GearSixIcon";
var s5 = o7;

// node_modules/@phosphor-icons/react/dist/csr/House.es.js
var o8 = __toESM(require("react"), 1);
var e33 = o8.forwardRef((r6, s6) => /* @__PURE__ */ o8.createElement(p, { ref: s6, ...r6, weights: e10 }));
e33.displayName = "HouseIcon";
var n4 = e33;

// node_modules/@phosphor-icons/react/dist/csr/Key.es.js
var e34 = __toESM(require("react"), 1);
var o9 = e34.forwardRef((r6, t5) => /* @__PURE__ */ e34.createElement(p, { ref: t5, ...r6, weights: e11 }));
o9.displayName = "KeyIcon";
var n5 = o9;

// node_modules/@phosphor-icons/react/dist/csr/List.es.js
var o10 = __toESM(require("react"), 1);
var t4 = o10.forwardRef((e42, r6) => /* @__PURE__ */ o10.createElement(p, { ref: r6, ...e42, weights: e12 }));
t4.displayName = "ListIcon";
var c4 = t4;

// node_modules/@phosphor-icons/react/dist/csr/MagnifyingGlass.es.js
var a28 = __toESM(require("react"), 1);
var o11 = a28.forwardRef((s6, n11) => /* @__PURE__ */ a28.createElement(p, { ref: n11, ...s6, weights: a14 }));
o11.displayName = "MagnifyingGlassIcon";
var f = o11;

// node_modules/@phosphor-icons/react/dist/csr/Note.es.js
var o12 = __toESM(require("react"), 1);
var e35 = o12.forwardRef((t5, r6) => /* @__PURE__ */ o12.createElement(p, { ref: r6, ...t5, weights: e14 }));
e35.displayName = "NoteIcon";
var n6 = e35;

// node_modules/@phosphor-icons/react/dist/csr/PencilSimple.es.js
var e36 = __toESM(require("react"), 1);
var o13 = e36.forwardRef((i, m4) => /* @__PURE__ */ e36.createElement(p, { ref: m4, ...i, weights: e15 }));
o13.displayName = "PencilSimpleIcon";
var a29 = o13;

// node_modules/@phosphor-icons/react/dist/csr/Play.es.js
var o14 = __toESM(require("react"), 1);
var a30 = o14.forwardRef((e42, r6) => /* @__PURE__ */ o14.createElement(p, { ref: r6, ...e42, weights: a17 }));
a30.displayName = "PlayIcon";
var n7 = a30;

// node_modules/@phosphor-icons/react/dist/csr/Plug.es.js
var o15 = __toESM(require("react"), 1);
var e37 = o15.forwardRef((r6, t5) => /* @__PURE__ */ o15.createElement(p, { ref: t5, ...r6, weights: l2 }));
e37.displayName = "PlugIcon";
var n8 = e37;

// node_modules/@phosphor-icons/react/dist/csr/Plus.es.js
var o16 = __toESM(require("react"), 1);
var e38 = o16.forwardRef((r6, s6) => /* @__PURE__ */ o16.createElement(p, { ref: s6, ...r6, weights: a19 }));
e38.displayName = "PlusIcon";
var n9 = e38;

// node_modules/@phosphor-icons/react/dist/csr/ShieldCheck.es.js
var e39 = __toESM(require("react"), 1);
var o17 = e39.forwardRef((c6, r6) => /* @__PURE__ */ e39.createElement(p, { ref: r6, ...c6, weights: e18 }));
o17.displayName = "ShieldCheckIcon";
var h = o17;

// node_modules/@phosphor-icons/react/dist/csr/SpinnerGap.es.js
var e40 = __toESM(require("react"), 1);
var o18 = e40.forwardRef((r6, n11) => /* @__PURE__ */ e40.createElement(p, { ref: n11, ...r6, weights: e19 }));
o18.displayName = "SpinnerGapIcon";
var m2 = o18;

// node_modules/@phosphor-icons/react/dist/csr/Trash.es.js
var o19 = __toESM(require("react"), 1);
var r3 = o19.forwardRef((a31, e42) => /* @__PURE__ */ o19.createElement(p, { ref: e42, ...a31, weights: e20 }));
r3.displayName = "TrashIcon";
var n10 = r3;

// node_modules/@phosphor-icons/react/dist/csr/Warning.es.js
var o20 = __toESM(require("react"), 1);
var r4 = o20.forwardRef((n11, a31) => /* @__PURE__ */ o20.createElement(p, { ref: a31, ...n11, weights: e21 }));
r4.displayName = "WarningIcon";
var c5 = r4;

// node_modules/@phosphor-icons/react/dist/csr/WarningCircle.es.js
var r5 = __toESM(require("react"), 1);
var e41 = r5.forwardRef((o21, n11) => /* @__PURE__ */ r5.createElement(p, { ref: n11, ...o21, weights: a24 }));
e41.displayName = "WarningCircleIcon";
var m3 = e41;
  ...
  return import_react3.default.createElement(
    ...
    import_react3.default.createElement(
      ...
      import_react3.default.createElement(
        ...
        }, import_react3.default.createElement(a29, { size: 14, weight: "regular", "aria-hidden": true })),
        import_react3.default.createElement("button", {
          type: "button",
        ...
        }, import_react3.default.createElement(n10, { size: 14, weight: "regular", "aria-hidden": true }))
      )
    ),
    ...
    deleteTarget ? import_react3.default.createElement("div", {
      ...
      import_react3.default.createElement(
        ...
        import_react3.default.createElement(
          ...
          import_react3.default.createElement(n10, { size: 14, "aria-hidden": true }),
...
function TodoDialog({ todo, onSave, onClose, busy, error, timeZone }) {
  ...
  const [title, setTitle] = import_react5.default.useState(todo?.title || "");
  const [date, setDate] = import_react5.default.useState(initial.date);
  const [time, setTime] = import_react5.default.useState(initial.time);
  ...
  return import_react5.default.createElement(
    "div",
    { className: "cpwb-modal-backdrop", role: "presentation", onMouseDown: (event) => {
      if (event.target === event.currentTarget) onClose();
    } },
    import_react5.default.createElement(
      "form",
      { className: "cpwb-modal", role: "dialog", "aria-modal": true, "aria-labelledby": "cpwb-todo-dialog-title", onSubmit: submit },
      import_react5.default.createElement("div", { className: "cpwb-modal-kicker" }, todo ? "TODO / MODIFY" : "TODO / NEW"),
      import_react5.default.createElement("h3", { id: "cpwb-todo-dialog-title" }, todo ? "\u7F16\u8F91\u5F85\u529E" : "\u6DFB\u52A0\u5F85\u529E"),
      import_react5.default.createElement("label", null, "\u6807\u9898", import_react5.default.createElement("input", { autoFocus: true, value: title, onChange: (e42) => setTitle(e42.target.value), placeholder: "\u4F8B\u5982\uFF1A\u5B8C\u6210\u68C0\u7D22\u63A5\u53E3\u5BA1\u8BA1" })),
      import_react5.default.createElement(
        "div",
        { className: "cpwb-form-grid" },
        import_react5.default.createElement("label", null, "\u9884\u8BA1\u5B8C\u6210\u65E5\u671F", import_react5.default.createElement("input", { type: "date", value: date, onChange: (e42) => setDate(e42.target.value) })),
        import_react5.default.createElement("label", null, "\u9884\u8BA1\u5B8C\u6210\u65F6\u95F4", import_react5.default.createElement("input", { type: "time", value: time, onChange: (e42) => setTime(e42.target.value) }))
      ),
      localError || error ? import_react5.default.createElement("div", { className: "cpwb-form-error", role: "alert" }, localError || error.message || String(error)) : null,
      import_react5.default.createElement("div", { className: "cpwb-modal-actions" }, import_react5.default.createElement("button", { type: "button", className: "cpwb-btn", onClick: onClose }, "\u53D6\u6D88"), import_react5.default.createElement("button", { type: "submit", className: "cpwb-btn cpwb-btn-primary", disabled: busy }, busy ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58"))
    )
  );
}
function Todos({ store: store3, projectId }) {
  const state = import_react5.default.useSyncExternalStore(store3.subscribe, store3.getSnapshot, store3.getSnapshot);
  const [dialog, setDialog] = import_react5.default.useState(null);
  ...
  return import_react5.default.createElement(
    ...
    import_react5.default.createElement("div", { className: "cpwb-tool-head" }, import_react5.default.createElement("span", null, "PROJECT TODO // " + String(pending).padStart(2, "0")), import_react5.default.createElement("button", { className: "cpwb-btn cpwb-btn-primary cpwb-button-content", type: "button", onClick: () => setDialog({ todo: null }) }, import_react5.default.createElement(n9, { size: 14, weight: "bold" }), import_react5.default.createElement("span", null, "\u65B0\u589E"))),
    error ? import_react5.default.createElement("div", { className: "cpwb-status cpwb-status-error", role: "alert" }, error.message || String(error)) : null,
    todos.length === 0 ? import_react5.default.createElement(Empty, { glyph: glyph(ICONS.grid) }, "\u6682\u65E0\u5F85\u529E\uFF0C\u6DFB\u52A0\u7B2C\u4E00\u9879") : import_react5.default.createElement("div", { className: "cpwb-list" }, todos.map((todo) => import_react5.default.createElement(
      "article",
      { key: todo.id, className: "cpwb-todo-row" + (todo.done ? " cpwb-item-done" : "") },
      import_react5.default.createElement("button", { type: "button", className: "cpwb-check" + (todo.done ? " cpwb-done" : ""), onClick: () => toggle(todo), "aria-label": todo.done ? "\u6807\u8BB0\u672A\u5B8C\u6210" : "\u6807\u8BB0\u5B8C\u6210" }, todo.done ? import_react5.default.createElement(n2, { size: 14, weight: "bold" }) : null),
      import_react5.default.createElement("button", { type: "button", className: "cpwb-item-main cpwb-todo-details", onClick: () => setDialog({ todo }) }, import_react5.default.createElement("span", { className: "cpwb-item-title" }, todo.title), import_react5.default.createElement("span", { className: "cpwb-item-meta" }, todo.overdue && !todo.done ? "\u5DF2\u903E\u671F \xB7 " : "\u9884\u8BA1\u5B8C\u6210 \xB7 ", localDateTime(todo.dueAt, timeZone), " \xB7 \u521B\u5EFA\u4E8E ", localDateTime(todo.createdAt, timeZone), todo.source === "auto" ? " \xB7 \u81EA\u52A8\u751F\u6210" : "")),
      import_react5.default.createElement("button", { type: "button", className: "cpwb-icon-button", onClick: () => setDialog({ todo }), "aria-label": "\u7F16\u8F91\u5F85\u529E" }, import_react5.default.createElement(a29, { size: 14 }))
    ))),
    dialog ? import_react5.default.createElement(TodoDialog, { todo: dialog.todo, onSave: save, onClose: () => setDialog(null), busy: action?.type === "todo" && action.status === "running", error, timeZone }) : null
  );
}
...
var ACCEPT = ACCEPT_EXTENSIONS.map(function(e42) {
  return "." + e42;
}).join(",");
var DOC_STATUS = {
...
function formatBytes(n11) {
  if (n11 == null) return "";
  if (n11 < 1024) return n11 + " B";
  if (n11 < 1024 * 1024) return (n11 / 1024).toFixed(1) + " KB";
  return (n11 / (1024 * 1024)).toFixed(1) + " MB";
}
  ...
  return import_react7.default.createElement(
    ...
    import_react7.default.createElement(
      ...
      import_react7.default.createElement(
        ...
        glyph(ICONS.doc),
        " " + d.originalName,
        import_react7.default.createElement(Badge, { kind: meta.kind }, meta.label)
      ),
      import_react7.default.createElement(
        "div",
    ...
    canReindex ? import_react7.default.createElement("button", { type: "button", className: "cpwb-btn", disabled: !!reindexing, onClick: function() {
      onReindex(d);
    }, title: "\u91CD\u65B0\u7D22\u5F15" }, glyph(ICONS.refresh), " \u91CD\u65B0\u7D22\u5F15") : null,
    import_react7.default.createElement("button", { type: "button", className: "cpwb-x", disabled: !!unlinkingDoc, onClick: function() {
      onUnlink(d);
    }, title: "\u4ECE\u672C\u77E5\u8BC6\u5E93\u89E3\u9664\u5173\u8054" }, glyph(ICONS.x))
  );
}
function renderCitation(c6, i) {
  return import_react7.default.createElement(
    "div",
    { key: c6.sourceId || c6.originalName + ":" + i, className: "cpwb-citation" },
    import_react7.default.createElement(
      "div",
      { className: "cpwb-citation-head" },
      import_react7.default.createElement("span", { className: "cpwb-citation-file" }, c6.originalName),
      import_react7.default.createElement("span", { className: "cpwb-citation-locator" }, c6.locator || "")
    ),
    c6.heading ? import_react7.default.createElement("div", { className: "cpwb-citation-heading" }, c6.heading) : null,
    import_react7.default.createElement("div", { className: "cpwb-citation-text" }, c6.text)
  );
}
function KnowledgeBase({ store: store3, projectId, knowledgeBaseId, sessions, workspaces, onConversationOpen, view = "all" }) {
  ...
  const newKbState = import_react7.default.useState("");
  const queryState = import_react7.default.useState("");
  const dragState = import_react7.default.useState(false);
  const pendingState = import_react7.default.useState([]);
  ...
  const chatErrorState = import_react7.default.useState(null);
  const chatError = chatErrorState[0];
  const setChatError = chatErrorState[1];
  const openingChatState = import_react7.default.useState(false);
  const openingChat = openingChatState[0];
  const setOpeningChat = openingChatState[1];
  const scopeReadyState = import_react7.default.useState(!standalone);
  ...
  const onDrop = function(e42) {
    e42.preventDefault();
    setDragActive(false);
    if (e42.dataTransfer && e42.dataTransfer.files) handleFiles(e42.dataTransfer.files);
  };
  ...
  return import_react7.default.createElement(
    "div",
    null,
    kbError ? import_react7.default.createElement(
      "div",
      ...
      import_react7.default.createElement("button", { type: "button", className: "cpwb-btn cpwb-btn-primary", onClick: retryError, title: "\u5237\u65B0/\u91CD\u8BD5" }, glyph(ICONS.refresh), " \u5237\u65B0 / \u91CD\u8BD5")
    ) : null,
    showDirectory ? import_react7.default.createElement(
      "div",
      { className: "cpwb-section" },
      import_react7.default.createElement(
        "div",
        { className: "cpwb-section-head" },
        import_react7.default.createElement("div", { className: "cpwb-label" }, "\u77E5\u8BC6\u5E93 \xB7 " + knowledgeBases.length)
      ),
      import_react7.default.createElement(
        "div",
        { className: "cpwb-addrow" },
        import_react7.default.createElement("input", { className: "cpwb-input", value: newKb, placeholder: "\u65B0\u5EFA\u77E5\u8BC6\u5E93\u2026", onChange: function(e42) {
          setNewKb(e42.target.value);
        }, onKeyDown: function(e42) {
          if (e42.key === "Enter") createKb();
        } }),
        import_react7.default.createElement("button", { type: "button", className: "cpwb-btn cpwb-btn-primary", onClick: createKb, title: "\u65B0\u5EFA\u77E5\u8BC6\u5E93", disabled: creatingKb }, glyph(ICONS.plus))
      ),
      knowledgeBases.length === 0 ? import_react7.default.createElement(Empty, { glyph: glyph(ICONS.db, 18) }, "\u6682\u65E0\u77E5\u8BC6\u5E93\uFF0C\u5148\u65B0\u5EFA\u4E00\u4E2A") : import_react7.default.createElement("div", { className: "cpwb-kb-list" }, knowledgeBases.map(function(kb) {
        ...
        return import_react7.default.createElement(
          ...
          projectId != null && isLinked ? import_react7.default.createElement("button", { type: "button", className: "cpwb-btn cpwb-btn-danger", onClick: function() {
            store3.actions.unlinkProjectKnowledgeBase(projectId, kb.id).catch(function() {
            });
          }, title: "\u89E3\u9664\u4E0E\u672C\u9879\u76EE\u7684\u5173\u8054", disabled: unlinkingKb }, "\u89E3\u9664\u5173\u8054") : projectId != null ? import_react7.default.createElement("button", { type: "button", className: "cpwb-btn", onClick: function() {
            store3.actions.linkProjectKnowledgeBase(projectId, kb.id).catch(function() {
            });
          }, title: "\u5173\u8054\u5230\u672C\u9879\u76EE", disabled: linking }, "\u5173\u8054") : null,
          import_react7.default.createElement("button", { type: "button", className: "cpwb-icon-button cpwb-danger-icon", onClick: function() {
            setDeleteTarget(kb);
          }, title: "\u5220\u9664\u77E5\u8BC6\u5E93", "aria-label": "\u5220\u9664\u77E5\u8BC6\u5E93 " + kb.name }, import_react7.default.createElement(n10, { size: 14 }))
        );
      }))
    ) : null,
    showDocuments ? import_react7.default.createElement(
      "div",
      { className: "cpwb-section" },
      import_react7.default.createElement(
        "div",
        { className: "cpwb-section-head" },
        import_react7.default.createElement("div", { className: "cpwb-label" }, "\u6587\u6863"),
        import_react7.default.createElement("button", { type: "button", className: "cpwb-btn", onClick: refreshStatus, title: "\u5237\u65B0\u72B6\u6001" }, glyph(ICONS.refresh), " \u5237\u65B0\u72B6\u6001")
      ),
      selectedId != null ? import_react7.default.createElement(
        "label",
        {
          className: "cpwb-drop" + (dragActive ? " cpwb-drop-active" : ""),
          onDrop,
          onDragOver: function(e42) {
            e42.preventDefault();
        ...
        import_react7.default.createElement("input", { type: "file", multiple: true, accept: ACCEPT, disabled: uploading, style: { display: "none" }, onChange: function(e42) {
          handleFiles(e42.target.files);
          e42.target.value = "";
        } }),
        glyph(ICONS.upload),
        " \u9009\u62E9\u6587\u4EF6\u6216\u62D6\u62FD\u5230\u300C" + (selected ? selected.name : "\u77E5\u8BC6\u5E93") + "\u300D"
      ) : import_react7.default.createElement(Empty, { glyph: glyph(ICONS.db, 18) }, "\u9009\u62E9\u6216\u65B0\u5EFA\u77E5\u8BC6\u5E93\u540E\u4E0A\u4F20\u6587\u4EF6"),
      pending.length > 0 ? import_react7.default.createElement(
        "div",
        { className: "cpwb-upload-block" },
        import_react7.default.createElement("div", { className: "cpwb-item-meta" }, "\u4E0A\u4F20\u8FDB\u5EA6 " + uploadDone + "/" + uploadTotal),
        pending.map(function(p2) {
          const label = uploadStatusLabel(p2.index, uploadAction);
          return import_react7.default.createElement(
            "div",
            { key: p2.key, className: "cpwb-upload-file" },
            import_react7.default.createElement("span", { className: "cpwb-item-title" }, p2.name),
            import_react7.default.createElement(Badge, { kind: label === "\u5931\u8D25" ? "overdue" : "pending" }, label)
          );
        })
      ) : null,
      selectedId == null ? null : documents.length === 0 ? import_react7.default.createElement(Empty, { glyph: glyph(ICONS.doc, 18) }, "\u8BE5\u77E5\u8BC6\u5E93\u6682\u65E0\u6587\u6863") : import_react7.default.createElement("div", { className: "cpwb-list" }, documents.map(function(d) {
        return renderDocumentItem(d, reindex, unlink, reindexing, unlinkingDoc);
      }))
    ) : null,
    selectedId != null && showRetrieval ? import_react7.default.createElement(
      "div",
      { className: "cpwb-section" },
      import_react7.default.createElement("div", { className: "cpwb-section-head" }, import_react7.default.createElement("div", { className: "cpwb-label" }, "\u77E5\u8BC6\u5E93\u68C0\u7D22")),
      import_react7.default.createElement(
        "div",
        { className: "cpwb-addrow" },
        import_react7.default.createElement("input", { className: "cpwb-input", value: query, placeholder: "\u68C0\u7D22\u8BE5\u77E5\u8BC6\u5E93\u2026", onChange: function(e42) {
          setQuery(e42.target.value);
        }, onKeyDown: function(e42) {
          if (e42.key === "Enter") runSearch();
        } }),
        import_react7.default.createElement("button", { type: "button", className: "cpwb-btn cpwb-btn-primary", onClick: runSearch, title: "\u68C0\u7D22", disabled: searching }, glyph(ICONS.search))
      ),
      citations.length === 0 ? import_react7.default.createElement(Empty, { glyph: glyph(ICONS.search, 18) }, "\u8F93\u5165\u5173\u952E\u8BCD\u68C0\u7D22\u77E5\u8BC6\u5E93\u5185\u5BB9") : import_react7.default.createElement("div", { className: "cpwb-citations" }, citations.map(renderCitation))
    ) : null,
    selectedId != null && showSessions ? import_react7.default.createElement(
      "div",
      { className: "cpwb-section" },
      import_react7.default.createElement(
        "div",
        { className: "cpwb-section-head" },
        import_react7.default.createElement("div", { className: "cpwb-label" }, "\u77E5\u8BC6\u5E93\u95EE\u7B54"),
        import_react7.default.createElement("button", { type: "button", className: "cpwb-btn cpwb-btn-primary", onClick: function() {
          openChat(null);
        }, disabled: openingChat, title: "\u65B0\u5EFA\u804A\u5929" }, glyph(ICONS.plus), " \u65B0\u5EFA\u804A\u5929")
      ),
      chatError ? import_react7.default.createElement("div", { className: "cpwb-error-msg" }, chatError) : null,
      knowledgeChats.length === 0 ? import_react7.default.createElement(Empty, { glyph: glyph(ICONS.book, 18) }, "\u9009\u62E9\u77E5\u8BC6\u5E93\u540E\u65B0\u5EFA\u804A\u5929") : import_react7.default.createElement("div", { className: "cpwb-kb-list" }, knowledgeChats.map(function(c6) {
        return import_react7.default.createElement(
          "div",
          { key: c6.id, className: "cpwb-kb-row" },
          import_react7.default.createElement(
            "button",
            { type: "button", className: "cpwb-kb-name", onClick: function() {
              openChat(c6.id);
    ...
    deleteTarget ? import_react7.default.createElement(
      ...
      import_react7.default.createElement(
        ...
        import_react7.default.createElement("div", { className: "cpwb-modal-kicker" }, "KNOWLEDGE / DELETE"),
        import_react7.default.createElement("h3", { id: "cpwb-delete-kb-title" }, "\u5220\u9664\u300C" + deleteTarget.name + "\u300D\uFF1F"),
        import_react7.default.createElement("p", null, "\u77E5\u8BC6\u5E93\u3001\u4F1A\u8BDD\u548C\u4EC5\u5C5E\u4E8E\u5B83\u7684\u6587\u6863/\u5411\u91CF\u5C06\u6C38\u4E45\u5220\u9664\uFF1B\u4ECD\u88AB\u5176\u4ED6\u9879\u76EE\u6216\u77E5\u8BC6\u5E93\u4F7F\u7528\u7684\u5171\u4EAB\u6587\u6863\u4F1A\u4FDD\u7559\u3002"),
        import_react7.default.createElement(
          "div",
          { className: "cpwb-modal-actions" },
          import_react7.default.createElement("button", { type: "button", className: "cpwb-btn", onClick: () => setDeleteTarget(null) }, "\u53D6\u6D88"),
          import_react7.default.createElement("button", { type: "button", className: "cpwb-btn cpwb-btn-danger cpwb-button-content", disabled: deletingKb, onClick: () => store3.actions.deleteKnowledgeBase(deleteTarget.id).then(() => setDeleteTarget(null)).catch(() => {
          }) }, import_react7.default.createElement(n10, { size: 14 }), import_react7.default.createElement("span", null, deletingKb ? "\u5220\u9664\u4E2D\u2026" : "\u6C38\u4E45\u5220\u9664"))
        )
      )
    ) : null
  );
  ...
  return import_react7.default.createElement(
    ...
    import_react7.default.createElement(
      ...
      import_react7.default.createElement(
        "div",
        null,
        import_react7.default.createElement("span", null, "02 / KNOWLEDGE NODES"),
        import_react7.default.createElement("h1", null, "\u77E5\u8BC6\u5E93\u4E2D\u5FC3"),
        import_react7.default.createElement("p", null, "\u4E0A\u4F20\u3001\u5411\u91CF\u5316\u3001\u68C0\u7D22\uFF0C\u5E76\u4ECE\u4EFB\u610F\u77E5\u8BC6\u5E93\u53D1\u8D77\u72EC\u7ACB\u4F1A\u8BDD\u3002")
      )
    ),
    import_react7.default.createElement(
      "section",
      { className: "cpwb-knowledge-center-body" },
      import_react7.default.createElement(KnowledgeBase, { ...props, view: "all" })
    )
  );
}
...
function Feedback({ action, type }) {
  ...
  if (action.status === "running") return import_react9.default.createElement("div", { className: "cpwb-status cpwb-status-loading", role: "status" }, import_react9.default.createElement(m2, iconProps), import_react9.default.createElement("span", null, "\u6267\u884C\u4E2D\u2026"));
  if (action.status === "error") return import_react9.default.createElement("div", { className: "cpwb-status cpwb-status-error", role: "alert" }, import_react9.default.createElement(c5, iconProps), import_react9.default.createElement("span", null, action.error?.message || "\u64CD\u4F5C\u5931\u8D25"));
  if (action.status === "done") return import_react9.default.createElement("div", { className: "cpwb-status cpwb-status-success", role: "status" }, import_react9.default.createElement(s3, iconProps), import_react9.default.createElement("span", null, "\u5DF2\u5B8C\u6210"));
  return null;
}
function ScheduleDialog({ schedule, timeZone, busy, error, onSave, onDelete, onClose }) {
  ...
  const [name, setName] = import_react9.default.useState(schedule?.name || "");
  const [prompt, setPrompt] = import_react9.default.useState(schedule?.prompt || "");
  const [recurrence, setRecurrence] = import_react9.default.useState(inferredRecurrence(schedule));
  ...
  const [enabled, setEnabled] = import_react9.default.useState(schedule?.enabled !== false);
  ...
  return import_react9.default.createElement(
    ...
    import_react9.default.createElement(
      "form",
      { className: "cpwb-modal cpwb-schedule-modal", role: "dialog", "aria-modal": true, "aria-labelledby": "cpwb-schedule-dialog-title", onSubmit: submit },
      import_react9.default.createElement("div", { className: "cpwb-modal-kicker" }, schedule ? "SCHEDULE / DETAILS" : "SCHEDULE / NEW"),
      import_react9.default.createElement("h3", { id: "cpwb-schedule-dialog-title" }, schedule ? "\u5B9A\u65F6\u4EFB\u52A1\u8BE6\u60C5" : "\u65B0\u589E\u5B9A\u65F6\u4EFB\u52A1"),
      import_react9.default.createElement("label", null, "\u4EFB\u52A1\u540D\u79F0", import_react9.default.createElement("input", { autoFocus: true, value: name, onChange: (event) => setName(event.target.value), placeholder: "\u4F8B\u5982\uFF1A\u751F\u6210\u9879\u76EE\u5468\u62A5" })),
      import_react9.default.createElement("label", null, "\u6267\u884C\u63D0\u793A\u8BCD", import_react9.default.createElement("textarea", { value: prompt, onChange: (event) => setPrompt(event.target.value), placeholder: "\u544A\u8BC9\u6A21\u578B\u9700\u8981\u5B8C\u6210\u4EC0\u4E48" })),
      import_react9.default.createElement("div", { className: "cpwb-recurrence-picker", role: "group", "aria-label": "\u91CD\u590D\u9891\u7387" }, Object.entries(RECURRENCE_LABELS).map(([value, label]) => import_react9.default.createElement("button", {
        key: value,
        type: "button",
      ...
      import_react9.default.createElement(
        "div",
        { className: "cpwb-form-grid" },
        import_react9.default.createElement("label", null, recurrence === "once" ? "\u6267\u884C\u65E5\u671F" : "\u9996\u6B21\u6267\u884C\u65E5\u671F", import_react9.default.createElement("input", { type: "date", value: date, onChange: (event) => setDate(event.target.value) })),
        import_react9.default.createElement("label", null, "\u6267\u884C\u65F6\u95F4", import_react9.default.createElement("input", { type: "time", value: time, onChange: (event) => setTime(event.target.value) }))
      ),
      import_react9.default.createElement("label", { className: "cpwb-switch-row" }, import_react9.default.createElement("span", null, "\u542F\u7528\u4EFB\u52A1"), import_react9.default.createElement("input", { type: "checkbox", checked: enabled, onChange: (event) => setEnabled(event.target.checked) })),
      ...
      confirmDelete ? import_react9.default.createElement("div", { className: "cpwb-danger-confirm" }, import_react9.default.createElement("span", null, "\u5220\u9664\u540E\u6267\u884C\u5386\u53F2\u4E5F\u4F1A\u6E05\u9664\u3002"), import_react9.default.createElement("button", { type: "button", className: "cpwb-btn cpwb-btn-danger", disabled: busy, onClick: () => onDelete().catch(() => {
      }) }, "\u786E\u8BA4\u5220\u9664")) : null,
      import_react9.default.createElement(
        "div",
        { className: "cpwb-modal-actions cpwb-modal-actions-split" },
        schedule ? import_react9.default.createElement("button", { type: "button", className: "cpwb-btn cpwb-btn-danger cpwb-button-content", onClick: () => setConfirmDelete(true) }, import_react9.default.createElement(n10, { size: 15 }), import_react9.default.createElement("span", null, "\u5220\u9664")) : import_react9.default.createElement("span", null),
        import_react9.default.createElement("div", { className: "cpwb-row" }, import_react9.default.createElement("button", { type: "button", className: "cpwb-btn", onClick: onClose }, "\u53D6\u6D88"), import_react9.default.createElement("button", { type: "submit", className: "cpwb-btn cpwb-btn-primary", disabled: busy }, busy ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58"))
      )
    )
  );
}
function Automation({ store: store3, projectId, view = "all", initialDialog = null }) {
  ...
  const [dialog, setDialog] = import_react9.default.useState(initialDialog === "create" ? { schedule: null } : null);
  ...
  const scheduleNodes = schedules.map((schedule) => {
    ...
    return import_react9.default.createElement(
      ...
      import_react9.default.createElement("div", { className: "cpwb-schedule-icon" }, import_react9.default.createElement(s4, { size: 18, weight: "regular" })),
      import_react9.default.createElement("div", { className: "cpwb-item-main" }, import_react9.default.createElement("div", { className: "cpwb-item-title" }, schedule.name), import_react9.default.createElement("div", { className: "cpwb-item-meta" }, `${RECURRENCE_LABELS[inferredRecurrence(schedule)]} \xB7 \u4E0B\u6B21 ${fmtTime(schedule.nextRunAt, timeZone)}`), latest ? import_react9.default.createElement("div", { className: "cpwb-item-meta" }, "\u6700\u8FD1\u6267\u884C \xB7 " + (latest.status || "unknown")) : null),
      import_react9.default.createElement("span", { className: "cpwb-schedule-state " + (schedule.enabled === false ? "cpwb-off" : "cpwb-on") }, schedule.enabled === false ? "\u505C\u7528" : "\u8FD0\u884C\u4E2D"),
      import_react9.default.createElement("button", { type: "button", className: "cpwb-icon-button", title: "\u7ACB\u5373\u8FD0\u884C", "aria-label": "\u7ACB\u5373\u8FD0\u884C " + schedule.name, disabled: schedule.enabled === false || action?.type === "runSchedule" && action.scheduleId === schedule.id && action.status === "running", onClick: (event) => {
        event.stopPropagation();
        store3.actions.runSchedule(schedule.id).catch(() => {
        });
      } }, import_react9.default.createElement(n7, { size: 14, weight: "fill" })),
      import_react9.default.createElement("button", { type: "button", className: "cpwb-icon-button", "aria-label": "\u7F16\u8F91 " + schedule.name, onClick: (event) => {
        event.stopPropagation();
        setDialog({ schedule });
      } }, import_react9.default.createElement(a29, { size: 14 }))
    );
  });
  const summaryNodes = summaries.map((summary) => import_react9.default.createElement("article", { key: summary.id, className: "cpwb-summary-entry" }, import_react9.default.createElement("div", { className: "cpwb-item-meta" }, summary.summaryDate + " \xB7 " + summary.status), summary.content || "\u6682\u65E0\u5185\u5BB9"));
  return import_react9.default.createElement(
    "div",
    null,
    view !== "schedule" ? import_react9.default.createElement("section", { className: "cpwb-section" }, import_react9.default.createElement("div", { className: "cpwb-section-head" }, import_react9.default.createElement("div", { className: "cpwb-label" }, "\u81EA\u52A8\u5316\u5F00\u5173")), import_react9.default.createElement("div", { className: "cpwb-toggle-row" }, import_react9.default.createElement("span", null, "21:00 \u6BCF\u65E5\u603B\u7ED3"), import_react9.default.createElement("button", { type: "button", className: "cpwb-toggle" + (automation.summaryEnabled ? " cpwb-on" : ""), onClick: () => toggle("summaryEnabled") }, automation.summaryEnabled ? "\u5F00" : "\u5173")), import_react9.default.createElement("div", { className: "cpwb-toggle-row" }, import_react9.default.createElement("span", null, "21:00 \u6B21\u65E5\u5F85\u529E"), import_react9.default.createElement("button", { type: "button", className: "cpwb-toggle" + (automation.nextDayTodosEnabled ? " cpwb-on" : ""), onClick: () => toggle("nextDayTodosEnabled") }, automation.nextDayTodosEnabled ? "\u5F00" : "\u5173")), import_react9.default.createElement(Feedback, { action, type: "updateAutomation" })) : null,
    view !== "summary" ? import_react9.default.createElement("section", { className: "cpwb-tool-panel" }, import_react9.default.createElement("div", { className: "cpwb-tool-head" }, import_react9.default.createElement("span", null, "SCHEDULES // " + String(schedules.length).padStart(2, "0")), import_react9.default.createElement("button", { type: "button", className: "cpwb-btn cpwb-btn-primary cpwb-button-content", onClick: () => setDialog({ schedule: null }) }, import_react9.default.createElement(n9, { size: 14, weight: "bold" }), import_react9.default.createElement("span", null, "\u65B0\u589E"))), import_react9.default.createElement(Feedback, { action, type: "runSchedule" }), schedules.length === 0 ? import_react9.default.createElement(Empty, { glyph: import_react9.default.createElement(c2, { size: 20 }) }, "\u6682\u65E0\u5B9A\u65F6\u4EFB\u52A1") : import_react9.default.createElement("div", { className: "cpwb-list" }, scheduleNodes)) : null,
    view !== "schedule" ? import_react9.default.createElement("section", { className: "cpwb-section" }, import_react9.default.createElement("div", { className: "cpwb-section-head" }, import_react9.default.createElement("div", { className: "cpwb-label" }, "\u6BCF\u65E5\u603B\u7ED3\u8BB0\u5F55"), import_react9.default.createElement("button", { type: "button", className: "cpwb-btn cpwb-button-content", onClick: () => store3.actions.runSummary({ projectId, summaryDate: localDateKey() }).catch(() => {
    }) }, import_react9.default.createElement(n7, { size: 13 }), import_react9.default.createElement("span", null, "\u7ACB\u5373\u751F\u6210"))), summaries.length === 0 ? import_react9.default.createElement(Empty, { glyph: import_react9.default.createElement(c2, { size: 20 }) }, "\u6682\u65E0\u603B\u7ED3\u8BB0\u5F55") : summaryNodes) : null,
    dialog ? import_react9.default.createElement(ScheduleDialog, { schedule: dialog.schedule, timeZone, busy: scheduleAction?.status === "running", error: scheduleAction?.status === "error" ? scheduleAction.error : null, onSave: save, onDelete: remove, onClose: () => setDialog(null) }) : null
  );
}
...
function useWorkbenchLayoutMode(override) {
  const observed = import_react11.default.useSyncExternalStore(subscribeViewport, viewportSnapshot, () => "desktop");
...
function DrawerDialog({ open, onClose, label, side, triggerRef, children }) {
  const dialogRef = import_react11.default.useRef(null);
  ...
  if (!open) return null;
  return import_react11.default.createElement("dialog", {
    ref: dialogRef,
...
var useBrowserLayoutEffect = typeof window === "undefined" ? import_react12.default.useEffect : import_react12.default.useLayoutEffect;
...
function parseNativeModelSelectionLabel(value) {
  const match = typeof value === "string" ? value.match(/^选择模型，当前\s*(.+?)，推理等级\s*(.+)$/) : null;
  return match ? match[1].trim() + " \xB7 " + match[2].trim() : null;
}
function useNativeModelSelectionLabel(sessionId) {
  const [label, setLabel] = import_react12.default.useState(null);
...
function useProjectRailSeat(projectId) {
  const [nativeDetailsOpen, setNativeDetailsOpen] = import_react12.default.useState(false);
  useBrowserLayoutEffect(function() {
...
function WorkbenchSessionShell(props) {
  const state = import_react12.default.useSyncExternalStore(props.store.subscribe, props.store.getSnapshot, props.store.getSnapshot);
  ...
  const [activeTool, setActiveTool] = import_react12.default.useState("todos");
  ...
  const projectTriggerRef = import_react12.default.useRef(null);
  ...
  let body = null;
  if (projectId != null) {
    if (activeTool === "todos") body = import_react12.default.createElement(Todos, { store: props.store, projectId });
    else if (activeTool === "schedule") body = import_react12.default.createElement(Automation, { store: props.store, projectId, view: "schedule" });
    else if (activeTool === "knowledge") body = import_react12.default.createElement(KnowledgeBase, { store: props.store, projectId, view: "linked" });
    else if (activeTool === "summary") body = import_react12.default.createElement(Automation, { store: props.store, projectId, view: "summary" });
  }
  const projectRail = function(drawer = false) {
    return import_react12.default.createElement(
      ...
      import_react12.default.createElement(
        ...
        import_react12.default.createElement("span", null, "PROJECT SYSTEM"),
        import_react12.default.createElement("h2", null, project?.name || "\u9879\u76EE\u5DE5\u4F5C\u53F0"),
        import_react12.default.createElement("small", null, "\u9879\u76EE\u4E0A\u4E0B\u6587 \xB7 " + String(projectId).padStart(2, "0"))
      ),
      import_react12.default.createElement("nav", { className: "cpwb-project-tool-tabs", "aria-label": "\u9879\u76EE\u5DE5\u5177" }, PROJECT_TOOL_TABS.map(([id, label, IconComponent]) => import_react12.default.createElement("button", {
        type: "button",
        key: id,
        ...
        title: label
      }, import_react12.default.createElement(IconComponent, { size: 18, weight: "regular", "aria-hidden": true }), import_react12.default.createElement("span", null, label)))),
      import_react12.default.createElement("div", { className: "cpwb-project-tool-body" }, body)
    );
  };
  ...
  return import_react12.default.createElement(
    ...
    import_react12.default.createElement(
      ...
      import_react12.default.createElement(
        ...
        import_react12.default.createElement("span", { className: "cpwb-session-context-kind" }, contextType),
        import_react12.default.createElement("strong", null, contextName)
      ),
      import_react12.default.createElement(
        "div",
        { className: "cpwb-session-context-meta" },
        import_react12.default.createElement("small", null, contextDetail),
        import_react12.default.createElement("em", null, selectionLabel)
      )
    ),
    dockedProjectRail ? projectRail(false) : null,
    drawerProjectRail ? import_react12.default.createElement("button", {
    ...
    }, import_react12.default.createElement(s, { size: 18, "aria-hidden": true }), import_react12.default.createElement("span", null, "\u9879\u76EE\u5DE5\u5177")) : null,
    drawerProjectRail ? import_react12.default.createElement(DrawerDialog, {
...
function HarnessWorkbenchLogo() {
  return import_react14.default.createElement(
    ...
    import_react14.default.createElement("title", { id: "cpwb-logo-title" }, "Harness Workbench"),
    import_react14.default.createElement(
      "g",
      { fill: "var(--cpwb-logo-cyan, #4de8f4)", transform: "translate(3 3)" },
      import_react14.default.createElement("text", { x: "9", y: "39", textLength: "166", lengthAdjust: "spacingAndGlyphs", fontFamily: "Rajdhani, sans-serif", fontSize: "39", fontStyle: "italic", fontWeight: "500" }, "HARNESS")
    ),
    import_react14.default.createElement(
      "g",
      { fill: "var(--cpwb-logo-amber, #ffb51b)" },
      import_react14.default.createElement("text", { x: "7", y: "37", textLength: "166", lengthAdjust: "spacingAndGlyphs", fontFamily: "Rajdhani, sans-serif", fontSize: "39", fontStyle: "italic", fontWeight: "500" }, "HARNESS")
    ),
    import_react14.default.createElement("path", { fill: "var(--cpwb-logo-cut, #07090f)", d: "M43 9h8L37 43h-8zM94 8h7L87 44h-7zM146 8h7l-14 36h-7z" }),
    import_react14.default.createElement("path", { fill: "none", stroke: "var(--cpwb-logo-cyan, #4de8f4)", strokeWidth: "1.5", d: "M2 45L28 39M0 49L43 45M159 39L188 31M153 44L190 39" }),
    import_react14.default.createElement("text", { x: "28", y: "63", fill: "var(--cpwb-logo-cyan, #4de8f4)", fontFamily: "Rajdhani, sans-serif", fontSize: "11", fontWeight: "600", letterSpacing: "5" }, "WORKBENCH")
  );
}
function SidebarBrand({ status = "DSH // LOCAL NODE" }) {
  return import_react14.default.createElement(
    ...
    import_react14.default.createElement("div", { className: "cpwb-sidebar-status" }, status),
    import_react14.default.createElement("div", { className: "cpwb-sidebar-wordmark" }, import_react14.default.createElement(HarnessWorkbenchLogo))
  );
}
...
function NavIcon({ component: Component }) {
  return import_react15.default.createElement(Component, { size: 19, weight: ICON_WEIGHT, "aria-hidden": true });
}
  ...
  return import_react15.default.createElement(
    ...
    import_react15.default.createElement(
      ...
      import_react15.default.createElement(
        ...
        import_react15.default.createElement("span", null, "DEEPSEEK"),
        import_react15.default.createElement("small", null, "HARNESS WORKBENCH")
      ),
      import_react15.default.createElement(
        "button",
        { type: "button", className: "cpwb-sidebar-new", onClick: onNewSession },
        import_react15.default.createElement(NavIcon, { component: n9 }),
        import_react15.default.createElement("span", null, "\u65B0\u5EFA\u4F1A\u8BDD")
      ),
      import_react15.default.createElement(
        "nav",
        { className: "cpwb-sidebar-global-nav", "aria-label": "\u4E3B\u5BFC\u822A" },
        nav.map(([id, label, IconComponent]) => import_react15.default.createElement("button", {
          type: "button",
          key: id,
          className: "cpwb-sidebar-nav-item" + (page === id ? " cpwb-active" : ""),
          "aria-current": page === id ? "page" : void 0,
          onClick: () => onNavigate?.(id)
        }, import_react15.default.createElement(NavIcon, { component: IconComponent }), import_react15.default.createElement("span", null, label)))
      )
    ),
    import_react15.default.createElement(
      "section",
      { className: "cpwb-sidebar-recents", "aria-label": "\u6700\u8FD1\u4F1A\u8BDD" },
      import_react15.default.createElement("div", { className: "cpwb-sidebar-section-label" }, "\u6700\u8FD1\u4F1A\u8BDD", import_react15.default.createElement("b", null, String(recent.length).padStart(2, "0"))),
      import_react15.default.createElement(
        "div",
        { className: "cpwb-sidebar-recent-scroll" },
        recent.length === 0 ? import_react15.default.createElement("p", { className: "cpwb-sidebar-empty" }, "\u6682\u65E0\u4F1A\u8BDD") : recent.map((session) => import_react15.default.createElement(
          "button",
          {
            type: "button",
          ...
          import_react15.default.createElement(NavIcon, { component: m }),
          import_react15.default.createElement(
            "span",
            null,
            import_react15.default.createElement("strong", null, session.title || session.displayTitle || session.contextName || "\u672A\u547D\u540D\u4F1A\u8BDD"),
            import_react15.default.createElement("small", null, contextLabel(session))
          )
        )),
        import_react15.default.createElement(
          "button",
    ...
    import_react15.default.createElement(
      ...
      import_react15.default.createElement(
        ...
        import_react15.default.createElement(NavIcon, { component: s5 }),
        import_react15.default.createElement("span", null, "\u8BBE\u7F6E")
      ),
      import_react15.default.createElement(SidebarBrand, { status: "INTELLIGENCE ONLINE" })
    )
  );
}
...
function SessionListPage({ store: store3, onOpenSession }) {
  const state = import_react17.default.useSyncExternalStore(store3.subscribe, store3.getSnapshot, store3.getSnapshot);
  const [query, setQuery] = import_react17.default.useState("");
  const [context, setContext] = import_react17.default.useState("");
  const page = state.sessionPage ?? { items: [], total: 0, limit: 20, offset: 0 };
  const load = import_react17.default.useCallback((offset = 0) => store3.actions.loadAllSessions({
    query: query.trim(),
  ...
  return import_react17.default.createElement(
    ...
    import_react17.default.createElement(
      ...
      import_react17.default.createElement(
        ...
        import_react17.default.createElement("span", null, "03 / CONVERSATIONS"),
        import_react17.default.createElement("h1", null, "\u5168\u90E8\u4F1A\u8BDD"),
        import_react17.default.createElement("p", null, "\u9879\u76EE\u3001\u77E5\u8BC6\u5E93\u4E0E\u72EC\u7ACB\u4F1A\u8BDD\u7EDF\u4E00\u5F52\u6863\u3002")
      ),
      import_react17.default.createElement("div", { className: "cpwb-page-header-stat" }, import_react17.default.createElement("strong", null, page.total), import_react17.default.createElement("span", null, "\u6761\u4F1A\u8BDD"))
    ),
    import_react17.default.createElement(
      "form",
      ...
      import_react17.default.createElement(
        "label",
        null,
        import_react17.default.createElement(f, { size: 18, weight: "regular", "aria-hidden": true }),
        import_react17.default.createElement("input", { value: query, onChange: (event) => setQuery(event.target.value), placeholder: "\u641C\u7D22\u4F1A\u8BDD\u6216\u6765\u6E90", "aria-label": "\u641C\u7D22\u4F1A\u8BDD" })
      ),
      import_react17.default.createElement(
        "select",
        { value: context, onChange: (event) => setContext(event.target.value), "aria-label": "\u4F1A\u8BDD\u7C7B\u578B" },
        import_react17.default.createElement("option", { value: "" }, "\u5168\u90E8\u7C7B\u578B"),
        import_react17.default.createElement("option", { value: "project" }, "\u9879\u76EE"),
        import_react17.default.createElement("option", { value: "knowledge_base" }, "\u77E5\u8BC6\u5E93"),
        import_react17.default.createElement("option", { value: "independent" }, "\u72EC\u7ACB")
      ),
      import_react17.default.createElement("button", { type: "submit" }, "\u68C0\u7D22")
    ),
    state.action?.status === "error" ? import_react17.default.createElement("div", { className: "cpwb-page-error", role: "alert" }, state.action.error?.message || "\u4F1A\u8BDD\u52A0\u8F7D\u5931\u8D25") : null,
    page.items.length === 0 ? import_react17.default.createElement("div", { className: "cpwb-session-list-empty" }, import_react17.default.createElement(s2, { size: 28, weight: "regular" }), import_react17.default.createElement("span", null, "\u6682\u65E0\u5339\u914D\u4F1A\u8BDD")) : import_react17.default.createElement("div", { className: "cpwb-session-list" }, page.items.map((row) => import_react17.default.createElement(
      "button",
      {
        type: "button",
        key: row.sessionId,
      ...
      import_react17.default.createElement(s2, { size: 20, weight: "regular", "aria-hidden": true }),
      import_react17.default.createElement(
        "span",
        null,
        import_react17.default.createElement("strong", null, row.title || row.displayTitle || row.contextName || "\u672A\u547D\u540D\u4F1A\u8BDD"),
        import_react17.default.createElement("small", null, scopeLabel(row))
      ),
      import_react17.default.createElement("time", null, activityLabel(row.updatedAt))
    ))),
    import_react17.default.createElement(
      "footer",
      { className: "cpwb-session-pagination" },
      import_react17.default.createElement("span", null, "\u5171 " + page.total + " \u6761"),
      import_react17.default.createElement(
        "div",
        null,
        import_react17.default.createElement("button", { type: "button", disabled: page.offset <= 0, onClick: () => load(Math.max(0, page.offset - page.limit)).catch(function() {
        }) }, "\u4E0A\u4E00\u9875"),
        import_react17.default.createElement("button", { type: "button", disabled: page.offset + page.limit >= page.total, onClick: () => load(page.offset + page.limit).catch(function() {
        }) }, "\u4E0B\u4E00\u9875")
      )
    )
  );
...
function WorkbenchShell(props) {
  ...
  const view = import_react19.default.useSyncExternalStore(
  ...
  const layoutMode = useWorkbenchLayoutMode(props.layoutMode);
  const [drawerOwner, setDrawerOwner] = import_react19.default.useState(null);
  const navigationTriggerRef = import_react19.default.useRef(null);
  ...
  if (view.page === "conversation") {
    center = import_react19.default.createElement(WorkbenchSessionShell, {
      ...props,
      open: true,
      globalSidebar: true,
    ...
    center = import_react19.default.createElement(KnowledgeCenterPage, {
      store: props.store,
    ...
    center = import_react19.default.createElement(SessionListPage, { store: props.store, onOpenSession: openSession });
  } else {
    center = import_react19.default.createElement(ProjectHome, { ...props, open: true });
  }
  const sidebar = import_react19.default.createElement(WorkbenchSidebar, {
    page: view.page,
  ...
  return import_react19.default.createElement(
    ...
    layoutMode === "mobile" ? import_react19.default.createElement(
      ...
      }, import_react19.default.createElement(c4, { size: 21, "aria-hidden": true })),
      import_react19.default.createElement(DrawerDialog, {
    ...
    import_react19.default.createElement("section", { className: "cpwb-workbench-stage" }, center)
  );
}
...
function ActionMessage({ message }) {
  return message ? import_react21.default.createElement("p", { role: "status", className: "cpwb-settings-message" }, message) : null;
}
function TimezonePanel({ settings, store: store3 }) {
  const [draft, setDraft] = import_react21.default.useState(settings.timezone || "Asia/Shanghai");
  const [message, setMessage] = import_react21.default.useState("");
  const [saving, setSaving] = import_react21.default.useState(false);
  import_react21.default.useEffect(() => setDraft(settings.timezone || "Asia/Shanghai"), [settings.timezone]);
  const save = async () => {
    setSaving(true);
    setMessage("");
    try {
  ...
  return import_react21.default.createElement(
    ...
    import_react21.default.createElement("span", { className: "cpwb-eyebrow" }, "WORKBENCH / GLOBAL TIMEZONE"),
    import_react21.default.createElement("h2", null, "\u5168\u5C40\u65F6\u533A"),
    import_react21.default.createElement("p", null, "\u6240\u6709\u5F85\u529E\u3001\u5B9A\u65F6\u4EFB\u52A1\u3001\u603B\u7ED3\u4E0E\u754C\u9762\u65F6\u95F4\u7EDF\u4E00\u4F7F\u7528 Workbench \u65F6\u533A\u3002"),
    import_react21.default.createElement(
      "select",
      { value: draft, onChange: (event) => setDraft(event.target.value), "aria-label": "Workbench \u65F6\u533A" },
      ...["Asia/Shanghai", "Asia/Tokyo", "Asia/Singapore", "Europe/London", "America/Los_Angeles", "America/New_York", "UTC"].map((zone) => import_react21.default.createElement("option", { key: zone, value: zone }, zone))
    ),
    import_react21.default.createElement("input", { value: draft, onChange: (event) => setDraft(event.target.value), placeholder: "\u5408\u6CD5 IANA ID\uFF0C\u4F8B\u5982 Europe/Berlin", "aria-label": "\u81EA\u5B9A\u4E49 IANA \u65F6\u533A" }),
    import_react21.default.createElement("button", { type: "button", onClick: save, disabled: saving }, saving ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58\u65F6\u533A"),
    import_react21.default.createElement(ActionMessage, { message })
  );
}
function EmbeddingPanel({ settings, store: store3 }) {
  ...
  const [credentialValue, setCredentialValue] = import_react21.default.useState("");
  const [message, setMessage] = import_react21.default.useState("");
  const [saving, setSaving] = import_react21.default.useState(false);
  import_react21.default.useEffect(() => setDraft({
    provider: embedding.provider || "ollama",
    baseUrl: embedding.baseUrl || "http://127.0.0.1:11434",
    model: embedding.model || "qwen3-embedding:0.6b",
    dimensions: embedding.dimensions || 1024,
  ...
  return import_react21.default.createElement(
    "div",
    { className: "cpwb-settings-panel" },
    import_react21.default.createElement("span", { className: "cpwb-eyebrow" }, "KNOWLEDGE / EMBEDDING"),
    import_react21.default.createElement("h2", null, "\u5411\u91CF\u6A21\u578B"),
    import_react21.default.createElement("label", null, "Provider", import_react21.default.createElement("select", { value: draft.provider, onChange: patch("provider") }, import_react21.default.createElement("option", { value: "ollama" }, "Ollama"), import_react21.default.createElement("option", { value: "openai-compatible" }, "OpenAI-compatible"))),
    import_react21.default.createElement("label", null, "Base URL", import_react21.default.createElement("input", { value: draft.baseUrl, onChange: patch("baseUrl"), "aria-label": "Embedding Base URL" })),
    import_react21.default.createElement("label", null, "Model", import_react21.default.createElement("input", { value: draft.model, onChange: patch("model"), "aria-label": "Embedding model" })),
    import_react21.default.createElement("label", null, "Dimensions", import_react21.default.createElement("input", { type: "number", value: draft.dimensions, onChange: patch("dimensions"), "aria-label": "Embedding dimensions" })),
    import_react21.default.createElement("label", null, "Timeout (ms)", import_react21.default.createElement("input", { type: "number", value: draft.timeoutMs, onChange: patch("timeoutMs"), "aria-label": "Embedding timeout" })),
    import_react21.default.createElement("label", null, "Credential reference", import_react21.default.createElement("input", { value: draft.credentialRef, onChange: patch("credentialRef"), "aria-label": "Embedding credential reference" })),
    import_react21.default.createElement(
      "div",
      { className: "cpwb-settings-actions" },
      import_react21.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.testEmbedding(config), "\u5411\u91CF\u670D\u52A1\u8FDE\u63A5\u6B63\u5E38\u3002"), disabled: saving }, "\u6D4B\u8BD5\u8FDE\u63A5"),
      import_react21.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.updateEmbedding(config), "\u5411\u91CF\u914D\u7F6E\u5DF2\u4FDD\u5B58\uFF0C\u7D22\u5F15\u72B6\u6001\u6B63\u5728\u6821\u9A8C\u3002"), disabled: saving }, "\u4FDD\u5B58\u914D\u7F6E")
    ),
    import_react21.default.createElement(
      "fieldset",
      null,
      import_react21.default.createElement("legend", null, "\u51ED\u636E\u72B6\u6001"),
      import_react21.default.createElement("p", null, credential.configured ? `\u5DF2\u914D\u7F6E \xB7 \u6765\u6E90 ${credential.source || "\u672A\u77E5"}` : "\u672A\u914D\u7F6E", credential.readOnly ? " \xB7 \u53EA\u8BFB" : ""),
      import_react21.default.createElement("input", { type: "password", value: credentialValue, onChange: (event) => setCredentialValue(event.target.value), placeholder: "\u8F93\u5165\u65B0\u51ED\u636E", "aria-label": "\u65B0 embedding \u51ED\u636E" }),
      import_react21.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.putEmbeddingCredential({ credentialRef: draft.credentialRef, value: credentialValue }), "\u51ED\u636E\u5DF2\u4EA4\u7531 DSH credentials \u4FDD\u5B58\u3002"), disabled: saving || !draft.credentialRef || !credentialValue }, "\u8BBE\u7F6E / \u66FF\u6362\u51ED\u636E"),
      import_react21.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.deleteEmbeddingCredential({ credentialRef: draft.credentialRef }), "\u51ED\u636E\u5DF2\u6E05\u9664\u3002"), disabled: saving || !draft.credentialRef }, "\u6E05\u9664\u51ED\u636E")
    ),
    import_react21.default.createElement(
      "div",
      { className: "cpwb-settings-index" },
      import_react21.default.createElement("strong", null, `\u7D22\u5F15\u72B6\u6001\uFF1A${index.status || "unknown"}`),
      import_react21.default.createElement("span", null, `\u6587\u6863 ${index.counts?.ready ?? index.documentCount ?? 0}`),
      import_react21.default.createElement("p", null, "\u5F71\u54CD\u8303\u56F4\uFF1A\u5168\u90E8\u77E5\u8BC6\u5E93\u6587\u6863"),
      import_react21.default.createElement("button", { type: "button", onClick: () => {
...
function NetworkPanel({ settings, store: store3 }) {
  ...
  const [draft, setDraft] = import_react21.default.useState({ mode: saved.mode || "inherit", proxyUrl: saved.proxyUrl || "", noProxy: saved.noProxy || "" });
  const [message, setMessage] = import_react21.default.useState("");
  const [saving, setSaving] = import_react21.default.useState(false);
  const [testResult, setTestResult] = import_react21.default.useState(null);
  import_react21.default.useEffect(() => setDraft({ mode: saved.mode || "inherit", proxyUrl: saved.proxyUrl || "", noProxy: saved.noProxy || "" }), [saved.mode, saved.proxyUrl, saved.noProxy]);
  const run = async (action, success) => {
    setSaving(true);
    setMessage("");
    try {
  ...
  return import_react21.default.createElement(
    "div",
    { className: "cpwb-settings-panel" },
    import_react21.default.createElement("span", { className: "cpwb-eyebrow" }, "RUNTIME / NETWORK"),
    import_react21.default.createElement("h2", null, "\u7F51\u7EDC / Proxy"),
    import_react21.default.createElement("label", null, "\u6A21\u5F0F", import_react21.default.createElement("select", { value: draft.mode, onChange: (event) => setDraft({ ...draft, mode: event.target.value }) }, import_react21.default.createElement("option", { value: "inherit" }, "\u7EE7\u627F DSH"), import_react21.default.createElement("option", { value: "direct" }, "\u76F4\u8FDE"), import_react21.default.createElement("option", { value: "custom" }, "\u81EA\u5B9A\u4E49 Proxy"))),
    import_react21.default.createElement("label", null, "Proxy URL", import_react21.default.createElement("input", { value: draft.proxyUrl, onChange: (event) => setDraft({ ...draft, proxyUrl: event.target.value }), "aria-label": "Proxy URL" })),
    import_react21.default.createElement("label", null, "No Proxy", import_react21.default.createElement("input", { value: draft.noProxy, onChange: (event) => setDraft({ ...draft, noProxy: event.target.value }), "aria-label": "No Proxy" })),
    import_react21.default.createElement(
      "div",
      { className: "cpwb-settings-actions" },
      import_react21.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.updateNetwork(draft), "\u7F51\u7EDC\u914D\u7F6E\u5DF2\u4FDD\u5B58\uFF1B\u8FDB\u7A0B\u7EA7\u4EE3\u7406\u5C06\u5728\u4E0B\u6B21\u542F\u52A8\u751F\u6548\u3002"), disabled: saving }, "\u4FDD\u5B58\u7F51\u7EDC"),
      import_react21.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.testNetwork(draft), "\u5DF2\u5B8C\u6210\u5F53\u524D\u751F\u6548\u7F51\u7EDC\u6D4B\u8BD5\uFF1B\u81EA\u5B9A\u4E49\u914D\u7F6E\u5C06\u5728\u4E0B\u6B21\u542F\u52A8\u9A8C\u8BC1\u3002"), disabled: saving }, "\u6D4B\u8BD5\u5F53\u524D\u751F\u6548\u7F51\u7EDC")
    ),
    import_react21.default.createElement("p", null, `\u5F53\u524D\u751F\u6548\uFF1A${network.currentEffective?.mode || "inherit"}`),
    import_react21.default.createElement("p", null, `\u4E0B\u6B21\u542F\u52A8\uFF1A${network.nextLaunch?.mode || network.mode || "inherit"}`),
    import_react21.default.createElement("p", null, network.requiresRestart ? "\u914D\u7F6E\u5DF2\u4FDD\u5B58\uFF0C\u4E0B\u6B21\u542F\u52A8\u751F\u6548\u3002" : "\u5F53\u524D\u8FDB\u7A0B\u5DF2\u4E0E\u4FDD\u5B58\u914D\u7F6E\u4E00\u81F4\u3002"),
    testResult ? import_react21.default.createElement("pre", { "data-network-result": true }, JSON.stringify(testResult)) : null,
    import_react21.default.createElement(ActionMessage, { message })
  );
}
function AuthPanel({ settings, store: store3 }) {
  ...
  const [message, setMessage] = import_react21.default.useState("");
  const [busy, setBusy] = import_react21.default.useState(false);
  ...
  return import_react21.default.createElement(
    "div",
    { className: "cpwb-settings-panel" },
    import_react21.default.createElement("span", { className: "cpwb-eyebrow" }, "CODEX LINK / LOCAL AUTH BRIDGE"),
    import_react21.default.createElement("h2", null, "Codex \u5FEB\u901F\u63A5\u5165"),
    import_react21.default.createElement(
      "div",
      { className: `cpwb-auth-state ${configured ? "cpwb-auth-online" : "cpwb-auth-offline"}` },
      import_react21.default.createElement("span", { className: "cpwb-auth-icon" }, configured ? import_react21.default.createElement(h, { size: 25, weight: "duotone", "aria-hidden": true }) : import_react21.default.createElement(n5, { size: 25, weight: "duotone", "aria-hidden": true })),
      import_react21.default.createElement(
        "div",
        null,
        import_react21.default.createElement("strong", null, configured ? "CODEX LINK / ONLINE" : "CODEX LINK / NOT CONNECTED"),
        import_react21.default.createElement("p", null, configured ? `\u51ED\u636E\u6765\u6E90\uFF1A${auth.source || "DSH credentials"}` : "\u626B\u63CF\u672C\u673A Codex \u767B\u5F55\u7F13\u5B58\uFF0C\u5E76\u5B89\u5168\u63A5\u5165\u5F53\u524D Workbench\u3002")
      )
    ),
    import_react21.default.createElement(
      "div",
      { className: "cpwb-auth-privacy" },
      import_react21.default.createElement(m3, { size: 17, weight: "regular", "aria-hidden": true }),
      import_react21.default.createElement("p", null, "\u626B\u63CF\u53EA\u5728\u70B9\u51FB\u540E\u53D1\u751F\u3002\u4EE4\u724C\u4E0D\u4F1A\u53D1\u9001\u5230\u6D4F\u89C8\u5668\u3001\u5199\u5165 Workbench \u6570\u636E\u5E93\u6216\u663E\u793A\u5728\u65E5\u5FD7\u4E2D\u3002")
    ),
    configured ? import_react21.default.createElement(
      "div",
      { className: "cpwb-settings-actions" },
      import_react21.default.createElement("button", { type: "button", onClick: test, disabled: busy }, busy ? "\u9A8C\u8BC1\u4E2D\u2026" : "\u9A8C\u8BC1\u672C\u5730\u51ED\u636E"),
      import_react21.default.createElement("span", { className: "cpwb-auth-activation" }, "NEXT REQUEST / ACTIVE")
    ) : import_react21.default.createElement(
      "button",
      { type: "button", className: "cpwb-auth-connect", onClick: connect, disabled: busy || auth.canConnect === false },
      busy ? import_react21.default.createElement(import_react21.default.Fragment, null, import_react21.default.createElement(m2, { size: 18, className: "cpwb-spin", "aria-hidden": true }), "\u6B63\u5728\u63A5\u5165\u2026") : import_react21.default.createElement(import_react21.default.Fragment, null, import_react21.default.createElement(n8, { size: 18, weight: "bold", "aria-hidden": true }), "\u626B\u63CF\u5E76\u63A5\u5165 Codex")
    ),
    auth.readOnly ? import_react21.default.createElement("p", null, "\u8BE5\u51ED\u636E\u7531\u542F\u52A8\u73AF\u5883\u63D0\u4F9B\uFF0C\u53EA\u8BFB\u4E14\u4F18\u5148\u4E8E\u672C\u5730\u51ED\u636E\u5E93\u3002") : null,
    auth.canConnect === false && !configured ? import_react21.default.createElement("p", { className: "cpwb-auth-unavailable" }, "\u5F53\u524D DSH credentials \u670D\u52A1\u4E0D\u53EF\u7528\uFF0C\u65E0\u6CD5\u6267\u884C\u81EA\u52A8\u63A5\u5165\u3002") : null,
    import_react21.default.createElement(ActionMessage, { message })
  );
}
function WorkbenchPanel({ section, settings, store: store3 }) {
  if (section === "timezone") return import_react21.default.createElement(TimezonePanel, { settings, store: store3 });
  if (section === "embedding") return import_react21.default.createElement(EmbeddingPanel, { settings, store: store3 });
  if (section === "network") return import_react21.default.createElement(NetworkPanel, { settings, store: store3 });
  if (section === "auth") return import_react21.default.createElement(AuthPanel, { settings, store: store3 });
  return import_react21.default.createElement(
    "div",
    { className: "cpwb-settings-panel" },
    import_react21.default.createElement("span", { className: "cpwb-eyebrow" }, "HARNESS WORKBENCH"),
    import_react21.default.createElement("h2", null, "Workbench \u8BBE\u7F6E"),
    import_react21.default.createElement("p", null, "\u8FD9\u91CC\u662F Workbench \u81EA\u6709\u8BBE\u7F6E\u3002\u6A21\u578B\u3001\u63D2\u4EF6\u4E0E DSH credentials \u7EE7\u7EED\u7531\u539F\u751F DSH \u8BBE\u7F6E\u9875\u9762\u7BA1\u7406\u3002")
  );
}
function WorkbenchSettingsSection({ store: store3, initialActive = "workbench" }) {
  const [active, setActive] = import_react21.default.useState(initialActive);
  const subscribe = store3?.subscribe || (() => () => {
  });
  const getSnapshot = store3?.getSnapshot || (() => ({}));
  const snapshot = import_react21.default.useSyncExternalStore(subscribe, getSnapshot, getSnapshot) || {};
  ...
  return import_react21.default.createElement(
    ...
    import_react21.default.createElement(
      ...
      import_react21.default.createElement(
        "div",
        null,
        import_react21.default.createElement("span", { className: "cpwb-eyebrow" }, "HARNESS WORKBENCH / SYSTEM CONFIG"),
        import_react21.default.createElement("h2", null, "Workbench \u8BBE\u7F6E"),
        import_react21.default.createElement("p", null, "\u9879\u76EE\u5DE5\u4F5C\u53F0\u6269\u5C55\u8BBE\u7F6E\uFF1B\u6A21\u578B\u3001\u63D2\u4EF6\u548C Agent \u9884\u8BBE\u7EE7\u7EED\u7531\u5DE6\u4FA7\u539F\u751F\u5206\u7C7B\u7BA1\u7406\u3002")
      )
    ),
    import_react21.default.createElement(
      "nav",
      { className: "cpwb-settings-nav", "aria-label": "Workbench \u8BBE\u7F6E\u5206\u7C7B" },
      ...WORKBENCH_SECTIONS.map(([id, label]) => import_react21.default.createElement("button", { key: id, type: "button", className: active === id ? "cpwb-active" : "", onClick: () => setActive(id) }, label))
    ),
    import_react21.default.createElement("main", { className: "cpwb-settings-content" }, import_react21.default.createElement(WorkbenchPanel, { section: active, settings, store: store3 }))
  );
}
