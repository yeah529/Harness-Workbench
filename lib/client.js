...
function localDateKey(date = /* @__PURE__ */ new Date()) {
  ...
  const m7 = String(date.getMonth() + 1).padStart(2, "0");
...
function createWorkbenchStore(api) {
  ...
  const actions = {
    ...
    loadKnowledgeChats: async function loadKnowledgeChats2(kbId) {
      await loadKnowledgeChats2.run(kbId);
    },
    ...
    openProjectChat: async function openProjectChat({ projectId, resumeSessionId }) {
      ...
      let result;
      try {
        result = await runAction("openProjectChat", () => api.chat.sessions.create({ projectId, resumeSessionId }, { signal: ac.signal }));
      } finally {
        untrack(ac);
      }
    ...
    openKnowledgeChat: async function openKnowledgeChat({ knowledgeBaseId, chatId, title }) {
      ...
      let result;
      try {
        result = await runAction("openKnowledgeChat", () => api.chat.sessions.create({ knowledgeBaseId, chatId, title }, { signal: ac.signal }));
      } finally {
        untrack(ac);
      }
      registerWorkbenchSession({
    ...
    submitPrompt: async function submitPrompt({ sessionId, question, projectId, knowledgeBaseId }) {
      ...
      let result;
      try {
        result = await runAction("submitPrompt", () => api.chat.prompts.submit({ sessionId, question, projectId, knowledgeBaseId }, { signal: ac.signal }));
      } finally {
        untrack(ac);
      }
  ...
  return {
    ...
    knowledgeChats: {
      list({ knowledgeBaseId, signal } = {}) {
        return request2({ path: "/knowledge-chats", query: { knowledgeBaseId }, signal });
      },
      create({ knowledgeBaseId, title }, { signal } = {}) {
        return request2({ method: "POST", path: "/knowledge-chats", body: { knowledgeBaseId, title }, signal });
      }
    },
    chat: {
      sessions: {
        ...
        create({ projectId, knowledgeBaseId, title, chatId, resumeSessionId }, { signal } = {}) {
          return request2({ method: "POST", path: "/chat/sessions", body: { projectId, knowledgeBaseId, title, chatId, resumeSessionId }, signal });
        }
      },
      prompts: {
        submit({ sessionId, question, projectId, knowledgeBaseId }, { signal } = {}) {
          return request2({ method: "POST", path: "/chat/prompts", body: { sessionId, question, projectId, knowledgeBaseId }, signal });
        }
      }
    }
  };
...
var PAGES = /* @__PURE__ */ new Set(["home", "knowledge", "sessions", "conversation"]);
...
var a2 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e2.createElement(e2.Fragment, null, /* @__PURE__ */ e2.createElement("path", { d: "M228,128a12,12,0,0,1-12,12H69l51.52,51.51a12,12,0,0,1-17,17l-72-72a12,12,0,0,1,0-17l72-72a12,12,0,0,1,17,17L69,116H216A12,12,0,0,1,228,128Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ e2.createElement(e2.Fragment, null, /* @__PURE__ */ e2.createElement("path", { d: "M112,56V200L40,128Z", opacity: "0.2" }), /* @__PURE__ */ e2.createElement("path", { d: "M216,120H120V56a8,8,0,0,0-13.66-5.66l-72,72a8,8,0,0,0,0,11.32l72,72A8,8,0,0,0,120,200V136h96a8,8,0,0,0,0-16ZM104,180.69,51.31,128,104,75.31Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e2.createElement(e2.Fragment, null, /* @__PURE__ */ e2.createElement("path", { d: "M224,128a8,8,0,0,1-8,8H120v64a8,8,0,0,1-13.66,5.66l-72-72a8,8,0,0,1,0-11.32l72-72A8,8,0,0,1,120,56v64h96A8,8,0,0,1,224,128Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e2.createElement(e2.Fragment, null, /* @__PURE__ */ e2.createElement("path", { d: "M222,128a6,6,0,0,1-6,6H54.49l61.75,61.76a6,6,0,1,1-8.48,8.48l-72-72a6,6,0,0,1,0-8.48l72-72a6,6,0,0,1,8.48,8.48L54.49,122H216A6,6,0,0,1,222,128Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e2.createElement(e2.Fragment, null, /* @__PURE__ */ e2.createElement("path", { d: "M224,128a8,8,0,0,1-8,8H59.31l58.35,58.34a8,8,0,0,1-11.32,11.32l-72-72a8,8,0,0,1,0-11.32l72-72a8,8,0,0,1,11.32,11.32L59.31,120H216A8,8,0,0,1,224,128Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e2.createElement(e2.Fragment, null, /* @__PURE__ */ e2.createElement("path", { d: "M220,128a4,4,0,0,1-4,4H49.66l65.17,65.17a4,4,0,0,1-5.66,5.66l-72-72a4,4,0,0,1,0-5.66l72-72a4,4,0,0,1,5.66,5.66L49.66,124H216A4,4,0,0,1,220,128Z" }))
  ]
]);
...
var e3 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a3.createElement(a3.Fragment, null, /* @__PURE__ */ a3.createElement("path", { d: "M228,104a12,12,0,0,1-24,0V69l-59.51,59.51a12,12,0,0,1-17-17L187,52H152a12,12,0,0,1,0-24h64a12,12,0,0,1,12,12Zm-44,24a12,12,0,0,0-12,12v64H52V84h64a12,12,0,0,0,0-24H48A20,20,0,0,0,28,80V208a20,20,0,0,0,20,20H176a20,20,0,0,0,20-20V140A12,12,0,0,0,184,128Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ a3.createElement("path", { d: "M224,104a8,8,0,0,1-16,0V59.32l-66.33,66.34a8,8,0,0,1-11.32-11.32L196.68,48H152a8,8,0,0,1,0-16h64a8,8,0,0,1,8,8Zm-40,24a8,8,0,0,0-8,8v72H48V80h72a8,8,0,0,0,0-16H48A16,16,0,0,0,32,80V208a16,16,0,0,0,16,16H176a16,16,0,0,0,16-16V136A8,8,0,0,0,184,128Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a3.createElement(a3.Fragment, null, /* @__PURE__ */ a3.createElement("path", { d: "M192,136v72a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V80A16,16,0,0,1,48,64h72a8,8,0,0,1,0,16H48V208H176V136a8,8,0,0,1,16,0Zm32-96a8,8,0,0,0-8-8H152a8,8,0,0,0-5.66,13.66L172.69,72l-42.35,42.34a8,8,0,0,0,11.32,11.32L184,83.31l26.34,26.35A8,8,0,0,0,224,104Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a3.createElement(a3.Fragment, null, /* @__PURE__ */ a3.createElement("path", { d: "M222,104a6,6,0,0,1-12,0V54.49l-69.75,69.75a6,6,0,0,1-8.48-8.48L201.51,46H152a6,6,0,0,1,0-12h64a6,6,0,0,1,6,6Zm-38,26a6,6,0,0,0-6,6v72a2,2,0,0,1-2,2H48a2,2,0,0,1-2-2V80a2,2,0,0,1,2-2h72a6,6,0,0,0,0-12H48A14,14,0,0,0,34,80V208a14,14,0,0,0,14,14H176a14,14,0,0,0,14-14V136A6,6,0,0,0,184,130Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a3.createElement(a3.Fragment, null, /* @__PURE__ */ a3.createElement("path", { d: "M224,104a8,8,0,0,1-16,0V59.32l-66.33,66.34a8,8,0,0,1-11.32-11.32L196.68,48H152a8,8,0,0,1,0-16h64a8,8,0,0,1,8,8Zm-40,24a8,8,0,0,0-8,8v72H48V80h72a8,8,0,0,0,0-16H48A16,16,0,0,0,32,80V208a16,16,0,0,0,16,16H176a16,16,0,0,0,16-16V136A8,8,0,0,0,184,128Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a3.createElement(a3.Fragment, null, /* @__PURE__ */ a3.createElement("path", { d: "M220,104a4,4,0,0,1-8,0V49.66l-73.16,73.17a4,4,0,0,1-5.66-5.66L206.34,44H152a4,4,0,0,1,0-8h64a4,4,0,0,1,4,4Zm-36,28a4,4,0,0,0-4,4v72a4,4,0,0,1-4,4H48a4,4,0,0,1-4-4V80a4,4,0,0,1,4-4h72a4,4,0,0,0,0-8H48A12,12,0,0,0,36,80V208a12,12,0,0,0,12,12H176a12,12,0,0,0,12-12V136A4,4,0,0,0,184,132Z" }))
  ]
]);
...
var a4 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e4.createElement(e4.Fragment, null, /* @__PURE__ */ e4.createElement("path", { d: "M204,64V168a12,12,0,0,1-24,0V93L72.49,200.49a12,12,0,0,1-17-17L163,76H88a12,12,0,0,1,0-24H192A12,12,0,0,1,204,64Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ e4.createElement(e4.Fragment, null, /* @__PURE__ */ e4.createElement("path", { d: "M192,64V168L88,64Z", opacity: "0.2" }), /* @__PURE__ */ e4.createElement("path", { d: "M192,56H88a8,8,0,0,0-5.66,13.66L128.69,116,58.34,186.34a8,8,0,0,0,11.32,11.32L140,127.31l46.34,46.35A8,8,0,0,0,200,168V64A8,8,0,0,0,192,56Zm-8,92.69-38.34-38.34h0L107.31,72H184Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e4.createElement(e4.Fragment, null, /* @__PURE__ */ e4.createElement("path", { d: "M200,64V168a8,8,0,0,1-13.66,5.66L140,127.31,69.66,197.66a8,8,0,0,1-11.32-11.32L128.69,116,82.34,69.66A8,8,0,0,1,88,56H192A8,8,0,0,1,200,64Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e4.createElement(e4.Fragment, null, /* @__PURE__ */ e4.createElement("path", { d: "M198,64V168a6,6,0,0,1-12,0V78.48L68.24,196.24a6,6,0,0,1-8.48-8.48L177.52,70H88a6,6,0,0,1,0-12H192A6,6,0,0,1,198,64Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e4.createElement(e4.Fragment, null, /* @__PURE__ */ e4.createElement("path", { d: "M200,64V168a8,8,0,0,1-16,0V83.31L69.66,197.66a8,8,0,0,1-11.32-11.32L172.69,72H88a8,8,0,0,1,0-16H192A8,8,0,0,1,200,64Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e4.createElement(e4.Fragment, null, /* @__PURE__ */ e4.createElement("path", { d: "M196,64V168a4,4,0,0,1-8,0V73.66L66.83,194.83a4,4,0,0,1-5.66-5.66L182.34,68H88a4,4,0,0,1,0-8H192A4,4,0,0,1,196,64Z" }))
  ]
]);
...
var e8 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a8.createElement(a8.Fragment, null, /* @__PURE__ */ a8.createElement("path", { d: "M120,128a16,16,0,1,1-16-16A16,16,0,0,1,120,128Zm32-16a16,16,0,1,0,16,16A16,16,0,0,0,152,112Zm84,16A108,108,0,0,1,78.77,224.15L46.34,235A20,20,0,0,1,21,209.66l10.81-32.43A108,108,0,1,1,236,128Zm-24,0A84,84,0,1,0,55.27,170.06a12,12,0,0,1,1,9.81l-9.93,29.79,29.79-9.93a12.1,12.1,0,0,1,3.8-.62,12,12,0,0,1,6,1.62A84,84,0,0,0,212,128Z" }))
  ],
  [
    "duotone",
  ...
  [
    "fill",
    /* @__PURE__ */ a8.createElement(a8.Fragment, null, /* @__PURE__ */ a8.createElement("path", { d: "M128,24A104,104,0,0,0,36.18,176.88L24.83,210.93a16,16,0,0,0,20.24,20.24l34.05-11.35A104,104,0,1,0,128,24ZM84,140a12,12,0,1,1,12-12A12,12,0,0,1,84,140Zm44,0a12,12,0,1,1,12-12A12,12,0,0,1,128,140Zm44,0a12,12,0,1,1,12-12A12,12,0,0,1,172,140Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a8.createElement(a8.Fragment, null, /* @__PURE__ */ a8.createElement("path", { d: "M138,128a10,10,0,1,1-10-10A10,10,0,0,1,138,128ZM84,118a10,10,0,1,0,10,10A10,10,0,0,0,84,118Zm88,0a10,10,0,1,0,10,10A10,10,0,0,0,172,118Zm58,10A102,102,0,0,1,79.31,217.65L44.44,229.27a14,14,0,0,1-17.71-17.71l11.62-34.87A102,102,0,1,1,230,128Zm-12,0A90,90,0,1,0,50.08,173.06a6,6,0,0,1,.5,4.91L38.12,215.35a2,2,0,0,0,2.53,2.53L78,205.42a6.2,6.2,0,0,1,1.9-.31,6.09,6.09,0,0,1,3,.81A90,90,0,0,0,218,128Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a8.createElement(a8.Fragment, null, /* @__PURE__ */ a8.createElement("path", { d: "M140,128a12,12,0,1,1-12-12A12,12,0,0,1,140,128ZM84,116a12,12,0,1,0,12,12A12,12,0,0,0,84,116Zm88,0a12,12,0,1,0,12,12A12,12,0,0,0,172,116Zm60,12A104,104,0,0,1,79.12,219.82L45.07,231.17a16,16,0,0,1-20.24-20.24l11.35-34.05A104,104,0,1,1,232,128Zm-16,0A88,88,0,1,0,51.81,172.06a8,8,0,0,1,.66,6.54L40,216,77.4,203.53a7.85,7.85,0,0,1,2.53-.42,8,8,0,0,1,4,1.08A88,88,0,0,0,216,128Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a8.createElement(a8.Fragment, null, /* @__PURE__ */ a8.createElement("path", { d: "M136,128a8,8,0,1,1-8-8A8,8,0,0,1,136,128Zm-52-8a8,8,0,1,0,8,8A8,8,0,0,0,84,120Zm88,0a8,8,0,1,0,8,8A8,8,0,0,0,172,120Zm56,8A100,100,0,0,1,79.5,215.47l-35.69,11.9a12,12,0,0,1-15.18-15.18l11.9-35.69A100,100,0,1,1,228,128Zm-8,0A92,92,0,1,0,48.35,174.07a4,4,0,0,1,.33,3.27L36.22,214.72a4,4,0,0,0,5.06,5.06l37.38-12.46a3.93,3.93,0,0,1,1.27-.21,4.05,4.05,0,0,1,2,.54A92,92,0,0,0,220,128Z" }))
  ]
]);
...
var e9 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a9.createElement(a9.Fragment, null, /* @__PURE__ */ a9.createElement("path", { d: "M172,108a12,12,0,0,1-12,12H96a12,12,0,0,1,0-24h64A12,12,0,0,1,172,108Zm-12,28H96a12,12,0,0,0,0,24h64a12,12,0,0,0,0-24Zm76-8A108,108,0,0,1,78.77,224.15L46.34,235A20,20,0,0,1,21,209.66l10.81-32.43A108,108,0,1,1,236,128Zm-24,0A84,84,0,1,0,55.27,170.06a12,12,0,0,1,1,9.81l-9.93,29.79,29.79-9.93a12.1,12.1,0,0,1,3.8-.62,12,12,0,0,1,6,1.62A84,84,0,0,0,212,128Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ a9.createElement("path", { d: "M128,24A104,104,0,0,0,36.18,176.88L24.83,210.93a16,16,0,0,0,20.24,20.24l34.05-11.35A104,104,0,1,0,128,24Zm0,192a87.87,87.87,0,0,1-44.06-11.81,8,8,0,0,0-4-1.08,7.85,7.85,0,0,0-2.53.42L40,216,52.47,178.6a8,8,0,0,0-.66-6.54A88,88,0,1,1,128,216Zm40-104a8,8,0,0,1-8,8H96a8,8,0,0,1,0-16h64A8,8,0,0,1,168,112Zm0,32a8,8,0,0,1-8,8H96a8,8,0,0,1,0-16h64A8,8,0,0,1,168,144Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a9.createElement(a9.Fragment, null, /* @__PURE__ */ a9.createElement("path", { d: "M128,24A104,104,0,0,0,36.18,176.88L24.83,210.93a16,16,0,0,0,20.24,20.24l34.05-11.35A104,104,0,1,0,128,24Zm32,128H96a8,8,0,0,1,0-16h64a8,8,0,0,1,0,16Zm0-32H96a8,8,0,0,1,0-16h64a8,8,0,0,1,0,16Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a9.createElement(a9.Fragment, null, /* @__PURE__ */ a9.createElement("path", { d: "M166,112a6,6,0,0,1-6,6H96a6,6,0,0,1,0-12h64A6,6,0,0,1,166,112Zm-6,26H96a6,6,0,0,0,0,12h64a6,6,0,0,0,0-12Zm70-10A102,102,0,0,1,79.31,217.65L44.44,229.27a14,14,0,0,1-17.71-17.71l11.62-34.87A102,102,0,1,1,230,128Zm-12,0A90,90,0,1,0,50.08,173.06a6,6,0,0,1,.5,4.91L38.12,215.35a2,2,0,0,0,2.53,2.53L78,205.42a6.2,6.2,0,0,1,1.9-.31,6.09,6.09,0,0,1,3,.81A90,90,0,0,0,218,128Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a9.createElement(a9.Fragment, null, /* @__PURE__ */ a9.createElement("path", { d: "M168,112a8,8,0,0,1-8,8H96a8,8,0,0,1,0-16h64A8,8,0,0,1,168,112Zm-8,24H96a8,8,0,0,0,0,16h64a8,8,0,0,0,0-16Zm72-8A104,104,0,0,1,79.12,219.82L45.07,231.17a16,16,0,0,1-20.24-20.24l11.35-34.05A104,104,0,1,1,232,128Zm-16,0A88,88,0,1,0,51.81,172.06a8,8,0,0,1,.66,6.54L40,216,77.4,203.53a7.85,7.85,0,0,1,2.53-.42,8,8,0,0,1,4,1.08A88,88,0,0,0,216,128Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a9.createElement(a9.Fragment, null, /* @__PURE__ */ a9.createElement("path", { d: "M164,112a4,4,0,0,1-4,4H96a4,4,0,0,1,0-8h64A4,4,0,0,1,164,112Zm-4,28H96a4,4,0,0,0,0,8h64a4,4,0,0,0,0-8Zm68-12A100,100,0,0,1,79.5,215.47l-35.69,11.9a12,12,0,0,1-15.18-15.18l11.9-35.69A100,100,0,1,1,228,128Zm-8,0A92,92,0,1,0,48.35,174.07a4,4,0,0,1,.33,3.27L36.22,214.72a4,4,0,0,0,5.06,5.06l37.38-12.46a3.93,3.93,0,0,1,1.27-.21,4.05,4.05,0,0,1,2,.54A92,92,0,0,0,220,128Z" }))
  ]
]);
...
var e10 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a10.createElement(a10.Fragment, null, /* @__PURE__ */ a10.createElement("path", { d: "M236.34,187.09A84,84,0,0,0,172.29,68.9,84,84,0,0,0,19.66,139.09l-6.84,23.26a20,20,0,0,0,24.83,24.83l23.26-6.84a83.94,83.94,0,0,0,22.76,6.74,84.06,84.06,0,0,0,111.42,41.26l23.26,6.84a20,20,0,0,0,24.83-24.83ZM62,155.5a11.88,11.88,0,0,0-3.39.49l-20.72,6.09L44,141.35a12,12,0,0,0-.93-9A60,60,0,1,1,67.7,156.92,12,12,0,0,0,62,155.5Zm150.89,24.8a12,12,0,0,0-.93,9l6.09,20.73L197.36,204a12,12,0,0,0-9.06.93A60,60,0,0,1,111,186.63a83.93,83.93,0,0,0,68.55-91.37,60,60,0,0,1,33.38,85Z" }))
  ],
  [
    "duotone",
...
var a11 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e11.createElement(e11.Fragment, null, /* @__PURE__ */ e11.createElement("path", { d: "M232.49,80.49l-128,128a12,12,0,0,1-17,0l-56-56a12,12,0,1,1,17-17L96,183,215.51,63.51a12,12,0,0,1,17,17Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ e11.createElement("path", { d: "M205.66,85.66l-96,96a8,8,0,0,1-11.32,0l-40-40a8,8,0,0,1,11.32-11.32L104,164.69l90.34-90.35a8,8,0,0,1,11.32,11.32Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e11.createElement(e11.Fragment, null, /* @__PURE__ */ e11.createElement("path", { d: "M216,40H40A16,16,0,0,0,24,56V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40ZM205.66,85.66l-96,96a8,8,0,0,1-11.32,0l-40-40a8,8,0,0,1,11.32-11.32L104,164.69l90.34-90.35a8,8,0,0,1,11.32,11.32Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e11.createElement(e11.Fragment, null, /* @__PURE__ */ e11.createElement("path", { d: "M228.24,76.24l-128,128a6,6,0,0,1-8.48,0l-56-56a6,6,0,0,1,8.48-8.48L96,191.51,219.76,67.76a6,6,0,0,1,8.48,8.48Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e11.createElement(e11.Fragment, null, /* @__PURE__ */ e11.createElement("path", { d: "M229.66,77.66l-128,128a8,8,0,0,1-11.32,0l-56-56a8,8,0,0,1,11.32-11.32L96,188.69,218.34,66.34a8,8,0,0,1,11.32,11.32Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e11.createElement(e11.Fragment, null, /* @__PURE__ */ e11.createElement("path", { d: "M226.83,74.83l-128,128a4,4,0,0,1-5.66,0l-56-56a4,4,0,0,1,5.66-5.66L96,194.34,221.17,69.17a4,4,0,1,1,5.66,5.66Z" }))
  ]
]);
...
var a12 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e12.createElement(e12.Fragment, null, /* @__PURE__ */ e12.createElement("path", { d: "M176.49,95.51a12,12,0,0,1,0,17l-56,56a12,12,0,0,1-17,0l-24-24a12,12,0,1,1,17-17L112,143l47.51-47.52A12,12,0,0,1,176.49,95.51ZM236,128A108,108,0,1,1,128,20,108.12,108.12,0,0,1,236,128Zm-24,0a84,84,0,1,0-84,84A84.09,84.09,0,0,0,212,128Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ e12.createElement(e12.Fragment, null, /* @__PURE__ */ e12.createElement("path", { d: "M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z", opacity: "0.2" }), /* @__PURE__ */ e12.createElement("path", { d: "M173.66,98.34a8,8,0,0,1,0,11.32l-56,56a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35A8,8,0,0,1,173.66,98.34ZM232,128A104,104,0,1,1,128,24,104.11,104.11,0,0,1,232,128Zm-16,0a88,88,0,1,0-88,88A88.1,88.1,0,0,0,216,128Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e12.createElement(e12.Fragment, null, /* @__PURE__ */ e12.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm45.66,85.66-56,56a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35a8,8,0,0,1,11.32,11.32Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e12.createElement(e12.Fragment, null, /* @__PURE__ */ e12.createElement("path", { d: "M172.24,99.76a6,6,0,0,1,0,8.48l-56,56a6,6,0,0,1-8.48,0l-24-24a6,6,0,0,1,8.48-8.48L112,151.51l51.76-51.75A6,6,0,0,1,172.24,99.76ZM230,128A102,102,0,1,1,128,26,102.12,102.12,0,0,1,230,128Zm-12,0a90,90,0,1,0-90,90A90.1,90.1,0,0,0,218,128Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e12.createElement(e12.Fragment, null, /* @__PURE__ */ e12.createElement("path", { d: "M173.66,98.34a8,8,0,0,1,0,11.32l-56,56a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35A8,8,0,0,1,173.66,98.34ZM232,128A104,104,0,1,1,128,24,104.11,104.11,0,0,1,232,128Zm-16,0a88,88,0,1,0-88,88A88.1,88.1,0,0,0,216,128Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e12.createElement(e12.Fragment, null, /* @__PURE__ */ e12.createElement("path", { d: "M170.83,101.17a4,4,0,0,1,0,5.66l-56,56a4,4,0,0,1-5.66,0l-24-24a4,4,0,0,1,5.66-5.66L112,154.34l53.17-53.17A4,4,0,0,1,170.83,101.17ZM228,128A100,100,0,1,1,128,28,100.11,100.11,0,0,1,228,128Zm-8,0a92,92,0,1,0-92,92A92.1,92.1,0,0,0,220,128Z" }))
  ]
]);
...
var e13 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M236,137A108.13,108.13,0,1,1,119,20,12,12,0,0,1,121,44,84.12,84.12,0,1,0,212,135,12,12,0,1,1,236,137ZM116,76v52a12,12,0,0,0,12,12h52a12,12,0,0,0,0-24H140V76a12,12,0,0,0-24,0Zm92,20a16,16,0,1,0-16-16A16,16,0,0,0,208,96ZM176,64a16,16,0,1,0-16-16A16,16,0,0,0,176,64Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z", opacity: "0.2" }), /* @__PURE__ */ a13.createElement("path", { d: "M232,136.66A104.12,104.12,0,1,1,119.34,24,8,8,0,0,1,120.66,40,88.12,88.12,0,1,0,216,135.34,8,8,0,0,1,232,136.66ZM120,72v56a8,8,0,0,0,8,8h56a8,8,0,0,0,0-16H136V72a8,8,0,0,0-16,0Zm40-24a12,12,0,1,0-12-12A12,12,0,0,0,160,48Zm36,24a12,12,0,1,0-12-12A12,12,0,0,0,196,72Zm24,36a12,12,0,1,0-12-12A12,12,0,0,0,220,108Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M208,96a12,12,0,1,1,12,12A12,12,0,0,1,208,96ZM196,72a12,12,0,1,0-12-12A12,12,0,0,0,196,72Zm28.66,56a8,8,0,0,0-8.63,7.31A88.12,88.12,0,1,1,120.66,40,8,8,0,0,0,119.34,24,104.12,104.12,0,1,0,232,136.66,8,8,0,0,0,224.66,128ZM128,56a72,72,0,1,1-72,72A72.08,72.08,0,0,1,128,56Zm-8,72a8,8,0,0,0,8,8h48a8,8,0,0,0,0-16H136V80a8,8,0,0,0-16,0Zm40-80a12,12,0,1,0-12-12A12,12,0,0,0,160,48Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M230,136.49A102.12,102.12,0,1,1,119.51,26a6,6,0,0,1,1,12A90.13,90.13,0,1,0,218,135.51a6,6,0,1,1,12,1ZM122,72v56a6,6,0,0,0,6,6h56a6,6,0,0,0,0-12H134V72a6,6,0,0,0-12,0Zm38-26a10,10,0,1,0-10-10A10,10,0,0,0,160,46Zm36,24a10,10,0,1,0-10-10A10,10,0,0,0,196,70Zm24,36a10,10,0,1,0-10-10A10,10,0,0,0,220,106Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M232,136.66A104.12,104.12,0,1,1,119.34,24,8,8,0,0,1,120.66,40,88.12,88.12,0,1,0,216,135.34,8,8,0,0,1,232,136.66ZM120,72v56a8,8,0,0,0,8,8h56a8,8,0,0,0,0-16H136V72a8,8,0,0,0-16,0Zm40-24a12,12,0,1,0-12-12A12,12,0,0,0,160,48Zm36,24a12,12,0,1,0-12-12A12,12,0,0,0,196,72Zm24,36a12,12,0,1,0-12-12A12,12,0,0,0,220,108Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a13.createElement(a13.Fragment, null, /* @__PURE__ */ a13.createElement("path", { d: "M228,136.33A100.13,100.13,0,1,1,119.67,28a4,4,0,1,1,.66,8A92.13,92.13,0,1,0,220,135.67a4,4,0,1,1,8,.66ZM128,132h56a4,4,0,0,0,0-8H132V72a4,4,0,0,0-8,0v56A4,4,0,0,0,128,132Zm32-88a8,8,0,1,0-8-8A8,8,0,0,0,160,44Zm36,24a8,8,0,1,0-8-8A8,8,0,0,0,196,68Zm24,36a8,8,0,1,0-8-8A8,8,0,0,0,220,104Z" }))
  ]
]);
...
var e15 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a14.createElement(a14.Fragment, null, /* @__PURE__ */ a14.createElement("path", { d: "M228,144v64a12,12,0,0,1-12,12H40a12,12,0,0,1-12-12V144a12,12,0,0,1,24,0v52H204V144a12,12,0,0,1,24,0Zm-108.49,8.49a12,12,0,0,0,17,0l40-40a12,12,0,0,0-17-17L140,115V32a12,12,0,0,0-24,0v83L96.49,95.51a12,12,0,0,0-17,17Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ a14.createElement("path", { d: "M224,144v64a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V144a8,8,0,0,1,16,0v56H208V144a8,8,0,0,1,16,0Zm-101.66,5.66a8,8,0,0,0,11.32,0l40-40a8,8,0,0,0-11.32-11.32L136,124.69V32a8,8,0,0,0-16,0v92.69L93.66,98.34a8,8,0,0,0-11.32,11.32Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a14.createElement(a14.Fragment, null, /* @__PURE__ */ a14.createElement("path", { d: "M224,144v64a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V144a8,8,0,0,1,16,0v56H208V144a8,8,0,0,1,16,0Zm-101.66,5.66a8,8,0,0,0,11.32,0l40-40A8,8,0,0,0,168,96H136V32a8,8,0,0,0-16,0V96H88a8,8,0,0,0-5.66,13.66Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a14.createElement(a14.Fragment, null, /* @__PURE__ */ a14.createElement("path", { d: "M222,144v64a6,6,0,0,1-6,6H40a6,6,0,0,1-6-6V144a6,6,0,0,1,12,0v58H210V144a6,6,0,0,1,12,0Zm-98.24,4.24a6,6,0,0,0,8.48,0l40-40a6,6,0,0,0-8.48-8.48L134,129.51V32a6,6,0,0,0-12,0v97.51L92.24,99.76a6,6,0,0,0-8.48,8.48Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a14.createElement(a14.Fragment, null, /* @__PURE__ */ a14.createElement("path", { d: "M224,144v64a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V144a8,8,0,0,1,16,0v56H208V144a8,8,0,0,1,16,0Zm-101.66,5.66a8,8,0,0,0,11.32,0l40-40a8,8,0,0,0-11.32-11.32L136,124.69V32a8,8,0,0,0-16,0v92.69L93.66,98.34a8,8,0,0,0-11.32,11.32Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a14.createElement(a14.Fragment, null, /* @__PURE__ */ a14.createElement("path", { d: "M220,144v64a4,4,0,0,1-4,4H40a4,4,0,0,1-4-4V144a4,4,0,0,1,8,0v60H212V144a4,4,0,0,1,8,0Zm-94.83,2.83a4,4,0,0,0,5.66,0l40-40a4,4,0,1,0-5.66-5.66L132,134.34V32a4,4,0,0,0-8,0V134.34L90.83,101.17a4,4,0,0,0-5.66,5.66Z" }))
  ]
]);
...
var l2 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a20.createElement(a20.Fragment, null, /* @__PURE__ */ a20.createElement("path", { d: "M87.5,151.52l64-64a12,12,0,0,1,17,17l-64,64a12,12,0,0,1-17-17Zm131-114a60.08,60.08,0,0,0-84.87,0L103.51,67.61a12,12,0,0,0,17,17l30.07-30.06a36,36,0,0,1,50.93,50.92L171.4,135.52a12,12,0,1,0,17,17l30.08-30.06A60.09,60.09,0,0,0,218.45,37.55ZM135.52,171.4l-30.07,30.08a36,36,0,0,1-50.92-50.93l30.06-30.07a12,12,0,0,0-17-17L37.55,133.58a60,60,0,0,0,84.88,84.87l30.06-30.07a12,12,0,0,0-17-17Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ a20.createElement("path", { d: "M165.66,90.34a8,8,0,0,1,0,11.32l-64,64a8,8,0,0,1-11.32-11.32l64-64A8,8,0,0,1,165.66,90.34ZM215.6,40.4a56,56,0,0,0-79.2,0L106.34,70.45a8,8,0,0,0,11.32,11.32l30.06-30a40,40,0,0,1,56.57,56.56l-30.07,30.06a8,8,0,0,0,11.31,11.32L215.6,119.6a56,56,0,0,0,0-79.2ZM138.34,174.22l-30.06,30.06a40,40,0,1,1-56.56-56.57l30.05-30.05a8,8,0,0,0-11.32-11.32L40.4,136.4a56,56,0,0,0,79.2,79.2l30.06-30.07a8,8,0,0,0-11.32-11.31Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a20.createElement(a20.Fragment, null, /* @__PURE__ */ a20.createElement("path", { d: "M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM144.56,173.66l-21.45,21.45a44,44,0,0,1-62.22-62.22l21.45-21.46a8,8,0,0,1,11.32,11.31L72.2,144.2a28,28,0,0,0,39.6,39.6l21.45-21.46a8,8,0,0,1,11.31,11.32Zm-34.9-16a8,8,0,0,1-11.32-11.32l48-48a8,8,0,0,1,11.32,11.32Zm85.45-34.55-21.45,21.45a8,8,0,0,1-11.32-11.31L183.8,111.8a28,28,0,0,0-39.6-39.6L122.74,93.66a8,8,0,0,1-11.31-11.32l21.46-21.45a44,44,0,0,1,62.22,62.22Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a20.createElement(a20.Fragment, null, /* @__PURE__ */ a20.createElement("path", { d: "M164.25,91.75a6,6,0,0,1,0,8.49l-64,64a6,6,0,0,1-8.49-8.48l64-64A6,6,0,0,1,164.25,91.75ZM214.2,41.8a54.07,54.07,0,0,0-76.38,0L107.75,71.85a6,6,0,0,0,8.49,8.49l30.07-30.06a42,42,0,0,1,59.41,59.41l-30.08,30.07a6,6,0,1,0,8.49,8.49l30.07-30.07A54,54,0,0,0,214.2,41.8ZM139.76,175.64l-30.07,30.08a42,42,0,0,1-59.41-59.41l30.06-30.07a6,6,0,0,0-8.49-8.49l-30,30.07a54,54,0,0,0,76.38,76.39l30.07-30.08a6,6,0,0,0-8.49-8.49Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a20.createElement(a20.Fragment, null, /* @__PURE__ */ a20.createElement("path", { d: "M165.66,90.34a8,8,0,0,1,0,11.32l-64,64a8,8,0,0,1-11.32-11.32l64-64A8,8,0,0,1,165.66,90.34ZM215.6,40.4a56,56,0,0,0-79.2,0L106.34,70.45a8,8,0,0,0,11.32,11.32l30.06-30a40,40,0,0,1,56.57,56.56l-30.07,30.06a8,8,0,0,0,11.31,11.32L215.6,119.6a56,56,0,0,0,0-79.2ZM138.34,174.22l-30.06,30.06a40,40,0,1,1-56.56-56.57l30.05-30.05a8,8,0,0,0-11.32-11.32L40.4,136.4a56,56,0,0,0,79.2,79.2l30.06-30.07a8,8,0,0,0-11.32-11.31Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a20.createElement(a20.Fragment, null, /* @__PURE__ */ a20.createElement("path", { d: "M162.84,93.16a4,4,0,0,1,0,5.66l-64,64a4,4,0,0,1-5.66-5.66l64-64A4,4,0,0,1,162.84,93.16Zm49.95-49.95a52.07,52.07,0,0,0-73.56,0L109.17,73.27a4,4,0,0,0,5.65,5.66l30.07-30.06a44,44,0,0,1,62.24,62.24l-30.07,30.06a4,4,0,0,0,5.66,5.66l30.07-30.06A52.07,52.07,0,0,0,212.79,43.21ZM141.17,177.06l-30.06,30.07a44,44,0,0,1-62.24-62.24l30.06-30.06a4,4,0,0,0-5.66-5.66L43.21,139.23a52,52,0,0,0,73.56,73.56l30.06-30.07a4,4,0,1,0-5.66-5.66Z" }))
  ]
]);
...
var a22 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e21.createElement(e21.Fragment, null, /* @__PURE__ */ e21.createElement("path", { d: "M232.49,215.51,185,168a92.12,92.12,0,1,0-17,17l47.53,47.54a12,12,0,0,0,17-17ZM44,112a68,68,0,1,1,68,68A68.07,68.07,0,0,1,44,112Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ e21.createElement(e21.Fragment, null, /* @__PURE__ */ e21.createElement("path", { d: "M192,112a80,80,0,1,1-80-80A80,80,0,0,1,192,112Z", opacity: "0.2" }), /* @__PURE__ */ e21.createElement("path", { d: "M229.66,218.34,179.6,168.28a88.21,88.21,0,1,0-11.32,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e21.createElement(e21.Fragment, null, /* @__PURE__ */ e21.createElement("path", { d: "M168,112a56,56,0,1,1-56-56A56,56,0,0,1,168,112Zm61.66,117.66a8,8,0,0,1-11.32,0l-50.06-50.07a88,88,0,1,1,11.32-11.31l50.06,50.06A8,8,0,0,1,229.66,229.66ZM112,184a72,72,0,1,0-72-72A72.08,72.08,0,0,0,112,184Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e21.createElement(e21.Fragment, null, /* @__PURE__ */ e21.createElement("path", { d: "M228.24,219.76l-51.38-51.38a86.15,86.15,0,1,0-8.48,8.48l51.38,51.38a6,6,0,0,0,8.48-8.48ZM38,112a74,74,0,1,1,74,74A74.09,74.09,0,0,1,38,112Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e21.createElement(e21.Fragment, null, /* @__PURE__ */ e21.createElement("path", { d: "M229.66,218.34l-50.07-50.06a88.11,88.11,0,1,0-11.31,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e21.createElement(e21.Fragment, null, /* @__PURE__ */ e21.createElement("path", { d: "M226.83,221.17l-52.7-52.7a84.1,84.1,0,1,0-5.66,5.66l52.7,52.7a4,4,0,0,0,5.66-5.66ZM36,112a76,76,0,1,1,76,76A76.08,76.08,0,0,1,36,112Z" }))
  ]
]);
...
var e24 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a25.createElement(a25.Fragment, null, /* @__PURE__ */ a25.createElement("path", { d: "M230.14,70.54,185.46,25.85a20,20,0,0,0-28.29,0L33.86,149.17A19.85,19.85,0,0,0,28,163.31V208a20,20,0,0,0,20,20H92.69a19.86,19.86,0,0,0,14.14-5.86L230.14,98.82a20,20,0,0,0,0-28.28ZM91,204H52V165l84-84,39,39ZM192,103,153,64l18.34-18.34,39,39Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ a25.createElement("path", { d: "M227.31,73.37,182.63,28.68a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L227.31,96a16,16,0,0,0,0-22.63ZM92.69,208H48V163.31l88-88L180.69,120ZM192,108.68,147.31,64l24-24L216,84.68Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a25.createElement(a25.Fragment, null, /* @__PURE__ */ a25.createElement("path", { d: "M227.31,73.37,182.63,28.68a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L227.31,96a16,16,0,0,0,0-22.63ZM192,108.68,147.31,64l24-24L216,84.68Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a25.createElement(a25.Fragment, null, /* @__PURE__ */ a25.createElement("path", { d: "M225.9,74.78,181.21,30.09a14,14,0,0,0-19.8,0L38.1,153.41a13.94,13.94,0,0,0-4.1,9.9V208a14,14,0,0,0,14,14H92.69a13.94,13.94,0,0,0,9.9-4.1L225.9,94.58a14,14,0,0,0,0-19.8ZM94.1,209.41a2,2,0,0,1-1.41.59H48a2,2,0,0,1-2-2V163.31a2,2,0,0,1,.59-1.41L136,72.48,183.51,120ZM217.41,86.1,192,111.51,144.49,64,169.9,38.58a2,2,0,0,1,2.83,0l44.68,44.69a2,2,0,0,1,0,2.83Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a25.createElement(a25.Fragment, null, /* @__PURE__ */ a25.createElement("path", { d: "M227.31,73.37,182.63,28.68a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L227.31,96a16,16,0,0,0,0-22.63ZM92.69,208H48V163.31l88-88L180.69,120ZM192,108.68,147.31,64l24-24L216,84.68Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a25.createElement(a25.Fragment, null, /* @__PURE__ */ a25.createElement("path", { d: "M224.49,76.2,179.8,31.51a12,12,0,0,0-17,0L133.17,61.17h0L39.52,154.83A11.9,11.9,0,0,0,36,163.31V208a12,12,0,0,0,12,12H92.69a12,12,0,0,0,8.48-3.51L224.48,93.17a12,12,0,0,0,0-17Zm-129,134.63A4,4,0,0,1,92.69,212H48a4,4,0,0,1-4-4V163.31a4,4,0,0,1,1.17-2.83L136,69.65,186.34,120ZM218.83,87.51,192,114.34,141.66,64l26.82-26.83a4,4,0,0,1,5.66,0l44.69,44.68a4,4,0,0,1,0,5.66Z" }))
  ]
]);
...
var a26 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e25.createElement(e25.Fragment, null, /* @__PURE__ */ e25.createElement("path", { d: "M234.49,111.07,90.41,22.94A20,20,0,0,0,60,39.87V216.13a20,20,0,0,0,30.41,16.93l144.08-88.13a19.82,19.82,0,0,0,0-33.86ZM84,208.85V47.15L216.16,128Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ e25.createElement(e25.Fragment, null, /* @__PURE__ */ e25.createElement(
      "path",
      {
        d: "M228.23,134.69,84.15,222.81A8,8,0,0,1,72,216.12V39.88a8,8,0,0,1,12.15-6.69l144.08,88.12A7.82,7.82,0,0,1,228.23,134.69Z",
        opacity: "0.2"
      }
    ), /* @__PURE__ */ e25.createElement("path", { d: "M232.4,114.49,88.32,26.35a16,16,0,0,0-16.2-.3A15.86,15.86,0,0,0,64,39.87V216.13A15.94,15.94,0,0,0,80,232a16.07,16.07,0,0,0,8.36-2.35L232.4,141.51a15.81,15.81,0,0,0,0-27ZM80,215.94V40l143.83,88Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e25.createElement(e25.Fragment, null, /* @__PURE__ */ e25.createElement("path", { d: "M240,128a15.74,15.74,0,0,1-7.6,13.51L88.32,229.65a16,16,0,0,1-16.2.3A15.86,15.86,0,0,1,64,216.13V39.87a15.86,15.86,0,0,1,8.12-13.82,16,16,0,0,1,16.2.3L232.4,114.49A15.74,15.74,0,0,1,240,128Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e25.createElement(e25.Fragment, null, /* @__PURE__ */ e25.createElement("path", { d: "M231.36,116.19,87.28,28.06a14,14,0,0,0-14.18-.27A13.69,13.69,0,0,0,66,39.87V216.13a13.69,13.69,0,0,0,7.1,12.08,14,14,0,0,0,14.18-.27l144.08-88.13a13.82,13.82,0,0,0,0-23.62Zm-6.26,13.38L81,217.7a2,2,0,0,1-2.06,0,1.78,1.78,0,0,1-1-1.61V39.87a1.78,1.78,0,0,1,1-1.61A2.06,2.06,0,0,1,80,38a2,2,0,0,1,1,.31L225.1,126.43a1.82,1.82,0,0,1,0,3.14Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e25.createElement(e25.Fragment, null, /* @__PURE__ */ e25.createElement("path", { d: "M232.4,114.49,88.32,26.35a16,16,0,0,0-16.2-.3A15.86,15.86,0,0,0,64,39.87V216.13A15.94,15.94,0,0,0,80,232a16.07,16.07,0,0,0,8.36-2.35L232.4,141.51a15.81,15.81,0,0,0,0-27ZM80,215.94V40l143.83,88Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e25.createElement(e25.Fragment, null, /* @__PURE__ */ e25.createElement("path", { d: "M230.32,117.9,86.24,29.79a11.91,11.91,0,0,0-12.17-.23A11.71,11.71,0,0,0,68,39.89V216.11a11.71,11.71,0,0,0,6.07,10.33,11.91,11.91,0,0,0,12.17-.23L230.32,138.1a11.82,11.82,0,0,0,0-20.2Zm-4.18,13.37L82.06,219.39a4,4,0,0,1-4.07.07,3.77,3.77,0,0,1-2-3.35V39.89a3.77,3.77,0,0,1,2-3.35,4,4,0,0,1,4.07.07l144.08,88.12a3.8,3.8,0,0,1,0,6.54Z" }))
  ]
]);
...
var a28 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e26.createElement(e26.Fragment, null, /* @__PURE__ */ e26.createElement("path", { d: "M228,128a12,12,0,0,1-12,12H140v76a12,12,0,0,1-24,0V140H40a12,12,0,0,1,0-24h76V40a12,12,0,0,1,24,0v76h76A12,12,0,0,1,228,128Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ e26.createElement(e26.Fragment, null, /* @__PURE__ */ e26.createElement(
      "path",
      {
        d: "M216,56V200a16,16,0,0,1-16,16H56a16,16,0,0,1-16-16V56A16,16,0,0,1,56,40H200A16,16,0,0,1,216,56Z",
        opacity: "0.2"
      }
    ), /* @__PURE__ */ e26.createElement("path", { d: "M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e26.createElement(e26.Fragment, null, /* @__PURE__ */ e26.createElement("path", { d: "M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM184,136H136v48a8,8,0,0,1-16,0V136H72a8,8,0,0,1,0-16h48V72a8,8,0,0,1,16,0v48h48a8,8,0,0,1,0,16Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e26.createElement(e26.Fragment, null, /* @__PURE__ */ e26.createElement("path", { d: "M222,128a6,6,0,0,1-6,6H134v82a6,6,0,0,1-12,0V134H40a6,6,0,0,1,0-12h82V40a6,6,0,0,1,12,0v82h82A6,6,0,0,1,222,128Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e26.createElement(e26.Fragment, null, /* @__PURE__ */ e26.createElement("path", { d: "M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e26.createElement(e26.Fragment, null, /* @__PURE__ */ e26.createElement("path", { d: "M220,128a4,4,0,0,1-4,4H132v84a4,4,0,0,1-8,0V132H40a4,4,0,0,1,0-8h84V40a4,4,0,0,1,8,0v84h84A4,4,0,0,1,220,128Z" }))
  ]
]);
...
var e28 = /* @__PURE__ */ new Map([
  ...
  [
    ...
    ), /* @__PURE__ */ a30.createElement("path", { d: "M208,40H48A16,16,0,0,0,32,56v56c0,52.72,25.52,84.67,46.93,102.19,23.06,18.86,46,25.26,47,25.53a8,8,0,0,0,4.2,0c1-.27,23.91-6.67,47-25.53C198.48,196.67,224,164.72,224,112V56A16,16,0,0,0,208,40Zm0,72c0,37.07-13.66,67.16-40.6,89.42A129.3,129.3,0,0,1,128,223.62a128.25,128.25,0,0,1-38.92-21.81C61.82,179.51,48,149.3,48,112l0-56,160,0ZM82.34,141.66a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35a8,8,0,0,1,11.32,11.32l-56,56a8,8,0,0,1-11.32,0Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a30.createElement(a30.Fragment, null, /* @__PURE__ */ a30.createElement("path", { d: "M208,40H48A16,16,0,0,0,32,56v56c0,52.72,25.52,84.67,46.93,102.19,23.06,18.86,46,25.26,47,25.53a8,8,0,0,0,4.2,0c1-.27,23.91-6.67,47-25.53C198.48,196.67,224,164.72,224,112V56A16,16,0,0,0,208,40Zm-34.32,69.66-56,56a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35a8,8,0,0,1,11.32,11.32Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a30.createElement(a30.Fragment, null, /* @__PURE__ */ a30.createElement("path", { d: "M208,42H48A14,14,0,0,0,34,56v56c0,51.94,25.12,83.4,46.2,100.64,22.73,18.6,45.27,24.89,46.22,25.15a6,6,0,0,0,3.16,0c.95-.26,23.49-6.55,46.22-25.15C196.88,195.4,222,163.94,222,112V56A14,14,0,0,0,208,42Zm2,70c0,37.76-13.94,68.39-41.44,91.06A131.17,131.17,0,0,1,128,225.72a130.94,130.94,0,0,1-40.56-22.66C59.94,180.39,46,149.76,46,112V56a2,2,0,0,1,2-2H208a2,2,0,0,1,2,2ZM172.24,99.76a6,6,0,0,1,0,8.48l-56,56a6,6,0,0,1-8.48,0l-24-24a6,6,0,0,1,8.48-8.48L112,151.51l51.76-51.75A6,6,0,0,1,172.24,99.76Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a30.createElement(a30.Fragment, null, /* @__PURE__ */ a30.createElement("path", { d: "M208,40H48A16,16,0,0,0,32,56v56c0,52.72,25.52,84.67,46.93,102.19,23.06,18.86,46,25.26,47,25.53a8,8,0,0,0,4.2,0c1-.27,23.91-6.67,47-25.53C198.48,196.67,224,164.72,224,112V56A16,16,0,0,0,208,40Zm0,72c0,37.07-13.66,67.16-40.6,89.42A129.3,129.3,0,0,1,128,223.62a128.25,128.25,0,0,1-38.92-21.81C61.82,179.51,48,149.3,48,112l0-56,160,0ZM82.34,141.66a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35a8,8,0,0,1,11.32,11.32l-56,56a8,8,0,0,1-11.32,0Z" }))
  ...
  [
    "thin",
    /* @__PURE__ */ a30.createElement(a30.Fragment, null, /* @__PURE__ */ a30.createElement("path", { d: "M208,44H48A12,12,0,0,0,36,56v56c0,51.16,24.73,82.12,45.47,99.1,22.4,18.32,44.55,24.5,45.48,24.76a4,4,0,0,0,2.1,0c.93-.26,23.08-6.44,45.48-24.76,20.74-17,45.47-47.94,45.47-99.1V56A12,12,0,0,0,208,44Zm4,68c0,38.44-14.23,69.63-42.29,92.71A132.45,132.45,0,0,1,128,227.82a132.23,132.23,0,0,1-41.71-23.11C58.23,181.63,44,150.44,44,112V56a4,4,0,0,1,4-4H208a4,4,0,0,1,4,4Zm-41.17-10.83a4,4,0,0,1,0,5.66l-56,56a4,4,0,0,1-5.66,0l-24-24a4,4,0,0,1,5.66-5.66L112,154.34l53.17-53.17A4,4,0,0,1,170.83,101.17Z" }))
  ]
]);
...
var e29 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a31.createElement(a31.Fragment, null, /* @__PURE__ */ a31.createElement("path", { d: "M140,32V64a12,12,0,0,1-24,0V32a12,12,0,0,1,24,0Zm84,84H192a12,12,0,0,0,0,24h32a12,12,0,0,0,0-24Zm-42.26,48.77a12,12,0,1,0-17,17l22.63,22.63a12,12,0,0,0,17-17ZM128,180a12,12,0,0,0-12,12v32a12,12,0,0,0,24,0V192A12,12,0,0,0,128,180ZM74.26,164.77,51.63,187.4a12,12,0,0,0,17,17l22.63-22.63a12,12,0,1,0-17-17ZM76,128a12,12,0,0,0-12-12H32a12,12,0,0,0,0,24H64A12,12,0,0,0,76,128ZM68.6,51.63a12,12,0,1,0-17,17L74.26,91.23a12,12,0,0,0,17-17Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ a31.createElement(a31.Fragment, null, /* @__PURE__ */ a31.createElement("path", { d: "M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z", opacity: "0.2" }), /* @__PURE__ */ a31.createElement("path", { d: "M136,32V64a8,8,0,0,1-16,0V32a8,8,0,0,1,16,0Zm88,88H192a8,8,0,0,0,0,16h32a8,8,0,0,0,0-16Zm-45.09,47.6a8,8,0,0,0-11.31,11.31l22.62,22.63a8,8,0,0,0,11.32-11.32ZM128,184a8,8,0,0,0-8,8v32a8,8,0,0,0,16,0V192A8,8,0,0,0,128,184ZM77.09,167.6,54.46,190.22a8,8,0,0,0,11.32,11.32L88.4,178.91A8,8,0,0,0,77.09,167.6ZM72,128a8,8,0,0,0-8-8H32a8,8,0,0,0,0,16H64A8,8,0,0,0,72,128ZM65.78,54.46A8,8,0,0,0,54.46,65.78L77.09,88.4A8,8,0,0,0,88.4,77.09Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a31.createElement(a31.Fragment, null, /* @__PURE__ */ a31.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24ZM48,136a8,8,0,0,1,0-16H72a8,8,0,0,1,0,16Zm46.06,37.25-17,17a8,8,0,0,1-11.32-11.32l17-17a8,8,0,0,1,11.31,11.31Zm0-79.19a8,8,0,0,1-11.31,0l-17-17A8,8,0,0,1,77.09,65.77l17,17A8,8,0,0,1,94.06,94.06ZM136,208a8,8,0,0,1-16,0V184a8,8,0,0,1,16,0Zm0-136a8,8,0,0,1-16,0V48a8,8,0,0,1,16,0Zm54.23,118.23a8,8,0,0,1-11.32,0l-17-17a8,8,0,0,1,11.31-11.31l17,17A8,8,0,0,1,190.23,190.23ZM208,136H184a8,8,0,0,1,0-16h24a8,8,0,0,1,0,16Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a31.createElement(a31.Fragment, null, /* @__PURE__ */ a31.createElement("path", { d: "M134,32V64a6,6,0,0,1-12,0V32a6,6,0,0,1,12,0Zm90,90H192a6,6,0,0,0,0,12h32a6,6,0,0,0,0-12Zm-46.5,47A6,6,0,0,0,169,177.5l22.63,22.62a6,6,0,0,0,8.48-8.48ZM128,186a6,6,0,0,0-6,6v32a6,6,0,0,0,12,0V192A6,6,0,0,0,128,186ZM78.5,169,55.88,191.64a6,6,0,1,0,8.48,8.48L87,177.5A6,6,0,1,0,78.5,169ZM70,128a6,6,0,0,0-6-6H32a6,6,0,0,0,0,12H64A6,6,0,0,0,70,128ZM64.36,55.88a6,6,0,0,0-8.48,8.48L78.5,87A6,6,0,1,0,87,78.5Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a31.createElement(a31.Fragment, null, /* @__PURE__ */ a31.createElement("path", { d: "M136,32V64a8,8,0,0,1-16,0V32a8,8,0,0,1,16,0Zm88,88H192a8,8,0,0,0,0,16h32a8,8,0,0,0,0-16Zm-45.09,47.6a8,8,0,0,0-11.31,11.31l22.62,22.63a8,8,0,0,0,11.32-11.32ZM128,184a8,8,0,0,0-8,8v32a8,8,0,0,0,16,0V192A8,8,0,0,0,128,184ZM77.09,167.6,54.46,190.22a8,8,0,0,0,11.32,11.32L88.4,178.91A8,8,0,0,0,77.09,167.6ZM72,128a8,8,0,0,0-8-8H32a8,8,0,0,0,0,16H64A8,8,0,0,0,72,128ZM65.78,54.46A8,8,0,0,0,54.46,65.78L77.09,88.4A8,8,0,0,0,88.4,77.09Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a31.createElement(a31.Fragment, null, /* @__PURE__ */ a31.createElement("path", { d: "M132,32V64a4,4,0,0,1-8,0V32a4,4,0,0,1,8,0Zm92,92H192a4,4,0,0,0,0,8h32a4,4,0,0,0,0-8Zm-47.92,46.43a4,4,0,1,0-5.65,5.65l22.62,22.63a4,4,0,0,0,5.66-5.66ZM128,188a4,4,0,0,0-4,4v32a4,4,0,0,0,8,0V192A4,4,0,0,0,128,188ZM79.92,170.43,57.29,193.05A4,4,0,0,0,63,198.71l22.62-22.63a4,4,0,1,0-5.65-5.65ZM68,128a4,4,0,0,0-4-4H32a4,4,0,0,0,0,8H64A4,4,0,0,0,68,128ZM63,57.29A4,4,0,0,0,57.29,63L79.92,85.57a4,4,0,1,0,5.65-5.65Z" }))
  ]
]);
...
var a32 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e30.createElement(e30.Fragment, null, /* @__PURE__ */ e30.createElement("path", { d: "M200,36H56A20,20,0,0,0,36,56V200a20,20,0,0,0,20,20H200a20,20,0,0,0,20-20V56A20,20,0,0,0,200,36Zm-4,160H60V60H196Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ e30.createElement("path", { d: "M200,40H56A16,16,0,0,0,40,56V200a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V56A16,16,0,0,0,200,40Zm0,160H56V56H200V200Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e30.createElement(e30.Fragment, null, /* @__PURE__ */ e30.createElement("path", { d: "M216,56V200a16,16,0,0,1-16,16H56a16,16,0,0,1-16-16V56A16,16,0,0,1,56,40H200A16,16,0,0,1,216,56Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e30.createElement(e30.Fragment, null, /* @__PURE__ */ e30.createElement("path", { d: "M200,42H56A14,14,0,0,0,42,56V200a14,14,0,0,0,14,14H200a14,14,0,0,0,14-14V56A14,14,0,0,0,200,42Zm2,158a2,2,0,0,1-2,2H56a2,2,0,0,1-2-2V56a2,2,0,0,1,2-2H200a2,2,0,0,1,2,2Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e30.createElement(e30.Fragment, null, /* @__PURE__ */ e30.createElement("path", { d: "M200,40H56A16,16,0,0,0,40,56V200a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V56A16,16,0,0,0,200,40Zm0,160H56V56H200V200Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e30.createElement(e30.Fragment, null, /* @__PURE__ */ e30.createElement("path", { d: "M200,44H56A12,12,0,0,0,44,56V200a12,12,0,0,0,12,12H200a12,12,0,0,0,12-12V56A12,12,0,0,0,200,44Zm4,156a4,4,0,0,1-4,4H56a4,4,0,0,1-4-4V56a4,4,0,0,1,4-4H200a4,4,0,0,1,4,4Z" }))
  ]
]);
...
var e31 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a33.createElement(a33.Fragment, null, /* @__PURE__ */ a33.createElement("path", { d: "M216,48H180V36A28,28,0,0,0,152,8H104A28,28,0,0,0,76,36V48H40a12,12,0,0,0,0,24h4V208a20,20,0,0,0,20,20H192a20,20,0,0,0,20-20V72h4a12,12,0,0,0,0-24ZM100,36a4,4,0,0,1,4-4h48a4,4,0,0,1,4,4V48H100Zm88,168H68V72H188ZM116,104v64a12,12,0,0,1-24,0V104a12,12,0,0,1,24,0Zm48,0v64a12,12,0,0,1-24,0V104a12,12,0,0,1,24,0Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ a33.createElement(a33.Fragment, null, /* @__PURE__ */ a33.createElement("path", { d: "M200,56V208a8,8,0,0,1-8,8H64a8,8,0,0,1-8-8V56Z", opacity: "0.2" }), /* @__PURE__ */ a33.createElement("path", { d: "M216,48H176V40a24,24,0,0,0-24-24H104A24,24,0,0,0,80,40v8H40a8,8,0,0,0,0,16h8V208a16,16,0,0,0,16,16H192a16,16,0,0,0,16-16V64h8a8,8,0,0,0,0-16ZM96,40a8,8,0,0,1,8-8h48a8,8,0,0,1,8,8v8H96Zm96,168H64V64H192ZM112,104v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm48,0v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a33.createElement(a33.Fragment, null, /* @__PURE__ */ a33.createElement("path", { d: "M216,48H176V40a24,24,0,0,0-24-24H104A24,24,0,0,0,80,40v8H40a8,8,0,0,0,0,16h8V208a16,16,0,0,0,16,16H192a16,16,0,0,0,16-16V64h8a8,8,0,0,0,0-16ZM112,168a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm48,0a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm0-120H96V40a8,8,0,0,1,8-8h48a8,8,0,0,1,8,8Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a33.createElement(a33.Fragment, null, /* @__PURE__ */ a33.createElement("path", { d: "M216,50H174V40a22,22,0,0,0-22-22H104A22,22,0,0,0,82,40V50H40a6,6,0,0,0,0,12H50V208a14,14,0,0,0,14,14H192a14,14,0,0,0,14-14V62h10a6,6,0,0,0,0-12ZM94,40a10,10,0,0,1,10-10h48a10,10,0,0,1,10,10V50H94ZM194,208a2,2,0,0,1-2,2H64a2,2,0,0,1-2-2V62H194ZM110,104v64a6,6,0,0,1-12,0V104a6,6,0,0,1,12,0Zm48,0v64a6,6,0,0,1-12,0V104a6,6,0,0,1,12,0Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a33.createElement(a33.Fragment, null, /* @__PURE__ */ a33.createElement("path", { d: "M216,48H176V40a24,24,0,0,0-24-24H104A24,24,0,0,0,80,40v8H40a8,8,0,0,0,0,16h8V208a16,16,0,0,0,16,16H192a16,16,0,0,0,16-16V64h8a8,8,0,0,0,0-16ZM96,40a8,8,0,0,1,8-8h48a8,8,0,0,1,8,8v8H96Zm96,168H64V64H192ZM112,104v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm48,0v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Z" }))
...
var e32 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a34.createElement(a34.Fragment, null, /* @__PURE__ */ a34.createElement("path", { d: "M228,144v64a12,12,0,0,1-12,12H40a12,12,0,0,1-12-12V144a12,12,0,0,1,24,0v52H204V144a12,12,0,0,1,24,0ZM96.49,80.49,116,61v83a12,12,0,0,0,24,0V61l19.51,19.52a12,12,0,1,0,17-17l-40-40a12,12,0,0,0-17,0l-40,40a12,12,0,1,0,17,17Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ a34.createElement("path", { d: "M224,144v64a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V144a8,8,0,0,1,16,0v56H208V144a8,8,0,0,1,16,0ZM93.66,77.66,120,51.31V144a8,8,0,0,0,16,0V51.31l26.34,26.35a8,8,0,0,0,11.32-11.32l-40-40a8,8,0,0,0-11.32,0l-40,40A8,8,0,0,0,93.66,77.66Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ a34.createElement(a34.Fragment, null, /* @__PURE__ */ a34.createElement("path", { d: "M224,144v64a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V144a8,8,0,0,1,16,0v56H208V144a8,8,0,0,1,16,0ZM88,80h32v64a8,8,0,0,0,16,0V80h32a8,8,0,0,0,5.66-13.66l-40-40a8,8,0,0,0-11.32,0l-40,40A8,8,0,0,0,88,80Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ a34.createElement(a34.Fragment, null, /* @__PURE__ */ a34.createElement("path", { d: "M222,144v64a6,6,0,0,1-6,6H40a6,6,0,0,1-6-6V144a6,6,0,0,1,12,0v58H210V144a6,6,0,0,1,12,0ZM92.24,76.24,122,46.49V144a6,6,0,0,0,12,0V46.49l29.76,29.75a6,6,0,0,0,8.48-8.48l-40-40a6,6,0,0,0-8.48,0l-40,40a6,6,0,0,0,8.48,8.48Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ a34.createElement(a34.Fragment, null, /* @__PURE__ */ a34.createElement("path", { d: "M224,144v64a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V144a8,8,0,0,1,16,0v56H208V144a8,8,0,0,1,16,0ZM93.66,77.66,120,51.31V144a8,8,0,0,0,16,0V51.31l26.34,26.35a8,8,0,0,0,11.32-11.32l-40-40a8,8,0,0,0-11.32,0l-40,40A8,8,0,0,0,93.66,77.66Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ a34.createElement(a34.Fragment, null, /* @__PURE__ */ a34.createElement("path", { d: "M220,144v64a4,4,0,0,1-4,4H40a4,4,0,0,1-4-4V144a4,4,0,0,1,8,0v60H212V144a4,4,0,0,1,8,0ZM90.83,74.83,124,41.66V144a4,4,0,0,0,8,0V41.66l33.17,33.17a4,4,0,1,0,5.66-5.66l-40-40a4,4,0,0,0-5.66,0l-40,40a4,4,0,0,0,5.66,5.66Z" }))
  ]
]);
...
var e33 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a35.createElement(a35.Fragment, null, /* @__PURE__ */ a35.createElement("path", { d: "M240.26,186.1,152.81,34.23h0a28.74,28.74,0,0,0-49.62,0L15.74,186.1a27.45,27.45,0,0,0,0,27.71A28.31,28.31,0,0,0,40.55,228h174.9a28.31,28.31,0,0,0,24.79-14.19A27.45,27.45,0,0,0,240.26,186.1Zm-20.8,15.7a4.46,4.46,0,0,1-4,2.2H40.55a4.46,4.46,0,0,1-4-2.2,3.56,3.56,0,0,1,0-3.73L124,46.2a4.77,4.77,0,0,1,8,0l87.44,151.87A3.56,3.56,0,0,1,219.46,201.8ZM116,136V104a12,12,0,0,1,24,0v32a12,12,0,0,1-24,0Zm28,40a16,16,0,1,1-16-16A16,16,0,0,1,144,176Z" }))
  ],
  [
    "duotone",
...
var a36 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e34.createElement(e34.Fragment, null, /* @__PURE__ */ e34.createElement("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm0,192a84,84,0,1,1,84-84A84.09,84.09,0,0,1,128,212Zm-12-80V80a12,12,0,0,1,24,0v52a12,12,0,0,1-24,0Zm28,40a16,16,0,1,1-16-16A16,16,0,0,1,144,172Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ e34.createElement(e34.Fragment, null, /* @__PURE__ */ e34.createElement("path", { d: "M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z", opacity: "0.2" }), /* @__PURE__ */ e34.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm-8-80V80a8,8,0,0,1,16,0v56a8,8,0,0,1-16,0Zm20,36a12,12,0,1,1-12-12A12,12,0,0,1,140,172Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e34.createElement(e34.Fragment, null, /* @__PURE__ */ e34.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm-8,56a8,8,0,0,1,16,0v56a8,8,0,0,1-16,0Zm8,104a12,12,0,1,1,12-12A12,12,0,0,1,128,184Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e34.createElement(e34.Fragment, null, /* @__PURE__ */ e34.createElement("path", { d: "M128,26A102,102,0,1,0,230,128,102.12,102.12,0,0,0,128,26Zm0,192a90,90,0,1,1,90-90A90.1,90.1,0,0,1,128,218Zm-6-82V80a6,6,0,0,1,12,0v56a6,6,0,0,1-12,0Zm16,36a10,10,0,1,1-10-10A10,10,0,0,1,138,172Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e34.createElement(e34.Fragment, null, /* @__PURE__ */ e34.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm-8-80V80a8,8,0,0,1,16,0v56a8,8,0,0,1-16,0Zm20,36a12,12,0,1,1-12-12A12,12,0,0,1,140,172Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e34.createElement(e34.Fragment, null, /* @__PURE__ */ e34.createElement("path", { d: "M128,28A100,100,0,1,0,228,128,100.11,100.11,0,0,0,128,28Zm0,192a92,92,0,1,1,92-92A92.1,92.1,0,0,1,128,220Zm-4-84V80a4,4,0,0,1,8,0v56a4,4,0,0,1-8,0Zm12,36a8,8,0,1,1-8-8A8,8,0,0,1,136,172Z" }))
  ]
]);
...
var a37 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e35.createElement(e35.Fragment, null, /* @__PURE__ */ e35.createElement("path", { d: "M208.49,191.51a12,12,0,0,1-17,17L128,145,64.49,208.49a12,12,0,0,1-17-17L111,128,47.51,64.49a12,12,0,0,1,17-17L128,111l63.51-63.52a12,12,0,0,1,17,17L145,128Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ e35.createElement("path", { d: "M205.66,194.34a8,8,0,0,1-11.32,11.32L128,139.31,61.66,205.66a8,8,0,0,1-11.32-11.32L116.69,128,50.34,61.66A8,8,0,0,1,61.66,50.34L128,116.69l66.34-66.35a8,8,0,0,1,11.32,11.32L139.31,128Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ e35.createElement(e35.Fragment, null, /* @__PURE__ */ e35.createElement("path", { d: "M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM181.66,170.34a8,8,0,0,1-11.32,11.32L128,139.31,85.66,181.66a8,8,0,0,1-11.32-11.32L116.69,128,74.34,85.66A8,8,0,0,1,85.66,74.34L128,116.69l42.34-42.35a8,8,0,0,1,11.32,11.32L139.31,128Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ e35.createElement(e35.Fragment, null, /* @__PURE__ */ e35.createElement("path", { d: "M204.24,195.76a6,6,0,1,1-8.48,8.48L128,136.49,60.24,204.24a6,6,0,0,1-8.48-8.48L119.51,128,51.76,60.24a6,6,0,0,1,8.48-8.48L128,119.51l67.76-67.75a6,6,0,0,1,8.48,8.48L136.49,128Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ e35.createElement(e35.Fragment, null, /* @__PURE__ */ e35.createElement("path", { d: "M205.66,194.34a8,8,0,0,1-11.32,11.32L128,139.31,61.66,205.66a8,8,0,0,1-11.32-11.32L116.69,128,50.34,61.66A8,8,0,0,1,61.66,50.34L128,116.69l66.34-66.35a8,8,0,0,1,11.32,11.32L139.31,128Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ e35.createElement(e35.Fragment, null, /* @__PURE__ */ e35.createElement("path", { d: "M202.83,197.17a4,4,0,0,1-5.66,5.66L128,133.66,58.83,202.83a4,4,0,0,1-5.66-5.66L122.34,128,53.17,58.83a4,4,0,0,1,5.66-5.66L128,122.34l69.17-69.17a4,4,0,1,1,5.66,5.66L133.66,128Z" }))
  ]
]);
...
var p = e36.forwardRef(
  (s9, a46) => {
    ...
    return /* @__PURE__ */ e36.createElement(
      "svg",
      {
        ref: a46,
        xmlns: "http://www.w3.org/2000/svg",
        width: t9 != null ? t9 : l6,
        height: t9 != null ? t9 : l6,
        fill: r9 != null ? r9 : d,
        viewBox: "0 0 256 256",
      ...
      !!n14 && /* @__PURE__ */ e36.createElement("title", null, n14),
      i,
      m7.get(o33 != null ? o33 : f2)
    );
  }
);
...
var r2 = o2.forwardRef((e63, c7) => /* @__PURE__ */ o2.createElement(p, { ref: c7, ...e63, weights: a }));
...
var r3 = o3.forwardRef((e63, t9) => /* @__PURE__ */ o3.createElement(p, { ref: t9, ...e63, weights: a2 }));
r3.displayName = "ArrowLeftIcon";
var s = r3;

// node_modules/@phosphor-icons/react/dist/csr/ArrowSquareOut.es.js
var r4 = __toESM(require("react"), 1);
var o4 = r4.forwardRef((e63, t9) => /* @__PURE__ */ r4.createElement(p, { ref: t9, ...e63, weights: e3 }));
o4.displayName = "ArrowSquareOutIcon";
var n = o4;

// node_modules/@phosphor-icons/react/dist/csr/ArrowUpRight.es.js
var o5 = __toESM(require("react"), 1);
var r5 = o5.forwardRef((t9, e63) => /* @__PURE__ */ o5.createElement(p, { ref: e63, ...t9, weights: a4 }));
r5.displayName = "ArrowUpRightIcon";
var c = r5;

// node_modules/@phosphor-icons/react/dist/csr/Books.es.js
var o6 = __toESM(require("react"), 1);
var e37 = o6.forwardRef((r9, s9) => /* @__PURE__ */ o6.createElement(p, { ref: s9, ...r9, weights: e5 }));
e37.displayName = "BooksIcon";
var n2 = e37;

// node_modules/@phosphor-icons/react/dist/csr/CalendarBlank.es.js
var a38 = __toESM(require("react"), 1);
var e38 = a38.forwardRef((o33, r9) => /* @__PURE__ */ a38.createElement(p, { ref: r9, ...o33, weights: e6 }));
e38.displayName = "CalendarBlankIcon";
var c2 = e38;

// node_modules/@phosphor-icons/react/dist/csr/CalendarCheck.es.js
var e39 = __toESM(require("react"), 1);
var a39 = e39.forwardRef((o33, r9) => /* @__PURE__ */ e39.createElement(p, { ref: r9, ...o33, weights: V }));
a39.displayName = "CalendarCheckIcon";
var s2 = a39;

// node_modules/@phosphor-icons/react/dist/csr/CaretDown.es.js
var o7 = __toESM(require("react"), 1);
var e40 = o7.forwardRef((r9, t9) => /* @__PURE__ */ o7.createElement(p, { ref: t9, ...r9, weights: t }));
e40.displayName = "CaretDownIcon";
var s3 = e40;

// node_modules/@phosphor-icons/react/dist/csr/ChatCircleDots.es.js
var o8 = __toESM(require("react"), 1);
var t3 = o8.forwardRef((e63, r9) => /* @__PURE__ */ o8.createElement(p, { ref: r9, ...e63, weights: e8 }));
...
var t4 = e41.forwardRef((o33, r9) => /* @__PURE__ */ e41.createElement(p, { ref: r9, ...o33, weights: e9 }));
...
var o9 = e42.forwardRef((r9, t9) => /* @__PURE__ */ e42.createElement(p, { ref: t9, ...r9, weights: e10 }));
o9.displayName = "ChatsCircleIcon";
var m3 = o9;

// node_modules/@phosphor-icons/react/dist/csr/Check.es.js
var e43 = __toESM(require("react"), 1);
var o10 = e43.forwardRef((c7, r9) => /* @__PURE__ */ e43.createElement(p, { ref: r9, ...c7, weights: a11 }));
o10.displayName = "CheckIcon";
var n3 = o10;

// node_modules/@phosphor-icons/react/dist/csr/CheckCircle.es.js
var e44 = __toESM(require("react"), 1);
var c3 = e44.forwardRef((o33, r9) => /* @__PURE__ */ e44.createElement(p, { ref: r9, ...o33, weights: a12 }));
...
var t5 = o11.forwardRef((n14, c7) => /* @__PURE__ */ o11.createElement(p, { ref: c7, ...n14, weights: e13 }));
...
var e45 = a40.forwardRef((o33, t9) => /* @__PURE__ */ a40.createElement(p, { ref: t9, ...o33, weights: t2 }));
e45.displayName = "DatabaseIcon";
var n4 = e45;

// node_modules/@phosphor-icons/react/dist/csr/DownloadSimple.es.js
var o12 = __toESM(require("react"), 1);
var e46 = o12.forwardRef((a46, m7) => /* @__PURE__ */ o12.createElement(p, { ref: m7, ...a46, weights: e15 }));
e46.displayName = "DownloadSimpleIcon";
var l4 = e46;

// node_modules/@phosphor-icons/react/dist/csr/GearSix.es.js
var e47 = __toESM(require("react"), 1);
var o13 = e47.forwardRef((r9, a46) => /* @__PURE__ */ e47.createElement(p, { ref: a46, ...r9, weights: l }));
o13.displayName = "GearSixIcon";
var s7 = o13;

// node_modules/@phosphor-icons/react/dist/csr/House.es.js
var o14 = __toESM(require("react"), 1);
var e48 = o14.forwardRef((r9, s9) => /* @__PURE__ */ o14.createElement(p, { ref: s9, ...r9, weights: e16 }));
e48.displayName = "HouseIcon";
var n5 = e48;

// node_modules/@phosphor-icons/react/dist/csr/ImageSquare.es.js
var e49 = __toESM(require("react"), 1);
var a41 = e49.forwardRef((o33, r9) => /* @__PURE__ */ e49.createElement(p, { ref: r9, ...o33, weights: e17 }));
a41.displayName = "ImageSquareIcon";
var I = a41;

// node_modules/@phosphor-icons/react/dist/csr/Info.es.js
var o15 = __toESM(require("react"), 1);
var e50 = o15.forwardRef((r9, t9) => /* @__PURE__ */ o15.createElement(p, { ref: t9, ...r9, weights: a18 }));
e50.displayName = "InfoIcon";
var c4 = e50;

// node_modules/@phosphor-icons/react/dist/csr/Key.es.js
var e51 = __toESM(require("react"), 1);
var o16 = e51.forwardRef((r9, t9) => /* @__PURE__ */ e51.createElement(p, { ref: t9, ...r9, weights: e19 }));
o16.displayName = "KeyIcon";
var n6 = o16;

// node_modules/@phosphor-icons/react/dist/csr/LinkSimple.es.js
var e52 = __toESM(require("react"), 1);
var o17 = e52.forwardRef((i, m7) => /* @__PURE__ */ e52.createElement(p, { ref: m7, ...i, weights: l2 }));
o17.displayName = "LinkSimpleIcon";
var p2 = o17;

// node_modules/@phosphor-icons/react/dist/csr/List.es.js
var o18 = __toESM(require("react"), 1);
var t6 = o18.forwardRef((e63, r9) => /* @__PURE__ */ o18.createElement(p, { ref: r9, ...e63, weights: e20 }));
t6.displayName = "ListIcon";
var c5 = t6;

// node_modules/@phosphor-icons/react/dist/csr/MagnifyingGlass.es.js
var a42 = __toESM(require("react"), 1);
var o19 = a42.forwardRef((s9, n14) => /* @__PURE__ */ a42.createElement(p, { ref: n14, ...s9, weights: a22 }));
o19.displayName = "MagnifyingGlassIcon";
var f = o19;

// node_modules/@phosphor-icons/react/dist/csr/Note.es.js
var o20 = __toESM(require("react"), 1);
var e53 = o20.forwardRef((t9, r9) => /* @__PURE__ */ o20.createElement(p, { ref: r9, ...t9, weights: e22 }));
e53.displayName = "NoteIcon";
var n7 = e53;

// node_modules/@phosphor-icons/react/dist/csr/PaperPlaneTilt.es.js
var e54 = __toESM(require("react"), 1);
var a43 = e54.forwardRef((o33, r9) => /* @__PURE__ */ e54.createElement(p, { ref: r9, ...o33, weights: e23 }));
a43.displayName = "PaperPlaneTiltIcon";
var m4 = a43;

// node_modules/@phosphor-icons/react/dist/csr/PencilSimple.es.js
var e55 = __toESM(require("react"), 1);
var o21 = e55.forwardRef((i, m7) => /* @__PURE__ */ e55.createElement(p, { ref: m7, ...i, weights: e24 }));
o21.displayName = "PencilSimpleIcon";
var a44 = o21;

// node_modules/@phosphor-icons/react/dist/csr/Play.es.js
var o22 = __toESM(require("react"), 1);
var a45 = o22.forwardRef((e63, r9) => /* @__PURE__ */ o22.createElement(p, { ref: r9, ...e63, weights: a26 }));
a45.displayName = "PlayIcon";
var n8 = a45;

// node_modules/@phosphor-icons/react/dist/csr/Plug.es.js
var o23 = __toESM(require("react"), 1);
var e56 = o23.forwardRef((r9, t9) => /* @__PURE__ */ o23.createElement(p, { ref: t9, ...r9, weights: l3 }));
e56.displayName = "PlugIcon";
var n9 = e56;

// node_modules/@phosphor-icons/react/dist/csr/Plus.es.js
var o24 = __toESM(require("react"), 1);
var e57 = o24.forwardRef((r9, s9) => /* @__PURE__ */ o24.createElement(p, { ref: s9, ...r9, weights: a28 }));
e57.displayName = "PlusIcon";
var n10 = e57;

// node_modules/@phosphor-icons/react/dist/csr/Robot.es.js
var o25 = __toESM(require("react"), 1);
var t7 = o25.forwardRef((e63, r9) => /* @__PURE__ */ o25.createElement(p, { ref: r9, ...e63, weights: e27 }));
t7.displayName = "RobotIcon";
var n11 = t7;

// node_modules/@phosphor-icons/react/dist/csr/ShieldCheck.es.js
var e58 = __toESM(require("react"), 1);
var o26 = e58.forwardRef((c7, r9) => /* @__PURE__ */ e58.createElement(p, { ref: r9, ...c7, weights: e28 }));
...
var o27 = e59.forwardRef((r9, n14) => /* @__PURE__ */ e59.createElement(p, { ref: n14, ...r9, weights: e29 }));
o27.displayName = "SpinnerGapIcon";
var m5 = o27;

// node_modules/@phosphor-icons/react/dist/csr/Stop.es.js
var o28 = __toESM(require("react"), 1);
var t8 = o28.forwardRef((e63, r9) => /* @__PURE__ */ o28.createElement(p, { ref: r9, ...e63, weights: a32 }));
t8.displayName = "StopIcon";
var s8 = t8;

// node_modules/@phosphor-icons/react/dist/csr/Trash.es.js
var o29 = __toESM(require("react"), 1);
var r6 = o29.forwardRef((a46, e63) => /* @__PURE__ */ o29.createElement(p, { ref: e63, ...a46, weights: e31 }));
r6.displayName = "TrashIcon";
var n12 = r6;

// node_modules/@phosphor-icons/react/dist/csr/UploadSimple.es.js
var o30 = __toESM(require("react"), 1);
var e60 = o30.forwardRef((a46, m7) => /* @__PURE__ */ o30.createElement(p, { ref: m7, ...a46, weights: e32 }));
e60.displayName = "UploadSimpleIcon";
var l5 = e60;

// node_modules/@phosphor-icons/react/dist/csr/Warning.es.js
var o31 = __toESM(require("react"), 1);
var r7 = o31.forwardRef((n14, a46) => /* @__PURE__ */ o31.createElement(p, { ref: a46, ...n14, weights: e33 }));
r7.displayName = "WarningIcon";
var c6 = r7;

// node_modules/@phosphor-icons/react/dist/csr/WarningCircle.es.js
var r8 = __toESM(require("react"), 1);
var e61 = r8.forwardRef((o33, n14) => /* @__PURE__ */ r8.createElement(p, { ref: n14, ...o33, weights: a36 }));
e61.displayName = "WarningCircleIcon";
var m6 = e61;

// node_modules/@phosphor-icons/react/dist/csr/X.es.js
var o32 = __toESM(require("react"), 1);
var e62 = o32.forwardRef((r9, t9) => /* @__PURE__ */ o32.createElement(p, { ref: t9, ...r9, weights: a37 }));
e62.displayName = "XIcon";
var n13 = e62;
  ...
  return import_react3.default.createElement(
    ...
    import_react3.default.createElement(
      ...
      import_react3.default.createElement(
        ...
        }, import_react3.default.createElement(a44, { size: 14, weight: "regular", "aria-hidden": true })),
        import_react3.default.createElement("button", {
          type: "button",
        ...
        }, import_react3.default.createElement(n12, { size: 14, weight: "regular", "aria-hidden": true }))
      )
    ),
      ...
      state.phase === "loading" ? import_react3.default.createElement("div", { className: "cpwb-home-loading", role: "status" }, import_react3.default.createElement("i"), " \u6B63\u5728\u540C\u6B65\u5DE5\u4F5C\u53F0\u6570\u636E\u2026") : import_react3.default.createElement(
        ...
        import_react3.default.createElement(
          ...
          import_react3.default.createElement(
            ...
            import_react3.default.createElement(n4, { size: 26, weight: "regular", "aria-hidden": true }),
            import_react3.default.createElement(
              "span",
              null,
    ...
    deleteTarget ? import_react3.default.createElement("div", {
      ...
      import_react3.default.createElement(
        ...
        import_react3.default.createElement(
          ...
          import_react3.default.createElement(n12, { size: 14, "aria-hidden": true }),
...
function organizeTodos(todos, { view = "pending", timeZone = DEFAULT_TIME_ZONE, now = /* @__PURE__ */ new Date() } = {}) {
  ...
  rows.sort((a46, b) => view === "completed" ? new Date(b.completedAt || b.dueAt).getTime() - new Date(a46.completedAt || a46.dueAt).getTime() : new Date(a46.dueAt).getTime() - new Date(b.dueAt).getTime());
...
function TodoDialog({ todo, onSave, onClose, busy, error, timeZone }) {
  ...
  return import_react7.default.createElement(
    ...
    import_react7.default.createElement(
      ...
      import_react7.default.createElement("label", null, "\u6807\u9898", import_react7.default.createElement("input", { autoFocus: true, value: title, onChange: (e63) => setTitle(e63.target.value), placeholder: "\u4F8B\u5982\uFF1A\u5B8C\u6210\u68C0\u7D22\u63A5\u53E3\u5BA1\u8BA1" })),
      import_react7.default.createElement(
        "div",
        { className: "cpwb-form-grid" },
        import_react7.default.createElement("label", null, "\u9884\u8BA1\u5B8C\u6210\u65E5\u671F", import_react7.default.createElement("input", { type: "date", value: date, onChange: (e63) => setDate(e63.target.value) })),
        import_react7.default.createElement("label", null, "\u9884\u8BA1\u5B8C\u6210\u65F6\u95F4", import_react7.default.createElement("input", { type: "time", value: time, onChange: (e63) => setTime(e63.target.value) }))
      ),
...
function Todos({ store: store3, projectId, now }) {
  ...
  return import_react7.default.createElement(
    ...
    import_react7.default.createElement("div", { className: "cpwb-tool-head" }, import_react7.default.createElement("span", null, "PROJECT TODO"), import_react7.default.createElement("button", { className: "cpwb-btn cpwb-btn-primary cpwb-button-content", type: "button", onClick: () => setDialog({ todo: null }) }, import_react7.default.createElement(n10, { size: 14, weight: "bold" }), import_react7.default.createElement("span", null, "\u65B0\u589E"))),
    import_react7.default.createElement(
      "div",
    ...
    sections.length === 0 ? import_react7.default.createElement(Empty, { glyph: glyph(ICONS.grid) }, view === "completed" ? "\u6682\u65E0\u5DF2\u5B8C\u6210\u5F85\u529E" : "\u6682\u65E0\u5F85\u5904\u7406\u5F85\u529E\uFF0C\u6DFB\u52A0\u7B2C\u4E00\u9879") : import_react7.default.createElement("div", { className: "cpwb-todo-sections" }, sections.map((section) => import_react7.default.createElement(
      ...
      import_react7.default.createElement("div", { className: "cpwb-list" }, section.items.map((todo) => import_react7.default.createElement(
        ...
        import_react7.default.createElement("button", { type: "button", className: "cpwb-check" + (todo.done ? " cpwb-done" : ""), onClick: () => toggle(todo), "aria-label": todo.done ? "\u6807\u8BB0\u672A\u5B8C\u6210" : "\u6807\u8BB0\u5B8C\u6210" }, todo.done ? import_react7.default.createElement(n3, { size: 14, weight: "bold" }) : null),
        import_react7.default.createElement(
          "button",
        ...
        import_react7.default.createElement("button", { type: "button", className: "cpwb-icon-button", onClick: () => setDialog({ todo }), "aria-label": "\u7F16\u8F91\u5F85\u529E " + todo.title }, import_react7.default.createElement(a44, { size: 14 })),
        import_react7.default.createElement("button", { type: "button", className: "cpwb-icon-button cpwb-danger-icon", onClick: () => setDeleteTarget(todo), "aria-label": "\u5220\u9664\u5F85\u529E " + todo.title }, import_react7.default.createElement(n12, { size: 14 }))
      )))
    ))),
    ...
    deleteTarget ? import_react7.default.createElement(
      ...
      import_react7.default.createElement(
        ...
        import_react7.default.createElement(
          ...
          }) }, import_react7.default.createElement(n12, { size: 14 }), import_react7.default.createElement("span", null, "\u786E\u8BA4\u5220\u9664"))
        )
      )
    ) : null
  );
...
var ACCEPT = ACCEPT_EXTENSIONS.map(function(e63) {
  return "." + e63;
}).join(",");
var DOC_STATUS = {
...
function KnowledgeBase({ store: store3, projectId, knowledgeBaseId, sessions, workspaces, onConversationOpen, view = "all" }) {
  ...
  import_react9.default.useEffect(function() {
    ...
    Promise.all([
      ...
      store3.actions.loadKnowledgeChats(knowledgeBaseId)
    ]).then(function() {
  ...
  import_react9.default.useEffect(function() {
    if (!standalone && selectedId != null) store3.actions.loadKnowledgeChats(selectedId).catch(function() {
    });
  ...
  const onDrop = function(e63) {
    e63.preventDefault();
    setDragActive(false);
    if (e63.dataTransfer && e63.dataTransfer.files) handleFiles(e63.dataTransfer.files);
  };
  ...
  const openChat = function(chatId) {
    ...
    setOpeningChat(true);
    setChatError(null);
    store3.actions.openKnowledgeChat({ knowledgeBaseId: selectedId, chatId: chatId == null ? void 0 : chatId }).then(function(result) {
      ...
      store3.actions.loadKnowledgeChats(selectedId).catch(function() {
      });
      return result;
    }).catch(function(err) {
      if (!mountedRef.current) return;
  ...
  return import_react9.default.createElement(
    ...
    showDirectory ? import_react9.default.createElement(
      ...
      import_react9.default.createElement(
        ...
        import_react9.default.createElement("input", { className: "cpwb-input", value: newKb, placeholder: "\u65B0\u5EFA\u77E5\u8BC6\u5E93\u2026", onChange: function(e63) {
          setNewKb(e63.target.value);
        }, onKeyDown: function(e63) {
          if (e63.key === "Enter") createKb();
        } }),
      ...
      knowledgeBases.length === 0 ? import_react9.default.createElement(Empty, { glyph: glyph(ICONS.db, 18) }, "\u6682\u65E0\u77E5\u8BC6\u5E93\uFF0C\u5148\u65B0\u5EFA\u4E00\u4E2A") : import_react9.default.createElement("div", { className: "cpwb-kb-list" }, knowledgeBases.map(function(kb) {
        ...
        return import_react9.default.createElement(
          ...
          import_react9.default.createElement("button", { type: "button", className: "cpwb-icon-button cpwb-danger-icon", onClick: function() {
            setDeleteTarget(kb);
          }, title: "\u5220\u9664\u77E5\u8BC6\u5E93", "aria-label": "\u5220\u9664\u77E5\u8BC6\u5E93 " + kb.name }, import_react9.default.createElement(n12, { size: 14 }))
        );
      }))
    ) : null,
    showDocuments ? import_react9.default.createElement(
      ...
      selectedId != null ? import_react9.default.createElement(
        ...
        import_react9.default.createElement("input", { type: "file", multiple: true, accept: ACCEPT, disabled: uploading, style: { display: "none" }, onChange: function(e63) {
          handleFiles(e63.target.files);
          e63.target.value = "";
        } }),
        glyph(ICONS.upload),
      ...
      pending.length > 0 ? import_react9.default.createElement(
        ...
        pending.map(function(p3) {
          ...
          return import_react9.default.createElement(
            ...
            import_react9.default.createElement("span", { className: "cpwb-item-title" }, p3.name),
    ...
    selectedId != null && showRetrieval ? import_react9.default.createElement(
      ...
      import_react9.default.createElement(
        "div",
        { className: "cpwb-addrow" },
        import_react9.default.createElement("input", { className: "cpwb-input", value: query, placeholder: "\u68C0\u7D22\u8BE5\u77E5\u8BC6\u5E93\u2026", onChange: function(e63) {
          setQuery(e63.target.value);
        }, onKeyDown: function(e63) {
          if (e63.key === "Enter") runSearch();
        } }),
    ...
    selectedId != null && showSessions ? import_react9.default.createElement(
      ...
      knowledgeChats.length === 0 ? import_react9.default.createElement(Empty, { glyph: glyph(ICONS.book, 18) }, "\u9009\u62E9\u77E5\u8BC6\u5E93\u540E\u65B0\u5EFA\u804A\u5929") : import_react9.default.createElement("div", { className: "cpwb-kb-list" }, knowledgeChats.map(function(c7) {
        return import_react9.default.createElement(
          "div",
          { key: c7.id, className: "cpwb-kb-row" },
          import_react9.default.createElement(
            "button",
            { type: "button", className: "cpwb-kb-name", onClick: function() {
              openChat(c7.id);
    ...
    deleteTarget ? import_react9.default.createElement(
      ...
      import_react9.default.createElement(
        ...
        import_react9.default.createElement(
          ...
          }) }, import_react9.default.createElement(n12, { size: 14 }), import_react9.default.createElement("span", null, deletingKb ? "\u5220\u9664\u4E2D\u2026" : "\u6C38\u4E45\u5220\u9664"))
        )
      )
    ) : null
  );
...
function Feedback({ action, type }) {
  ...
  if (action.status === "running") return import_react11.default.createElement("div", { className: "cpwb-status cpwb-status-loading", role: "status" }, import_react11.default.createElement(m5, iconProps), import_react11.default.createElement("span", null, "\u6267\u884C\u4E2D\u2026"));
  ...
  return import_react11.default.createElement(
    ...
    import_react11.default.createElement(
      ...
      import_react11.default.createElement(
        ...
        schedule ? import_react11.default.createElement("button", { type: "button", className: "cpwb-btn cpwb-btn-danger cpwb-button-content", onClick: () => setConfirmDelete(true) }, import_react11.default.createElement(n12, { size: 15 }), import_react11.default.createElement("span", null, "\u5220\u9664")) : import_react11.default.createElement("span", null),
...
function Automation({ store: store3, projectId, view = "all", initialDialog = null }) {
  ...
  const scheduleNodes = schedules.map((schedule) => {
    ...
    return import_react11.default.createElement(
      ...
      } }, import_react11.default.createElement(n8, { size: 14, weight: "fill" })),
      import_react11.default.createElement("button", { type: "button", className: "cpwb-icon-button", "aria-label": "\u7F16\u8F91 " + schedule.name, onClick: (event) => {
        event.stopPropagation();
        setDialog({ schedule });
      } }, import_react11.default.createElement(a44, { size: 14 }))
    );
  });
    ...
    return import_react11.default.createElement(
      ...
      import_react11.default.createElement(
        ...
        import_react11.default.createElement(
          ...
          import_react11.default.createElement("button", { type: "button", className: "cpwb-icon-button cpwb-danger-icon", title: "\u5220\u9664", "aria-label": `\u5220\u9664 ${summary.summaryDate} \u6BCF\u65E5\u603B\u7ED3`, onClick: () => setSummaryToDelete(summary) }, import_react11.default.createElement(n12, { size: 14 }))
        )
      ),
  ...
  return import_react11.default.createElement(
    ...
    }) }, summaryGenerating ? import_react11.default.createElement(m5, { size: 13, className: "cpwb-spin" }) : import_react11.default.createElement(n8, { size: 13 }), import_react11.default.createElement("span", null, summaryGenerating ? "\u751F\u6210\u4E2D\u2026" : "\u7ACB\u5373\u751F\u6210"))), import_react11.default.createElement(Feedback, { action, type: "runSummary" }), import_react11.default.createElement(Feedback, { action, type: "deleteSummary" }), summaries.length === 0 ? import_react11.default.createElement(Empty, { glyph: import_react11.default.createElement(c2, { size: 20 }) }, "\u6682\u65E0\u603B\u7ED3\u8BB0\u5F55") : summaryNodes) : null,
    ...
    import_react15.default.createElement(
      ...
      selected?.mode === "one-shot" ? import_react15.default.createElement("footer", { className: "cpwb-subagent-readonly" }, "\u4E00\u6B21\u6027\u4EFB\u52A1\u4EC5\u652F\u6301\u67E5\u770B\u8BB0\u5F55") : selected ? import_react15.default.createElement(
        ...
        import_react15.default.createElement(
          "div",
          null,
          selected.activity === "running" ? import_react15.default.createElement("button", { type: "button", className: "cpwb-subagent-stop", onClick: interrupt }, import_react15.default.createElement(s8, { size: 15, weight: "fill" }), "\u505C\u6B62\u5F53\u524D\u8F6E\u6B21") : import_react15.default.createElement("span", null, catalog.parentAvailable === false ? "\u7236\u4F1A\u8BDD\u6682\u4E0D\u53EF\u7528" : "\u53EF\u7EE7\u7EED\u5BF9\u8BDD"),
          import_react15.default.createElement("button", { type: "submit", className: "cpwb-subagent-send", disabled: sending || !draft.trim() || catalog.parentAvailable === false }, import_react15.default.createElement(m4, { size: 16, weight: "fill" }), sending ? "\u53D1\u9001\u4E2D" : "\u53D1\u9001")
        )
      ) : null,
...
function useProjectRailSeat(projectId) {
  ...
  useBrowserLayoutEffect(function() {
    ...
    if (projectId == null || typeof document === "undefined") return void 0;
...
function WorkbenchSessionShell(props) {
  ...
  const [activeTool, setActiveTool] = import_react17.default.useState("todos");
  ...
  const projectRail = function(drawer = false) {
    return import_react17.default.createElement(
      "aside",
      { className: "cpwb-project-rail" + (drawer ? " cpwb-project-rail-drawer" : ""), "aria-label": "\u9879\u76EE\u5DE5\u5177" },
      import_react17.default.createElement(
        "header",
        { className: "cpwb-project-rail-header" },
        import_react17.default.createElement("span", null, "PROJECT SYSTEM"),
        import_react17.default.createElement("h2", null, project?.name || "\u9879\u76EE\u5DE5\u4F5C\u53F0"),
        import_react17.default.createElement("small", null, "\u9879\u76EE\u4E0A\u4E0B\u6587 \xB7 " + String(projectId).padStart(2, "0"))
      ),
      import_react17.default.createElement("nav", { className: "cpwb-project-tool-tabs", "aria-label": "\u9879\u76EE\u5DE5\u5177" }, PROJECT_TOOL_TABS.map(([id, label, IconComponent]) => import_react17.default.createElement("button", {
        type: "button",
        key: id,
  ...
  return import_react17.default.createElement(
    "div",
    {
      ...
      "data-right-owner": dockedProjectRail ? "project-tools" : projectId != null && !projectSeatAvailable ? "native-details" : void 0,
    ...
    import_react17.default.createElement(
      ...
      import_react17.default.createElement(
        ...
        }, import_react17.default.createElement(n11, { size: 16, weight: "duotone", "aria-hidden": true }), import_react17.default.createElement("span", null, "SUBAGENT"), import_react17.default.createElement("b", null, String(subagentCount).padStart(2, "0"))),
        import_react17.default.createElement("em", null, selectionLabel)
      )
    ),
    dockedProjectRail ? projectRail(false) : null,
    drawerProjectRail ? import_react17.default.createElement("button", {
    ...
    }, import_react17.default.createElement(s2, { size: 18, "aria-hidden": true }), import_react17.default.createElement("span", null, "\u9879\u76EE\u5DE5\u5177")) : null,
    drawerProjectRail ? import_react17.default.createElement(DrawerDialog, {
  ...
  return import_react20.default.createElement(
    ...
    import_react20.default.createElement(
      ...
      import_react20.default.createElement(
        ...
        import_react20.default.createElement(NavIcon, { component: n10 }),
    ...
    import_react20.default.createElement(
      ...
      import_react20.default.createElement("div", { className: "cpwb-sidebar-section-label" }, "\u6700\u8FD1\u4F1A\u8BDD", import_react20.default.createElement("b", null, String(recent.length).padStart(2, "0"))),
      import_react20.default.createElement(
        "div",
        { className: "cpwb-sidebar-recent-scroll" },
        recent.length === 0 ? import_react20.default.createElement("p", { className: "cpwb-sidebar-empty" }, "\u6682\u65E0\u4F1A\u8BDD") : recent.map((session) => import_react20.default.createElement(
          "button",
          {
            type: "button",
          ...
          import_react20.default.createElement(NavIcon, { component: m3 }),
          import_react20.default.createElement(
            "span",
            null,
    ...
    import_react20.default.createElement(
      ...
      import_react20.default.createElement(
        ...
        import_react20.default.createElement(NavIcon, { component: s7 }),
...
function sameLink(a46, b) {
  return a46?.path === b?.path && a46?.viewBox === b?.viewBox;
}
function useKnowledgeBackplaneLink({ activeId, boardRef, panelRef, cardRefs, cardCount }) {
  const [link, setLink] = import_react22.default.useState(null);
  const measure = import_react22.default.useCallback(function() {
  ...
  const useLayoutEffect = typeof window === "undefined" ? import_react22.default.useEffect : import_react22.default.useLayoutEffect;
...
// src/client/KnowledgeCenterPage.js
var h2 = import_react23.default.createElement;
...
function KnowledgeHeader({ mode, knowledgeBase, onBack, onCreate, onSettings, onUpload, onChat }) {
  ...
  return h2(
    ...
    h2(
      ...
      board ? h2("button", { type: "button", className: "cpwb-kb-action cpwb-kb-action-ghost", onClick: onSettings }, h2(s7, { size: 16 }), "\u5411\u91CF\u6A21\u578B") : null,
      board ? h2("button", { type: "button", className: "cpwb-kb-action cpwb-kb-action-primary", onClick: onCreate }, h2(n10, { size: 16 }), "\u65B0\u5EFA\u77E5\u8BC6\u5E93") : null,
      !board ? h2("button", { type: "button", className: "cpwb-kb-action cpwb-kb-action-ghost", onClick: onBack }, h2(s, { size: 16 }), "\u8FD4\u56DE\u77E5\u8BC6\u5E93") : null,
      mode === "detail" ? h2("button", { type: "button", className: "cpwb-kb-action", onClick: onUpload }, h2(l5, { size: 16 }), "\u4E0A\u4F20\u6587\u4EF6") : null,
      mode === "detail" ? h2("button", { type: "button", className: "cpwb-kb-action cpwb-kb-action-primary", onClick: onChat }, h2(m2, { size: 16 }), "\u65B0\u5EFA\u77E5\u8BC6\u5E93\u4F1A\u8BDD") : null
    )
  );
}
...
function KnowledgeBoard({ knowledgeBases, pinnedId, previewId, onPin, onPreview, onPreviewEnd, onCreate, onChat, onDetail, onLink, timezone }) {
  ...
  const boardRef = import_react23.default.useRef(null);
  const panelRef = import_react23.default.useRef(null);
  const cardRefs = import_react23.default.useRef(/* @__PURE__ */ new Map());
  ...
  return h2(
    ...
    h2(
      ...
      h2("div", { className: "cpwb-knowledge-selected-files" }, files.map((file, index) => h2(
        ...
        h2("button", { type: "button", onClick: () => removeFile(index), "aria-label": `\u79FB\u9664 ${file.name}` }, h2(n13, { size: 14 }))
      ))),
  ...
  return h2(
    ...
    h2(
      ...
      h2(
        ...
        h2("label", { className: "cpwb-knowledge-compact-upload" }, h2("input", { type: "file", multiple: true, accept: ACCEPT, onChange: onFileInput }), h2(l5, { size: 15 }), "\u9009\u62E9\u6587\u4EF6\u5E76\u4E0A\u4F20"),
        documents.length ? h2("div", { className: "cpwb-knowledge-file-list" }, documents.map((document2) => {
          ...
          return h2(
            ...
            h2(
              ...
              h2("a", { href: cpwbApi.documents.contentUrl(document2.id, { download: true }), download: document2.originalName, title: "\u4E0B\u8F7D\u539F\u59CB\u6587\u4EF6", "aria-label": `\u4E0B\u8F7D\u539F\u59CB\u6587\u4EF6 ${document2.originalName}` }, h2(l4, { size: 15 })),
              document2.status === "failed" || document2.status === "stale" ? h2("button", { type: "button", onClick: () => onReindex(document2), title: "\u91CD\u65B0\u7D22\u5F15" }, "RETRY") : null,
              h2("button", { type: "button", onClick: () => onUnlink(document2), title: "\u4ECE\u77E5\u8BC6\u5E93\u79FB\u9664", "aria-label": `\u4ECE\u77E5\u8BC6\u5E93\u79FB\u9664 ${document2.originalName}` }, h2(n13, { size: 14 }))
            )
          );
...
function KnowledgeCenterPage({
  ...
  const state = import_react23.default.useSyncExternalStore(store3.subscribe, store3.getSnapshot, store3.getSnapshot);
  const knowledgeBases = Array.isArray(state.knowledgeBases) ? state.knowledgeBases : [];
  const projects = Array.isArray(state.projects) ? state.projects : [];
  const documents = Array.isArray(state.documents) ? state.documents : [];
  const initialId = initialKnowledgeBaseId ?? state.activeKnowledgeBaseId ?? knowledgeBases[0]?.id ?? null;
  const [mode, setMode] = import_react23.default.useState(initialMode);
  const [pinnedId, setPinnedId] = import_react23.default.useState(initialId);
  const [previewId, setPreviewId] = import_react23.default.useState(null);
  const [createName, setCreateName] = import_react23.default.useState("");
  const [createDescription, setCreateDescription] = import_react23.default.useState("");
  const [createFiles, setCreateFiles] = import_react23.default.useState([]);
  const [saving, setSaving] = import_react23.default.useState(false);
  const [localError, setLocalError] = import_react23.default.useState(null);
  const [linking, setLinking] = import_react23.default.useState(false);
  const [showLinks, setShowLinks] = import_react23.default.useState(false);
  const [deleteTarget, setDeleteTarget] = import_react23.default.useState(null);
...
function SessionListPage({ store: store3, onOpenSession }) {
  ...
  const [context, setContext] = import_react25.default.useState("");
  const page = state.sessionPage ?? { items: [], total: 0, limit: 20, offset: 0 };
  const load = import_react25.default.useCallback((offset = 0) => store3.actions.loadAllSessions({
    query: query.trim(),
  ...
  return import_react25.default.createElement(
    ...
    import_react25.default.createElement(
      ...
      import_react25.default.createElement(
        "div",
        { className: "cpwb-page-header-main" },
        import_react25.default.createElement("span", null, "03 / CONVERSATIONS"),
        import_react25.default.createElement("h1", null, "\u5168\u90E8\u4F1A\u8BDD"),
        import_react25.default.createElement("p", null, "\u9879\u76EE\u3001\u77E5\u8BC6\u5E93\u4E0E\u72EC\u7ACB\u4F1A\u8BDD\u7EDF\u4E00\u5F52\u6863\u3002")
      ),
      import_react25.default.createElement("div", { className: "cpwb-page-header-stat" }, import_react25.default.createElement("strong", null, page.total), import_react25.default.createElement("span", null, "\u6761\u4F1A\u8BDD"))
    ),
    import_react25.default.createElement(
      "form",
      ...
      import_react25.default.createElement(
        "label",
        null,
        import_react25.default.createElement(f, { size: 18, weight: "regular", "aria-hidden": true }),
        import_react25.default.createElement("input", { value: query, onChange: (event) => setQuery(event.target.value), placeholder: "\u641C\u7D22\u4F1A\u8BDD\u6216\u6765\u6E90", "aria-label": "\u641C\u7D22\u4F1A\u8BDD" })
      ),
      import_react25.default.createElement(
        "select",
        { value: context, onChange: (event) => setContext(event.target.value), "aria-label": "\u4F1A\u8BDD\u7C7B\u578B" },
        import_react25.default.createElement("option", { value: "" }, "\u5168\u90E8\u7C7B\u578B"),
        import_react25.default.createElement("option", { value: "project" }, "\u9879\u76EE"),
        import_react25.default.createElement("option", { value: "knowledge_base" }, "\u77E5\u8BC6\u5E93"),
        import_react25.default.createElement("option", { value: "independent" }, "\u72EC\u7ACB")
      ),
      import_react25.default.createElement("button", { type: "submit" }, "\u68C0\u7D22")
    ),
    state.action?.status === "error" ? import_react25.default.createElement("div", { className: "cpwb-page-error", role: "alert" }, state.action.error?.message || "\u4F1A\u8BDD\u52A0\u8F7D\u5931\u8D25") : null,
    page.items.length === 0 ? import_react25.default.createElement("div", { className: "cpwb-session-list-empty" }, import_react25.default.createElement(s4, { size: 28, weight: "regular" }), import_react25.default.createElement("span", null, "\u6682\u65E0\u5339\u914D\u4F1A\u8BDD")) : import_react25.default.createElement("div", { className: "cpwb-session-list" }, page.items.map((row) => import_react25.default.createElement(
      "button",
      {
        type: "button",
        key: row.sessionId,
      ...
      import_react25.default.createElement(s4, { size: 20, weight: "regular", "aria-hidden": true }),
      import_react25.default.createElement(
        "span",
        null,
        import_react25.default.createElement("strong", null, row.title || row.displayTitle || row.contextName || "\u672A\u547D\u540D\u4F1A\u8BDD"),
        import_react25.default.createElement("small", null, scopeLabel(row))
      ),
      import_react25.default.createElement("time", null, activityLabel(row.updatedAt))
    ))),
    import_react25.default.createElement(
      "footer",
      { className: "cpwb-session-pagination" },
      import_react25.default.createElement("span", null, "\u5171 " + page.total + " \u6761"),
      import_react25.default.createElement(
        "div",
        null,
        import_react25.default.createElement("button", { type: "button", disabled: page.offset <= 0, onClick: () => load(Math.max(0, page.offset - page.limit)).catch(function() {
        }) }, "\u4E0A\u4E00\u9875"),
        import_react25.default.createElement("button", { type: "button", disabled: page.offset + page.limit >= page.total, onClick: () => load(page.offset + page.limit).catch(function() {
        }) }, "\u4E0B\u4E00\u9875")
      )
    )
  );
...
function WorkbenchShell(props) {
  ...
  const view = import_react27.default.useSyncExternalStore(
    navigation2.subscribe,
    navigation2.getSnapshot,
    navigation2.getSnapshot
  );
  const state = import_react27.default.useSyncExternalStore(props.store.subscribe, props.store.getSnapshot, props.store.getSnapshot);
  const layoutMode = useWorkbenchLayoutMode(props.layoutMode);
  const [drawerOwner, setDrawerOwner] = import_react27.default.useState(null);
  const navigationTriggerRef = import_react27.default.useRef(null);
  ...
  if (view.page === "conversation") {
    center = import_react27.default.createElement(WorkbenchSessionShell, {
      ...props,
      open: true,
      globalSidebar: true,
    ...
    center = import_react27.default.createElement(KnowledgeCenterPage, {
      store: props.store,
      sessions: props.sessions,
    ...
    center = import_react27.default.createElement(SessionListPage, { store: props.store, onOpenSession: openSession });
  } else {
    center = import_react27.default.createElement(ProjectHome, { ...props, open: true });
  }
  const sidebar = import_react27.default.createElement(WorkbenchSidebar, {
    page: view.page,
  ...
  return import_react27.default.createElement(
    ...
    layoutMode === "mobile" ? import_react27.default.createElement(
      ...
      }, import_react27.default.createElement(c5, { size: 21, "aria-hidden": true })),
      import_react27.default.createElement(DrawerDialog, {
    ...
    import_react27.default.createElement("section", { className: "cpwb-workbench-stage" }, center)
  );
}
...
function ActionMessage({ message }) {
  return message ? import_react29.default.createElement("p", { role: "status", className: "cpwb-settings-message" }, message) : null;
}
function TimezonePanel({ settings, store: store3 }) {
  const [draft, setDraft] = import_react29.default.useState(settings.timezone || "Asia/Shanghai");
  const [message, setMessage] = import_react29.default.useState("");
  const [saving, setSaving] = import_react29.default.useState(false);
  import_react29.default.useEffect(() => setDraft(settings.timezone || "Asia/Shanghai"), [settings.timezone]);
  const save = async () => {
    setSaving(true);
    setMessage("");
    try {
  ...
  return import_react29.default.createElement(
    ...
    import_react29.default.createElement("span", { className: "cpwb-eyebrow" }, "WORKBENCH / GLOBAL TIMEZONE"),
    import_react29.default.createElement("h2", null, "\u5168\u5C40\u65F6\u533A"),
    import_react29.default.createElement("p", null, "\u6240\u6709\u5F85\u529E\u3001\u5B9A\u65F6\u4EFB\u52A1\u3001\u603B\u7ED3\u4E0E\u754C\u9762\u65F6\u95F4\u7EDF\u4E00\u4F7F\u7528 Workbench \u65F6\u533A\u3002"),
    import_react29.default.createElement(
      "select",
      { value: draft, onChange: (event) => setDraft(event.target.value), "aria-label": "Workbench \u65F6\u533A" },
      ...["Asia/Shanghai", "Asia/Tokyo", "Asia/Singapore", "Europe/London", "America/Los_Angeles", "America/New_York", "UTC"].map((zone) => import_react29.default.createElement("option", { key: zone, value: zone }, zone))
    ),
    import_react29.default.createElement("input", { value: draft, onChange: (event) => setDraft(event.target.value), placeholder: "\u5408\u6CD5 IANA ID\uFF0C\u4F8B\u5982 Europe/Berlin", "aria-label": "\u81EA\u5B9A\u4E49 IANA \u65F6\u533A" }),
    import_react29.default.createElement("button", { type: "button", onClick: save, disabled: saving }, saving ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58\u65F6\u533A"),
    import_react29.default.createElement(ActionMessage, { message })
  );
}
function AutomationPromptsPanel({ settings, store: store3 }) {
  const prompts = settings.automationPrompts || { summaryPrompt: "", todoPrompt: "" };
  const [draft, setDraft] = import_react29.default.useState(prompts);
  const [message, setMessage] = import_react29.default.useState("");
  const [saving, setSaving] = import_react29.default.useState(false);
  import_react29.default.useEffect(() => setDraft(prompts), [prompts.summaryPrompt, prompts.todoPrompt]);
  ...
  return import_react29.default.createElement(
    ...
    import_react29.default.createElement("span", { className: "cpwb-eyebrow" }, "AUTOMATION / PROMPT CONTROL"),
    import_react29.default.createElement("h2", null, "\u81EA\u52A8\u5316\u63D0\u793A\u8BCD"),
    import_react29.default.createElement("p", null, "\u652F\u6301\u53D8\u91CF {{projectId}}\u3001{{date}}\u3001{{nextDate}}\uFF1B\u8FD0\u884C\u65F6\u9879\u76EE\u6570\u636E\u4F1A\u7531\u7CFB\u7EDF\u5B89\u5168\u8FFD\u52A0\u3002"),
    import_react29.default.createElement(
      "label",
      null,
      "\u6BCF\u65E5\u603B\u7ED3\u63D0\u793A\u8BCD",
      import_react29.default.createElement("textarea", { rows: 8, value: draft.summaryPrompt, onChange: patch("summaryPrompt"), "aria-label": "\u6BCF\u65E5\u603B\u7ED3\u63D0\u793A\u8BCD" })
    ),
    import_react29.default.createElement(
      "label",
      null,
      "\u6B21\u65E5\u5F85\u529E\u63D0\u793A\u8BCD",
      import_react29.default.createElement("textarea", { rows: 8, value: draft.todoPrompt, onChange: patch("todoPrompt"), "aria-label": "\u6B21\u65E5\u5F85\u529E\u63D0\u793A\u8BCD" })
    ),
    import_react29.default.createElement("button", { type: "button", onClick: save, disabled: saving }, saving ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58\u63D0\u793A\u8BCD"),
    import_react29.default.createElement(ActionMessage, { message })
  );
}
function EmbeddingPanel({ settings, store: store3 }) {
  ...
  const [draft, setDraft] = import_react29.default.useState({
  ...
  const [credentialValue, setCredentialValue] = import_react29.default.useState("");
  const [message, setMessage] = import_react29.default.useState("");
  const [saving, setSaving] = import_react29.default.useState(false);
  import_react29.default.useEffect(() => setDraft({
    provider: embedding.provider || "ollama",
    baseUrl: embedding.baseUrl || "http://127.0.0.1:11434",
    model: embedding.model || "qwen3-embedding:0.6b",
    dimensions: embedding.dimensions || 1024,
  ...
  return import_react29.default.createElement(
    "div",
    { className: "cpwb-settings-panel" },
    import_react29.default.createElement("span", { className: "cpwb-eyebrow" }, "KNOWLEDGE / EMBEDDING"),
    import_react29.default.createElement("h2", null, "\u5411\u91CF\u6A21\u578B"),
    import_react29.default.createElement("label", null, "Provider", import_react29.default.createElement("select", { value: draft.provider, onChange: patch("provider") }, import_react29.default.createElement("option", { value: "ollama" }, "Ollama"), import_react29.default.createElement("option", { value: "openai-compatible" }, "OpenAI-compatible"))),
    import_react29.default.createElement("label", null, "Base URL", import_react29.default.createElement("input", { value: draft.baseUrl, onChange: patch("baseUrl"), "aria-label": "Embedding Base URL" })),
    import_react29.default.createElement("label", null, "Model", import_react29.default.createElement("input", { value: draft.model, onChange: patch("model"), "aria-label": "Embedding model" })),
    import_react29.default.createElement("label", null, "Dimensions", import_react29.default.createElement("input", { type: "number", value: draft.dimensions, onChange: patch("dimensions"), "aria-label": "Embedding dimensions" })),
    import_react29.default.createElement("label", null, "Timeout (ms)", import_react29.default.createElement("input", { type: "number", value: draft.timeoutMs, onChange: patch("timeoutMs"), "aria-label": "Embedding timeout" })),
    import_react29.default.createElement("label", null, "Credential reference", import_react29.default.createElement("input", { value: draft.credentialRef, onChange: patch("credentialRef"), "aria-label": "Embedding credential reference" })),
    import_react29.default.createElement(
      "div",
      { className: "cpwb-settings-actions" },
      import_react29.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.testEmbedding(config), "\u5411\u91CF\u670D\u52A1\u8FDE\u63A5\u6B63\u5E38\u3002"), disabled: saving }, "\u6D4B\u8BD5\u8FDE\u63A5"),
      import_react29.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.updateEmbedding(config), "\u5411\u91CF\u914D\u7F6E\u5DF2\u4FDD\u5B58\uFF0C\u7D22\u5F15\u72B6\u6001\u6B63\u5728\u6821\u9A8C\u3002"), disabled: saving }, "\u4FDD\u5B58\u914D\u7F6E")
    ),
    import_react29.default.createElement(
      "fieldset",
      null,
      import_react29.default.createElement("legend", null, "\u51ED\u636E\u72B6\u6001"),
      import_react29.default.createElement("p", null, credential.configured ? `\u5DF2\u914D\u7F6E \xB7 \u6765\u6E90 ${credential.source || "\u672A\u77E5"}` : "\u672A\u914D\u7F6E", credential.readOnly ? " \xB7 \u53EA\u8BFB" : ""),
      import_react29.default.createElement("input", { type: "password", value: credentialValue, onChange: (event) => setCredentialValue(event.target.value), placeholder: "\u8F93\u5165\u65B0\u51ED\u636E", "aria-label": "\u65B0 embedding \u51ED\u636E" }),
      import_react29.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.putEmbeddingCredential({ credentialRef: draft.credentialRef, value: credentialValue }), "\u51ED\u636E\u5DF2\u4EA4\u7531 DSH credentials \u4FDD\u5B58\u3002"), disabled: saving || !draft.credentialRef || !credentialValue }, "\u8BBE\u7F6E / \u66FF\u6362\u51ED\u636E"),
      import_react29.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.deleteEmbeddingCredential({ credentialRef: draft.credentialRef }), "\u51ED\u636E\u5DF2\u6E05\u9664\u3002"), disabled: saving || !draft.credentialRef }, "\u6E05\u9664\u51ED\u636E")
    ),
    import_react29.default.createElement(
      "div",
      { className: "cpwb-settings-index" },
      import_react29.default.createElement("strong", null, `\u7D22\u5F15\u72B6\u6001\uFF1A${index.status || "unknown"}`),
      import_react29.default.createElement("span", null, `\u6587\u6863 ${index.counts?.ready ?? index.documentCount ?? 0}`),
      import_react29.default.createElement("p", null, "\u5F71\u54CD\u8303\u56F4\uFF1A\u5168\u90E8\u77E5\u8BC6\u5E93\u6587\u6863"),
      import_react29.default.createElement("button", { type: "button", onClick: () => {
...
function NetworkPanel({ settings, store: store3 }) {
  ...
  const [draft, setDraft] = import_react29.default.useState({ mode: saved.mode || "inherit", proxyUrl: saved.proxyUrl || "", noProxy: saved.noProxy || "" });
  const [message, setMessage] = import_react29.default.useState("");
  const [saving, setSaving] = import_react29.default.useState(false);
  const [testResult, setTestResult] = import_react29.default.useState(null);
  import_react29.default.useEffect(() => setDraft({ mode: saved.mode || "inherit", proxyUrl: saved.proxyUrl || "", noProxy: saved.noProxy || "" }), [saved.mode, saved.proxyUrl, saved.noProxy]);
  const run = async (action, success) => {
    setSaving(true);
    setMessage("");
    try {
  ...
  return import_react29.default.createElement(
    "div",
    { className: "cpwb-settings-panel" },
    import_react29.default.createElement("span", { className: "cpwb-eyebrow" }, "RUNTIME / NETWORK"),
    import_react29.default.createElement("h2", null, "\u7F51\u7EDC / Proxy"),
    import_react29.default.createElement("label", null, "\u6A21\u5F0F", import_react29.default.createElement("select", { value: draft.mode, onChange: (event) => setDraft({ ...draft, mode: event.target.value }) }, import_react29.default.createElement("option", { value: "inherit" }, "\u7EE7\u627F DSH"), import_react29.default.createElement("option", { value: "direct" }, "\u76F4\u8FDE"), import_react29.default.createElement("option", { value: "custom" }, "\u81EA\u5B9A\u4E49 Proxy"))),
    import_react29.default.createElement("label", null, "Proxy URL", import_react29.default.createElement("input", { value: draft.proxyUrl, onChange: (event) => setDraft({ ...draft, proxyUrl: event.target.value }), "aria-label": "Proxy URL" })),
    import_react29.default.createElement("label", null, "No Proxy", import_react29.default.createElement("input", { value: draft.noProxy, onChange: (event) => setDraft({ ...draft, noProxy: event.target.value }), "aria-label": "No Proxy" })),
    import_react29.default.createElement(
      "div",
      { className: "cpwb-settings-actions" },
      import_react29.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.updateNetwork(draft), "\u7F51\u7EDC\u914D\u7F6E\u5DF2\u4FDD\u5B58\uFF1B\u8FDB\u7A0B\u7EA7\u4EE3\u7406\u5C06\u5728\u4E0B\u6B21\u542F\u52A8\u751F\u6548\u3002"), disabled: saving }, "\u4FDD\u5B58\u7F51\u7EDC"),
      import_react29.default.createElement("button", { type: "button", onClick: () => run(() => store3.actions.testNetwork(draft), "\u5DF2\u5B8C\u6210\u5F53\u524D\u751F\u6548\u7F51\u7EDC\u6D4B\u8BD5\uFF1B\u81EA\u5B9A\u4E49\u914D\u7F6E\u5C06\u5728\u4E0B\u6B21\u542F\u52A8\u9A8C\u8BC1\u3002"), disabled: saving }, "\u6D4B\u8BD5\u5F53\u524D\u751F\u6548\u7F51\u7EDC")
    ),
    import_react29.default.createElement("p", null, `\u5F53\u524D\u751F\u6548\uFF1A${network.currentEffective?.mode || "inherit"}`),
    import_react29.default.createElement("p", null, `\u4E0B\u6B21\u542F\u52A8\uFF1A${network.nextLaunch?.mode || network.mode || "inherit"}`),
    import_react29.default.createElement("p", null, network.requiresRestart ? "\u914D\u7F6E\u5DF2\u4FDD\u5B58\uFF0C\u4E0B\u6B21\u542F\u52A8\u751F\u6548\u3002" : "\u5F53\u524D\u8FDB\u7A0B\u5DF2\u4E0E\u4FDD\u5B58\u914D\u7F6E\u4E00\u81F4\u3002"),
    testResult ? import_react29.default.createElement("pre", { "data-network-result": true }, JSON.stringify(testResult)) : null,
    import_react29.default.createElement(ActionMessage, { message })
  );
}
function AuthPanel({ settings, store: store3 }) {
  ...
  const [message, setMessage] = import_react29.default.useState("");
  const [busy, setBusy] = import_react29.default.useState(false);
  ...
  return import_react29.default.createElement(
    "div",
    { className: "cpwb-settings-panel" },
    import_react29.default.createElement("span", { className: "cpwb-eyebrow" }, "CODEX LINK / LOCAL AUTH BRIDGE"),
    import_react29.default.createElement("h2", null, "Codex \u5FEB\u901F\u63A5\u5165"),
    import_react29.default.createElement(
      "div",
      { className: `cpwb-auth-state ${configured ? "cpwb-auth-online" : "cpwb-auth-offline"}` },
      import_react29.default.createElement("span", { className: "cpwb-auth-icon" }, configured ? import_react29.default.createElement(h, { size: 25, weight: "duotone", "aria-hidden": true }) : import_react29.default.createElement(n6, { size: 25, weight: "duotone", "aria-hidden": true })),
      import_react29.default.createElement(
        "div",
        null,
        import_react29.default.createElement("strong", null, configured ? "CODEX LINK / ONLINE" : "CODEX LINK / NOT CONNECTED"),
        import_react29.default.createElement("p", null, configured ? `\u51ED\u636E\u6765\u6E90\uFF1A${auth.source || "DSH credentials"}` : "\u626B\u63CF\u672C\u673A Codex \u767B\u5F55\u7F13\u5B58\uFF0C\u5E76\u5B89\u5168\u63A5\u5165\u5F53\u524D Workbench\u3002")
      )
    ),
    import_react29.default.createElement(
      "div",
      { className: "cpwb-auth-privacy" },
      import_react29.default.createElement(m6, { size: 17, weight: "regular", "aria-hidden": true }),
      import_react29.default.createElement("p", null, "\u626B\u63CF\u53EA\u5728\u70B9\u51FB\u540E\u53D1\u751F\u3002\u4EE4\u724C\u4E0D\u4F1A\u53D1\u9001\u5230\u6D4F\u89C8\u5668\u3001\u5199\u5165 Workbench \u6570\u636E\u5E93\u6216\u663E\u793A\u5728\u65E5\u5FD7\u4E2D\u3002")
    ),
    configured ? import_react29.default.createElement(
      "div",
      { className: "cpwb-settings-actions" },
      import_react29.default.createElement("button", { type: "button", onClick: test, disabled: busy }, busy ? "\u9A8C\u8BC1\u4E2D\u2026" : "\u9A8C\u8BC1\u672C\u5730\u51ED\u636E"),
      import_react29.default.createElement("span", { className: "cpwb-auth-activation" }, "NEXT REQUEST / ACTIVE")
    ) : import_react29.default.createElement(
      "button",
      { type: "button", className: "cpwb-auth-connect", onClick: connect, disabled: busy || auth.canConnect === false },
      busy ? import_react29.default.createElement(import_react29.default.Fragment, null, import_react29.default.createElement(m5, { size: 18, className: "cpwb-spin", "aria-hidden": true }), "\u6B63\u5728\u63A5\u5165\u2026") : import_react29.default.createElement(import_react29.default.Fragment, null, import_react29.default.createElement(n9, { size: 18, weight: "bold", "aria-hidden": true }), "\u626B\u63CF\u5E76\u63A5\u5165 Codex")
    ),
    auth.readOnly ? import_react29.default.createElement("p", null, "\u8BE5\u51ED\u636E\u7531\u542F\u52A8\u73AF\u5883\u63D0\u4F9B\uFF0C\u53EA\u8BFB\u4E14\u4F18\u5148\u4E8E\u672C\u5730\u51ED\u636E\u5E93\u3002") : null,
    auth.canConnect === false && !configured ? import_react29.default.createElement("p", { className: "cpwb-auth-unavailable" }, "\u5F53\u524D DSH credentials \u670D\u52A1\u4E0D\u53EF\u7528\uFF0C\u65E0\u6CD5\u6267\u884C\u81EA\u52A8\u63A5\u5165\u3002") : null,
    import_react29.default.createElement(ActionMessage, { message })
  );
}
function WorkbenchPanel({ section, settings, store: store3 }) {
  if (section === "timezone") return import_react29.default.createElement(TimezonePanel, { settings, store: store3 });
  if (section === "automation") return import_react29.default.createElement(AutomationPromptsPanel, { settings, store: store3 });
  if (section === "embedding") return import_react29.default.createElement(EmbeddingPanel, { settings, store: store3 });
  if (section === "network") return import_react29.default.createElement(NetworkPanel, { settings, store: store3 });
  if (section === "auth") return import_react29.default.createElement(AuthPanel, { settings, store: store3 });
  return import_react29.default.createElement(
    "div",
    { className: "cpwb-settings-panel" },
    import_react29.default.createElement("span", { className: "cpwb-eyebrow" }, "HARNESS WORKBENCH"),
    import_react29.default.createElement("h2", null, "Workbench \u8BBE\u7F6E"),
    import_react29.default.createElement("p", null, "\u8FD9\u91CC\u662F Workbench \u81EA\u6709\u8BBE\u7F6E\u3002\u6A21\u578B\u3001\u63D2\u4EF6\u4E0E DSH credentials \u7EE7\u7EED\u7531\u539F\u751F DSH \u8BBE\u7F6E\u9875\u9762\u7BA1\u7406\u3002")
  );
}
function WorkbenchSettingsSection({ store: store3, initialActive = "workbench" }) {
  const [active, setActive] = import_react29.default.useState(initialActive);
  const subscribe = store3?.subscribe || (() => () => {
  });
  const getSnapshot = store3?.getSnapshot || (() => ({}));
  const snapshot = import_react29.default.useSyncExternalStore(subscribe, getSnapshot, getSnapshot) || {};
  ...
  return import_react29.default.createElement(
    ...
    import_react29.default.createElement(
      ...
      import_react29.default.createElement(
        "div",
        null,
        import_react29.default.createElement("span", { className: "cpwb-eyebrow" }, "HARNESS WORKBENCH / SYSTEM CONFIG"),
        import_react29.default.createElement("h2", null, "Workbench \u8BBE\u7F6E"),
        import_react29.default.createElement("p", null, "\u9879\u76EE\u5DE5\u4F5C\u53F0\u6269\u5C55\u8BBE\u7F6E\uFF1B\u6A21\u578B\u3001\u63D2\u4EF6\u548C Agent \u9884\u8BBE\u7EE7\u7EED\u7531\u5DE6\u4FA7\u539F\u751F\u5206\u7C7B\u7BA1\u7406\u3002")
      )
    ),
    import_react29.default.createElement(
      "nav",
      { className: "cpwb-settings-nav", "aria-label": "Workbench \u8BBE\u7F6E\u5206\u7C7B" },
      ...WORKBENCH_SECTIONS.map(([id, label]) => import_react29.default.createElement("button", { key: id, type: "button", className: active === id ? "cpwb-active" : "", onClick: () => setActive(id) }, label))
    ),
    import_react29.default.createElement("main", { className: "cpwb-settings-content" }, import_react29.default.createElement(WorkbenchPanel, { section: active, settings, store: store3 }))
  );
}
...
function ImageAttachmentButton({ input }) {
  const pickerRef = import_react31.default.useRef(null);
  ...
  return import_react31.default.createElement(
    ...
    import_react31.default.createElement("button", {
      ...
      "aria-label": "\u6DFB\u52A0\u56FE\u7247",
      onClick: choose
    }, import_react31.default.createElement(I, { size: 17, weight: "regular", "aria-hidden": true })),
      ...
      inject: function() {
        ...
        const openKnownSession = async function(sessionId) {
          ...
          if (entry.scope.kind === "project") {
            result = await store2.actions.openProjectChat({ projectId: entry.scope.scopeId, resumeSessionId: sessionId });
          } else if (entry.scope.kind === "knowledge_base") {
            result = await store2.actions.openKnowledgeChat({ knowledgeBaseId: entry.scope.scopeId, chatId: entry.chatId });
          } else {
            result = await store2.actions.openIndependentSession({ resumeSessionId: sessionId });
          }
          return openResult(result, entry.scope.kind === "project" ? entry.scope.scopeId : null);
        };
        const createSession = async function() {
          const result = await store2.actions.openIndependentSession();
        ...
        return {
          ...
          enterProject(projectId, options = {}) {
            ...
            return store2.actions.openProjectChat({
              projectId,
              resumeSessionId: options.newSession ? void 0 : options.resumeSessionId
            }).then(function(result) {
          ...
          enterKnowledgeBase(knowledgeBaseId, options = {}) {
            ...
            return store2.actions.openKnowledgeChat({
              knowledgeBaseId,
              chatId: options.newSession ? void 0 : options.chatId
            }).then(function(result) {
              return openResult(result, null);
            });
          }
